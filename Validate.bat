...
REM 리포트 서버는 백그라운드(새 창)에서 실행
start "A11y Report Server" validator-cli.exe "@.\command\report.args"
...
echo.
echo 모든 작업이 완료되었습니다. 
echo 리포트 서버 창을 닫으려면 해당 창에서 Ctrl+C를 누르거나 창을 닫아주세요.
