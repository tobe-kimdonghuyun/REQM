(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div00",null,"60","472","33","20",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("div00");
            this.addChild(obj.name, obj);

            obj = new Button("btn48",null,"0","86","28","382",null,null,null,null,null,this.div00.form);
            obj.set_taborder("0");
            obj.set_text("커스텀버튼");
            obj.set_fittocontents("width");
            this.div00.addChild(obj.name, obj);

            obj = new Button("btn36",null,"0","72","28","232",null,null,null,null,null,this.div00.form);
            obj.set_taborder("2");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_WF_Delete");
            this.div00.addChild(obj.name, obj);

            obj = new Button("btnCust01_00_00","243","0",null,"28","122",null,null,null,null,null,this.div00.form);
            obj.set_taborder("3");
            obj.set_text("엑셀업로드");
            obj.set_fittocontents("width");
            ...
            obj = new Button("btnCust00_00_00","353","0","119","28",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("4");
            obj.set_text("엑셀다운로드");
            obj.set_fittocontents("width");
            ...
            obj = new Button("btn35",null,"0","72","28","307",null,null,null,null,null,this.div00.form);
            obj.set_taborder("1");
            obj.set_text("행추가");
            ...
            obj = new Button("btnCust01_00_00",null,"0","107","28","122",null,null,null,null,null,this.div00_01.form);
            obj.set_taborder("0");
            obj.set_text("엑셀업로드");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_ExcelUp");
            ...
            obj = new Button("btnCust00_00_00",null,"0","119","28","0",null,null,null,null,null,this.div00_01.form);
            obj.set_taborder("1");
            obj.set_text("엑셀다운로드");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_ExcelSave");
