(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "KORN_MSGE","type" : "string","size" : "32"},{"id" : "ENGL_MSGE","type" : "string","size" : "32"},{"id" : "MSGE_CD","type" : "string","size" : "32"},{"id" : "MSGE_FLAG_CD","type" : "string","size" : "32"}]}});
            this.addChild(obj.name, obj);
