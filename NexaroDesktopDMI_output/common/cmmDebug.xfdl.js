(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("true");
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "PATH","type" : "STRING","size" : "256"},{"id" : "NAME","type" : "STRING","size" : "256"},{"id" : "taborder","type" : "INT","size" : "256"},{"id" : "accessibilityenable","type" : "STRING","size" : "256"},{"id" : "visible","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
