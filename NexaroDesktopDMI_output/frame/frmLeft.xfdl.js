(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "MENU_ID","type" : "STRING","size" : "256"},{"id" : "MENU_NM","type" : "STRING","size" : "256"},{"id" : "MENU_LV","type" : "STRING","size" : "256"},{"id" : "HIPO_MENU_ID","type" : "STRING","size" : "256"},{"id" : "MENU_GRP_ID","type" : "STRING","size" : "256"},{"id" : "PRGM_ID","type" : "STRING","size" : "256"},{"id" : "LEAF_YN","type" : "STRING","size" : "256"},{"id" : "MENU_URL","type" : "STRING","size" : "256"},{"id" : "MENU_STS","type" : "STRING","size" : "256"},{"id" : "SYTM_FLAG_CD","type" : "STRING","size" : "256"}]}});
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "PRGM_FULL_PATH","type" : "STRING","size" : "32"},{"id" : "SORT_ORDR","type" : "BIGDECIMAL","size" : "16"},{"id" : "MENU_ID","type" : "STRING","size" : "32"},{"id" : "MENU_NM_EN","type" : "STRING","size" : "32"},{"id" : "MENU_NM","type" : "STRING","size" : "32"},{"id" : "PRGM_ID","type" : "STRING","size" : "32"},{"id" : "PRGM_PATH","type" : "STRING","size" : "32"}]}});
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00","0","82",null,null,"0","0",null,null,null,null,this.divLnb.form);
            obj.set_taborder("5");
            ...
            obj = new Button("btnMenu","0","42","50%","40",null,null,null,null,null,null,this.divLnb.form);
            obj.set_taborder("0");
            obj.set_cssclass("btn_LF_MenuS");
            obj.set_tooltiptext("전체메뉴");
            this.divLnb.addChild(obj.name, obj);

            obj = new Button("btnMyMenu","btnMenu:0","42",null,"40","0",null,null,null,null,null,this.divLnb.form);
            obj.set_taborder("2");
            ...
            obj = new Div("divMyMenuEdit","15","95","182","28",null,null,null,null,null,null,this.divLnb.form);
            obj.set_taborder("4");
            obj.set_text("div00");
            obj.set_visible("false");
            this.divLnb.addChild(obj.name, obj);
