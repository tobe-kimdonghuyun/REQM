(function()
{
    const fn = function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_apppath("http://172.10.12.45:9090/nexacroK/nexacroK_mfe_sub22");
            obj.set_automount("false");
            obj.set_taborder("0");
            obj.getSetter("text").set("Button00");
            this.addChild(obj.name, obj);

            obj = new nexacro.TextArea("TextArea00","706","43","404","357",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("Button00","706","410","160","63",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("mount");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("Button01","878","412","172","63",null,null,null,null,null,null,this);
            obj.set_taborder("2");
