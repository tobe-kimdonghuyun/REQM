    ...
    */
    ...
    _pCalendar._on_edit_oninput = function (/*obj, e*/)
    {
        ...
        if (datepicker && this._isPopupVisible())
        {
            ...
            datepicker._setValue(cur_value);//maskobj.getDatePickerValue());
        }
    ...
    _pCalendar._on_drop_onclick = function (/*obj, e*/) { };    // control
    ...
    _pCalendar._on_spin_mobile_onspinup = function (/*obj, e*/)
    {
        ...
        if (calendaredit)
        {
            ...
            //var pos = input_elem._composer.getOffset();
            var pos = this.getCaretPos();
                ...
                case "insertCompositionText":
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                input_elem._beforeinput_result_data = result.text;
                                input_elem._beforeinput_result_pos = { begin: begin + value.length, end: begin + value.length };
