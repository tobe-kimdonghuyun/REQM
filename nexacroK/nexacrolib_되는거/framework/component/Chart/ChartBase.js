...
if (!nexacro._ChartBase)
{
    ...
    _pChartBase.updateContents = function (contents)
    {
        ...
        {
            if(!Object.prototype.hasOwnProperty.call(contents, name)) //if (!contents.hasOwnProperty(name))
            {
                return;
            }
...
if (!nexacro.ChartSelectionControl)
{
    ...
    _pChartSelection._dragselectionObject = function (obj, x, y, canvasX, canvasY)
    {
        ...
        return {
            moved: function (button, alt_key, ctrl_key, shift_key, screenX, screenY, targetCanvasX, targetCanvasY, clientX, clientY)
            {
                var ret;
                distance[0] = clientX - origin[0];
                distance[1] = clientY - origin[1];
                ...
                pThis._updateSelection(boardRect, targetCanvasX, targetCanvasY);
                ret = "drag";
                return ret;
            },
            ended: function (button, alt_key, ctrl_key, shift_key, screenX, screenY, targetCanvasX, targetCanvasY, clientX, clientY)
            {
                var ret,
                ...
                ret = pThis._updateSelection(boardRect, targetCanvasX, targetCanvasY);
                xret = yret = false;
