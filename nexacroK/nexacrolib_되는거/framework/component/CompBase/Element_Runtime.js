...
if (nexacro._Browser == "Runtime")
{
    ...
    if (!nexacro.Element)
    {
        ...
        _pElement._getPropertyFlexAlign = nexacro._emptyFn;
        ...
        */
        ...
        _pInputElement.setElementInputType = function (type, bimedisable, use_password)
        {
            ...
            if (this.inputtype != type)
            {
                ...
                if (handle)
                {
                    ...
                    nexacro.__setInputElementHandleUsePassword(handle, use_password);
                }
            }
        };
        ...
        _pControlElement.setElementTransition = nexacro._emptyFn;
