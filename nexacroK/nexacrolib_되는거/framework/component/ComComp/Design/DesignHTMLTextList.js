...
{
    var _pHTMLTextList = nexacro.HTMLTextList.prototype;
    
    // -- Override
    _pHTMLTextList.on_create_contents = function ()
    {
    ...
    _pHTMLTextList.on_created_contents = function (win)
    {   
    ...
    _pHTMLTextList.on_change_containerRect = function (width, height)
    {
    ...
    _pHTMLTextList.on_apply_text = function (text)
    {
        var cellElem = this._cell_elem;
        if (cellElem)
        {
    ...
    _pHTMLTextList.createCssDesignContents = function ()
    {
        this.set_text("HTMLTextList");
    };
