...
if (!nexacro.NexacroPortal)
{
    ...
    _pNexacroPortal._detachContainerListeners = function ()
    {
        ...
        {
            container_handle.removeEventListener("oncomplate", fn.oncomplate);
    ...
    _pNexacroPortal._attachContainerListeners = function ()
    {
        ...
        this._attached_listeners_fns = {
            oncomplate: function (e) { pthis._onMfeDomComplate(e); },
        ...
        container_handle.addEventListener("oncomplate", this._attached_listeners_fns.oncomplate);
    ...
    _pNexacroPortal._onMfeDomComplate = function (e)
    {
