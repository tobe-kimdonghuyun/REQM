...
if (!nexacro.Device || nexacro._OS == "OSX")
{
    ...
    if (!nexacro.LiteDBParameter)
    {
        ...
        if (nexacro.Device)
        {
            _pLiteDBParameter.toJSON = function ()
            {
                ...
                const datautils = env._getDataUtils();
                ...
                {                   
                    switch (datautils.toTypeCode(this._p_type))
                    {
                        case 2: /* int */
                        case 3: /* float, double */
                            valueString = datautils.toTextFromDecimal(this._p_value);
                            break;
                        case 4: /* decimal, bigdecimal */
                            valueString = '"' + datautils.toTextFromDecimal(this._p_value) + '"';
                            break;
                        case 5: /* date */
                            valueString = '"' + datautils.toTextFromDate(this._p_value) + '"';
                            break;
                        case 6: /* time */
                            valueString = '"' + datautils.toTextFromTime(this._p_value) + '"';
                            break;
                        case 7: /* datetime */
                            if (this.value.dateObj == undefined)
                                valueString = '"' + datautils.toTextFromDateTime(this._p_value) + '"';
                            else
                                valueString = '"' + datautils.toTextFromDateTime(this._p_value.dateObj) + '"';
                            break;
                        case 0: /* undefined */
                        case 1: /* string */
                        case 8: /* blob */
                ...
                return nexacro._executeGlobalEvalStr('({"name":"' + this._p_name + '","type":' + datautils.toTypeCode(this._p_type) + ',"value":' + valueString + '})');
            };
        }
