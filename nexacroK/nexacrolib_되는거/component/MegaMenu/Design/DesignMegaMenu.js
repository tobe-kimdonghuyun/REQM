...
{
    //==============================================================================
    // nexacro.MegaMenu : Design
    //==============================================================================

    var _pMegaMenu = nexacro.MegaMenu.prototype;

    //==============================================================================
    // nexacro.MegaMenu : Design Contents
    //==============================================================================
    ...
    */
    ...
    _pMegaMenu._onCreateCssDesignContents = function (mode)
    {
    ...
    _pMegaMenu._onShowCssDesignContents = function ()
    {
        // user sample apperance set
        this.set_index(1);
    };
    // [component.design.contents:destroy] 
    _pMegaMenu._onDestroyCssDesignContents = function ()
    {
    ...
    _pMegaMenu._onCreateFormDesignContents = function ()
    {
    };
    // [component.design.contents.form:show] 
    _pMegaMenu._onShowFormDesignContents = function ()
    {
    };
    // [component.design.contents.form:destroy] 
    _pMegaMenu._onDestroyFormDesignContents = function ()
    {
    };

    // Formats Component의 Contents Editor의 Preview가 존재할때 Override 
    // [component.design.contents.ctse:create]     
    _pMegaMenu._onCreateCtseDesignContents = function ()
    {
    };
    // [component.design.contents.ctse:show] 
    _pMegaMenu._onShowCtseDesignContents = function ()
    {
    };
    // [component.design.contents.ctse:destroy] 
    _pMegaMenu._onDestroyCtseDesignContents = function ()
    {
    };
    */

    //==============================================================================
    // nexacro.MegaMenu : Design Logic
    //==============================================================================
