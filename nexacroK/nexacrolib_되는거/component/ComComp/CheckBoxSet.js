...
if (!nexacro.CheckBoxSet)
{
    ...
    _pCheckBoxSet._p_itemheight = undefined;
    _pCheckBoxSet._itemheight = undefined;
    ...
    _pCheckBoxSet.on_attach_contents_handle = function (win, enablea11y)
    {
        var text_elem = this._text_elem;
        if (text_elem)
        {
    ...
    _pCheckBoxSet.on_change_bindSource = function (propid, ds, row, col)
    {
        if (propid == "value")
        {
            ...
            let codecolumn = this._p_codecolumn;
            let datacolumn = this._p_datacolumn == "" ? codecolumn : this._p_datacolumn;
    ...
    _pCheckBoxSet.on_apply_font = function (font)
    {
        nexacro.Component.prototype.on_apply_font.call(this, font);
        this._reapplyRemValues();
    };

    _pCheckBoxSet._reapplyRemValues = function ()
    {
    ...
    _pCheckBoxSet.on_fire_user_onkeydown = function (keycode, alt_key, ctrl_key, shift_key, fire_comp, refer_comp, meta_key)
    {
        ...
        /*
        if (this._getEnvironment()?._p_enableaccessibility && keycode == nexacro.Event.KEY_TAB)
        {
            var item;
            var accIdx = this._accessibility_index;
    ...
    {
        var role = this._p_itemaccessibilityrole;
