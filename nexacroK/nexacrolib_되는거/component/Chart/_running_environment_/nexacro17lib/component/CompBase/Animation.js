...
if (!nexacro.Animation)
{
    ...
    }(this, function ()
    {
        ...
        var is = {
            ...
            col: function (a) { return (is.hex(a) || is.rgb(a) || is.hsl(a) || isNamedColor(a)); }
        }
        ...
        function anime(params)
        {
            ...
            //instance._rafTarget = is.arr(params.targets) ? params.targets[0] : params.targets;
            ...
            function syncInstanceChildren(time)
            {
                ...
                {
                    for (var i = 0; i < arrayLength(children) ; i++) children[i].seek(time);
                }
                else
                {
                    for (var i = arrayLength(children) ; i--;) children[i].seek(time);
                }
            }
    ...
    _pAnimation.set_enableevent = function (v)
    {
        ...
        if (this.enableevent != v) this.enableevent = v;
    };
    ...
    _pAnimation.set_loop = function (v)
    {
        ...
        if (this.loop != loop) this.loop = loop;
    }
    ...
    _pAnimation.set_loopcount = function (v)
    {
        ...
        if (this.loopcount != loopcount) this.loopcount = loopcount;
    }
    ...
    _pAnimation.set_delay = function (v)
    {
        ...
        if (this.delay != delay) this.delay = delay;
    }
    ...
    _pAnimation.set_easing = function (v)
    {
        ...
        if (this.easing != easing) this.easing = easing;
    }

    _pAnimation.set_beziercurve = function (v)
    {
        var beziercurve = nexacro._toString(v);
        if (this.beziercurve != beziercurve) this.beziercurve = beziercurve;
    };
    ...
    _pAnimation.set_round = function (v)
    {
        ...
        if (this.round != round) this.round = round;
    }
    ...
    {
        if (this._anime) this._anime.pause();
    }

    _pAnimation.restart = function ()
    {
        if (this._anime) this._anime.restart();
    }
    ...
    _pAnimation.seek = function (time)
    {
        this.play();
        this.pause();
        if (this._anime) this._anime.seek(time);
    }
    ...
    {
        if (this._anime) this._anime.reset();
        this._createAnimeJSObject();
    }
    ...
    //_pAnimation.insertChild = function(idx, id, obj) {
    //    if (id && id.length <= 0) {
    //        return -1;
    //    }
    //    if (!obj) {
    ...
    {
        if (this.offset != v) this.offset = v;
    };
    ...
    _pAnimationTimeline.addTarget = function (id, obj, offset)
    {
        ...
        if (!item)
        {
            ...
            //this._anime.add(obj._makeParamsObject(offset));
        }
        return ret;
    };
