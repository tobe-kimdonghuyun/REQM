...
if (!nexacro.SimpleComponent)
{
    ...
    */
    ...
    // [component:create]                           // override는 가급적 없도록
    ...
    // [component.controlelement:create]            // 이부분 override는 basic component에서만
    ...
    {
        return this.on_create_control_element(parentElem);// TODO : 소스통합
    };

    // [component.controlelement:init]              // 이부분 override는 basic component에서만
    ...
    //  this.onInitControlElement();                // 이 override 노출은 제외
    };
    ...
    // [component.controlelement.init:status]       // 이부분 override는 basic component에서만
    _pSimpleComponent._initControlElementStatus = function ()
    {
        // visible                                  // TODO : 이부분이 있어야하는지 확인필요
 ...
 // [component.controlelement.init:rtl]       // 이부분 override는 basic component에서만
    _pSimpleComponent._initControlElementRTL = function ()
    {
        this.on_apply_prop_rtl();
    };

    // [component.controlelement.init:cssinfo]      // 이부분 override는 basic component에서만
    ...
    // [component.controlelement.cssselector:set]   // 이부분 override는 basic component에서만
    _pSimpleComponent._setControlElementCssSelector = function ()
    {
        this.on_apply_cssselector();                // TODO : on override로 있어야하는지 확인후 직접호출
    ...
    // [component.controlelement.cssmapinfo:set]    // 이부분 override는 basic component에서만
    ...
    // [component.controlelement.init:possize]      // 이부분 override는 basic component에서만
    ...
    // [component.controlelement.init:styleprop]    // 이부분 override는 basic component에서만
    _pSimpleComponent._initControlElementStyleProps = function ()
    {
        this._initNormalStyleProperty(this._control_element); // TODO: 소스통합
    };
    ...
    // [component.contents:init]                    // 이부분 override는 basic component에서만. receate를 처리하기 위해서 contents create 명시적 분리
    _pSimpleComponent._initContents = function ()
    {
        this.onCreateContents();                    // Simple Component는 Override 없음
    ...
    */
    ...
    _pSimpleComponent.enable = true;                        // 기본 system status
    ...
    */
    ...
    _pSimpleComponent.readonly = undefined;                 // readonly 지원시 true/false 설정
    ...
    */
    ...
    {
        // basic action
        return this.on_click_basic_action(null, e.button, e.alt_key, e.ctrl_key, e.shift_key, e.screenX, e.screenY, e.canvasX, e.canvasY/*, e.clientX, e.clientY*/);
    };
