...
if (!nexacro.FileUpload)
{
            ...
            else // success
            {
                try
                {
                    if (data)
                    {
                        ...
                        if (errorcode < 0)
                        {
                            //                 obj, errortype, errormsg, errorobj, statuscode, requesturi, locationuri, index
                    ...
                    else if (status != 4) //FileTransfer on_progress 4
                    {
                        this.on_fire_onerror(this, "ObjectError", errormsg, this, 9901, null, null, -1);
                    }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (xmldoc)
                    {
                        ...
                        {
                            errormsg = data; // CommunicationError
                        }

                        if (errorcode < 0) //fire error
                            this.on_fire_onerror(this, "ObjectError", errormsg, this, 9901, null, null, -1);
                        else
                            this.on_fire_onsuccess(result[1], errorcode, errormsg, url, result);
                    }
    ...
    _pFileUpload.on_fire_user_onkeydown = function (keycode, alt_key, ctrl_key, shift_key, fire_comp, refer_comp)
    {
        ...
        else
        {
            ...
            if (nexacro._enableaccessibility)
            {
                ...
                //if (items[idx])
                //    this._setControlFlag(items[idx]);
    ...
    _pFileUploadItemButtonControl.on_fire_sys_onkeyup = function (key_code, alt_key, ctrl_key, shift_key, from_comp, from_refer_comp) //  override for keyup 'enter' or 'space'
    {
