...
if (!nexacro.ChartRadarCategoryAxisControl)
{
    ...
    _pChartRadarCategoryAxisControl._arrangeLabelGroup = function ()
    {
        ...
        function getUnitVector(ptAnchor, ptTargetPos)
        {
            var pt = { x: 0, y: 0 };
            if (ptAnchor.x - ptTargetPos.x == 0 && ptAnchor.y - ptTargetPos.y == 0)
            {
                return pt;
            }

            var dx = ptAnchor.x - ptTargetPos.x;
            var dy = ptAnchor.y - ptTargetPos.y;

            var len = getDistance(ptAnchor.x, ptAnchor.y, ptTargetPos.x, ptTargetPos.y);
            pt.x = dx / len;
            pt.y = dy / len;
...
if (!nexacro.ChartRadarValueAxisControl)
{
    ...
    _pChartRadarValueAxisControl._setupTickGeneration = function (width, height)
    {
        ...
        if (!this._tickGenerator)
        {
            ...
            {
                var _ticks = [],
                    _start = axis._floorInBase(axis._min, axis._tickinterval),
                    j = 0,
                    _v = Number.NaN,
                    _prev;
                ...
                if (istotal)
                {
                    ...
                    _max = axis._tickmax || axis._datamax;
                }
                else
                {
                    min = axis._min;
                ...
                {
                    _prev = _v;
                    _v = _start + j * axis._tickinterval;
                    _ticks.push(_v);
                    ++j;
                } while (_v < _max && _v != _prev);
...
if (!nexacro.ChartRadarSeriesControl)
{
    ...
    _pChartRadarSeriesControl._drawPointItemText = function (cx, cy, item)
    {
        ...
        function positionlefttop(targetItemText, x, y, targetItemtextGap)
        {
            // xy
            ...
            targetItemText.set_x(textLeft - targetItemtextGap);
            targetItemText.set_y(textTop - targetItemtextGap);

        }
        function positioncentertop(targetItemText, x, y, targetItemtextGap)
        {
            // y
            targetItemText.set_verticalAlign("bottom");
        ...
        function positionrighttop(targetItemText, x, y, targetItemtextGap)
        {
            //xy
            targetItemText.set_verticalAlign("bottom");
        ...
        function positionleftmiddle(targetItemText, x, y, targetItemtextGap)
        {
            //x
        ...
        function positioncentermiddle(targetItemText, x, y, targetItemtextGap)
        {
            //y
            targetItemText.set_verticalAlign("middle");
            targetItemText.set_textAlign("center");
        ...
        function positionrightmiddle(targetItemText, x, y, targetItemtextGap)
        {
            //x
            targetItemText.set_verticalAlign("middle");
            targetItemText.set_textAlign("left");
        ...
        function positionleftbottom(targetItemText, x, y, targetItemtextGap)
        {
            //xy
        ...
        function positioncenterbottom(targetItemText, x, y, targetItemtextGap)
        {
            //y
            targetItemText.set_verticalAlign("top");
            targetItemText.set_textAlign("center");
        ...
        function positionrightbottom(targetItemText, x, y, targetItemtextGap)
        {
            //xy
            targetItemText.set_verticalAlign("top");
            targetItemText.set_textAlign("left");
