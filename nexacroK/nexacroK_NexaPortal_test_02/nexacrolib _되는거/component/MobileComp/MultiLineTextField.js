...
if (!nexacro.MultiLineTextField)
{
    ...
    */
    ...
    _pMultiLineTextField._useNativeWheelScroll = _pTextAreaPtype._useNativeWheelScroll;
    _pMultiLineTextField.on_apply_scrollpropagation = _pTextAreaPtype.on_apply_scrollpropagation;
    ...
    _pMultiLineTextFieldBox.on_attach_contents_handle = function (win, enablea11y)
    {
