...
{
    var _pHTMLLottie = nexacro.HTMLLottie.prototype;
    
    // -- Override
    _pHTMLLottie.on_create_contents = function ()
    {
    ...
    _pHTMLLottie.on_created_contents = function (win)
    {   
    ...
    _pHTMLLottie.on_change_containerRect = function (width, height)
    {
    ...
    _pHTMLLottie.on_apply_text = function (text)
    {
        var cellElem = this._cell_elem;
        if (cellElem)
        {
    ...
    _pHTMLLottie.createCssDesignContents = function ()
    {
        this.set_text("HTMLLottie");
    };
