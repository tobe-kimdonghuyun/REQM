...
if (!nexacro.DatasetBase)
{
    ...
    //DataUtils["2.0"]에서 undefined : Invalid Date 처리
    _pDate._setInvalidDate = function ()
    {
    ...
    nexacro.DataUtilsSet["1.0"] = (function ()
    {
        var datautil =
        {
            _version : "1.0",
            ...
            {
                return datautil._default_values[type.toLowerCase()];
            },

            getDefaultSize: function (type)
            {
                return datautil._default_sizes[type.toLowerCase()];
            },

            toTypeCode: function (type)
            {
                var n = datautil._typeint[type.toLowerCase()];
                return (n == null) ? 0 : n;
            },

            toTypeName: function (type)
            {
                var n = datautil._typenames[type];
            ...
            findDataType: function (value)
            {
                ...
                var n = datautil._typenames[value];
                return (n == null) ? 0 : n;
            },
            ...
            toString: function (value)
            {
                ...
                if (value instanceof Date) return datautil._formatDateTime(value);
            ...
            toBoolean: function (value)
            {
                ...
                {
                    value = datautil._boolean_values[value];
                }
            ...
            toDecimal: function (value)
            {
                ...
                else return (isFinite(value)) ? new nexacro.Decimal(value) : "";
            },
            ...
            toDate: function (value)
            {
                ...
                if ((typeof value) == "string")
                    return datautil._parseDateTime(value, "date");
                if (value instanceof Date)
                    return datautil._datetimeToDate(value);
                if ((typeof value) == "number" && datautil._isValidTime(value))
                    return datautil._datetimeToDate(new Date(value));
            ...
            toDateFromText: function (value)
            {
                ...
                return (value == "") ? null : datautil._parseDateTime(value, "date");
            },
            toTextFromDate: function (value)
            {
                return (value == null) ? null : datautil._formatDate(value);
                /*
                if (value === null) return null; // RP_38152) distincted each. _toXMLText()
                if (value === undefined) return undefined;
                if (value == "") return "";
                return datautil._formatDate(value);
                */
            },
            ...
            toTime: function (value)
            {
                ...
                if ((typeof value) == "string")
                {
                    return datautil._parseDateTime(value, "time");
                }
                if (value instanceof Date)
                {
                    return datautil._datetimeToTime(value);
                }
                if ((typeof value) == "number" && datautil._isValidTime(value))
                {
                    return datautil._datetimeToTime(new Date(value));
                }
                if (value instanceof nexacro.Date)
                {
                    return value;
            ...
            toTimeFromText: function (value)
            {
                ...
                return (value == "") ? null : datautil._parseDateTime(value, "time");
            },
            toTextFromTime: function (value)
            {
                //return (value == null) ? null : datautil._formatTime(value);
                if (value === null) return null;  // RP_38152) distincted each. _toXMLText()
                if (value === undefined) return undefined;
                if (value == "") return "";
                return datautil._formatTime(value);
            },
            ...
            toDateTime: function (value)
            {
                ...
                if ((typeof value) == "string")
                {
                    ...
                    return datautil._parseDateTime(value, "datetime");
                }
                if (value instanceof Date)
                {
                    return value;
            ...
            {
                if (value === undefined) return undefined;
                return (value == "") ? null : datautil._parseDateTime(value, "datetime");
            },
            toTextFromDateTime: function (value)
            {
                //return (value == null) ? null : datautil._formatDateTime(value);
                if (value === null) return null;  // RP_38152) distincted each. _toXMLText()
                if (value === undefined) return undefined;
                if (value == "") return "";
                return datautil._formatDateTime(value);
            },
            ...
            {
                return datautil._toTime(datetime.getHours(), datetime.getMinutes(), datetime.getSeconds(), datetime.getMilliseconds());
            },
            ...
            _parseDateTime: function (str, cType)
            {
                ...
                switch (cType)
                {
                    case "datetime": // yyyyMMddHHmmssZZZ
                        ...
                        return datautil._toDateTime(year, month, date, hour, minute, second, millisecond);
                    case "date": // yyyyMMdd
                        year = str.substring(0, 4);
                        month = str.substring(4, 6) || "01";
                        date = str.substring(6, 8) || "01";
                        return datautil._toDate(year, month, date);
                    case "time": // HHmmssZZZ
                        hour = str.substring(0, 2);
                        minute = str.substring(2, 4);
                        second = str.substring(4, 6);
                        millisecond = str.substring(6, 9);
                        return datautil._toTime(hour, minute, second, millisecond);
                }
                return "";
            },
            ...
            _formatDate: function (datetime)
            {
                ...
                return datautil._leftPad(datetime.getFullYear() * 10000 + (datetime.getMonth() + 1) * 100 + datetime.getDate(), 8);
            },
            _formatTime: function (datetime)
            {
                ...
                millsecond = datautil._leftPad(ms, 3);
                return datautil._leftPad(datetime.getHours() * 10000 + datetime.getMinutes() * 100 + datetime.getSeconds(), 6) + millsecond;
            },
            _formatDateTime: function (datetime)
            {
                if (!datetime) return undefined;
                var yyyymmdd = datautil._leftPad(datetime.getFullYear() * 10000 + (datetime.getMonth() + 1) * 100 + datetime.getDate(), 8);
                var millsecond = "";
                var ms = datetime.getMilliseconds();
                millsecond = datautil._leftPad(ms, 3);
                var hhmiss = datautil._leftPad(datetime.getHours() * 10000 + datetime.getMinutes() * 100 + datetime.getSeconds(), 6) + millsecond;
            ...
            {
                return (time <= datautil._MAX_MILLISECONDS && time >= datautil._MIN_MILLISECONDS);
            },
    ...
    nexacro.DataUtilsSet["2.0"] = (function ()
    {
        var datautil =
        {
            _version : "2.0",
            ...
            {
                var date;
                if (!datautil._isValidPackedDate(value))
                {
                    if ((typeof value) != "number")
                    {
                        ...
                        {
                            let dd = new nexacro.Date(); //Invalid Date
                            dd._setInvalidDate();
                            return dd;
                        }
                        else
                ...
                if ((typeof value) == "number")
                {
                    ...
                    if (datautil._isValidTime(value))
                    {
                        value = datautil._datetimeToDate(date);
                        return datautil._toDate(value.getFullYear(), value.getMonth() + 1, value.getDate());
                    }
                    else
                    {
                        if (isNaN(date.valueOf()))
            ...
            toDateFromText: function (value)
            {
                ...
                if (!datautil._isValidPackedDate(value))
                {
                    ...
                    {
                        ret = datautil._toDate(date.getFullYear(), date.getMonth() + 1, date.getDate());
                    }
                }
                else
                    ret = datautil._parseDateTime(value, "date");
            ...
            {
                var date;
                if (!datautil._isValidPackedTime(value))
                {
                    if ((typeof value) != "number")
                    {
                        if (value === "" || value === undefined)
                ...
                if ((typeof value) == "number")
                {
                    ...
                    if (datautil._isValidTime(value))
                    {
                        value = datautil._datetimeToTime(date);
                        return datautil._toTime(value.getHours(), value.getMinutes(), value.getSeconds(), value.getMilliseconds());
                    }
                    else
                    {
                        if (isNaN(date.valueOf()))
            ...
            toTimeFromText: function (value)
            {
                if (!datautil._isValidPackedTime(value))
                {
                    ...
                    {
                        return datautil._toTime(date.getHours(), date.getMinutes(), date.getSeconds(), date.getMilliseconds());
                    }
                }
            ...
            {
                var date;
                if (!datautil._isValidPackedDateTime(value))
                {
                    if ((typeof value) != "number")
                    {
                        if (value === "" || value === undefined)
                ...
                if (value instanceof Date || value instanceof nexacro.Date)
                {
                    return datautil._toDateTime(value.getFullYear(), value.getMonth() + 1, value.getDate(), value.getHours(), value.getMinutes(), value.getSeconds(), value.getMilliseconds());
                }
            ...
            toDateTimeFromText: function (value)
            {
                ...
                if (!datautil._isValidPackedDateTime(value))
                {
                    ...
                    {
                        ret = datautil._toDateTime(date.getFullYear(), date.getMonth() + 1, date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds(), date.getMilliseconds());
                    }
                }
                else
                    ret = datautil._parseDateTime(value, "datetime");
    ...
    nexacro.ConstColumnVariable.prototype = _pConstColumnVariable;
    ...
    nexacro.DSColumnInfo = function (id, type, ntype, size, prop, sumtext, datapath, idx, label, datautils)
    {
        this.id = id;
        ...
        this._index = idx;
        this._datautils = datautils || nexacro.getEnvironment()._datautils || nexacro.DataUtilsSet["1.0"];
    ...
    _pDSColumnInfo.set_type = function (v)
    {
        if (this._p_type != v)
        {
            ...
            var datautils = this._datautils;
            if (datautils._typeenums.indexOf(check) == -1)
            {
                return;
            }

            this._p_type = v;
            this.ntype = datautils._typeint[check];
    ...
    // for test code
    _pDSColumnInfo._setDataUtils = function (datautils)
    {
        if (datautils)
    ...
    _pDSColumnInfo._on_apply_columntype = function ()
    {
        ...
        switch (ntype)
        {
            case 1:
                // string
                this._toText = datautils.toTextFromString;
                this._fromText = datautils.toStringFromText;
                this._fromVal = datautils.toString;
                this._toXMLText = datautils.toXMLTextFromString;
                this._fromXMLText = datautils.toStringFromXMLText;
                break;
            case 2:
                // int
                this._toText = datautils.toTextFromInt;
                this._fromText = datautils.toIntFromText;
                this._fromVal = datautils.toInt;
                this._toXMLText = datautils.toTextFromInt;
                this._fromXMLText = datautils.toIntFromText;
                break;
            case 3:
                // float
                this._toText = datautils.toTextFromFloat;
                this._fromText = datautils.toFloatFromText;
                this._fromVal = datautils.toFloat;
                this._toXMLText = datautils.toTextFromFloat;
                this._fromXMLText = datautils.toFloatFromText;
                break;
            case 4:
                // bigdecimal
                this._toText = datautils.toTextFromDecimal;
                this._fromText = datautils.toDecimalFromText;
                this._fromVal = datautils.toDecimal;
                this._toXMLText = datautils.toTextFromDecimal;
                this._fromXMLText = datautils.toDecimalFromText;
                break;
            case 5:
                // date
                this._toText = datautils.toTextFromDate;
                this._fromText = datautils.toDateFromText;
                this._fromVal = datautils.toDate;
                this._toXMLText = datautils.toTextFromDate;
                this._fromXMLText = datautils.toDateFromText;
                break;
            case 6:
                // time
                this._toText = datautils.toTextFromTime;
                this._fromText = datautils.toTimeFromText;
                this._fromVal = datautils.toTime;
                this._toXMLText = datautils.toTextFromTime;
                this._fromXMLText = datautils.toTimeFromText;
                break;
            case 7:
                // datetime
                this._toText = datautils.toTextFromDateTime;
                this._fromText = datautils.toDateTimeFromText;
                this._fromVal = datautils.toDateTime;
                this._toXMLText = datautils.toTextFromDateTime;
                this._fromXMLText = datautils.toDateTimeFromText;
                break;
            case 8:
                // blob
                this._toText = datautils.toTextFromBlob;
                this._fromText = datautils.toBlobFromText;
                this._fromVal = datautils.toBlob;
                this._toXMLText = datautils.toTextFromBlob;
                this._fromXMLText = datautils.toBlobFromText;
                break;
            default:
                // variant
                this._toText = datautils.toTextFromVariant;
                this._fromText = datautils.toVariantFromText;
                this._fromVal = datautils.toVariant;
                this._toXMLText = datautils.toXMLTextFromVariant;
                this._fromXMLText = datautils.toVariantFromXMLText;
                break;
        }
    };
    ...
    nexacro.DatasetBase = function (id, parent)
    {
        ...
        this._initDatasetRuleFuncs(this._getEnvironment()?._p_datatyperule || "1.0");
    };
    ...
    _pDatasetBase._getEnvironment = function ()
    {
        if (!this._env)
        {
            if (this._p_parent &&this._p_parent._getEnvironment)
                this._env = this._p_parent._getEnvironment();
        }
        return this._env || nexacro.getEnvironment();
    };
    ...
    _pDatasetBase.getSaveNan = function (v)
    {
        ...
        return v ? v : env ? env._p_datasetsavenan : nexacro._datasetsavenan;
    };
    ...
    _pDatasetBase.getSaveInfinity = function (v)
    {
        ...
        return v ? v : env ? env._p_datasetsaveinfinity : nexacro._datasetsaveinfinity;
    };
    ...
    _pDatasetBase.getSaveInvalidDate = function (v)
    {
        ...
        return v ? v : env ? env._p_datasetsaveinvaliddate : nexacro._datasetsaveinvaliddate;
    };
    ...
    // ----------------- event handling ------------------ //
    _pDatasetBase.on_fire_onload = function (errcode, errmsg, reason, progressload, init_binddataobj_prop)
    {
        if (errcode >= 0)
        {
            // based on manual
        ...
        if (this._binddataobject && init_binddataobj_prop)
        {
            this._binddataobject = null;
    ...
    _pDatasetBase._createExprFunc = function (expr_str, useCache)
    {
        const arglist = ["currow", "rowidx", "comp", "dataset", "_records_", "_row_", "_args_", "group"];
        let exprFn = null;
        if (useCache === true)
        {
            if (!this._exprFuncs)
            ...
            {
                exprFn = this._exprFuncs[expr_str];
        ...
        exprFn = nexacro._createExprFunc(expr_str, this, arglist);
        if (useCache === true && exprFn)
        {
            this._exprFuncs[expr_str] = exprFn;
        }
        return exprFn;
    };
    ...
    _pDatasetBase._addConstColumn = function (id, value, type, size, datapath, label, userattrs)
    {
        ...
        if (type)
        {
            ntype = datautils._typeint[nexacro._toString(type).toLowerCase()];
        }
        else
        {
            type = (typeof value);
            if (type == "number")
                ...
                ntype = datautils._typecodes[type];
        }
        ...
        if (prev_var)
        {
            ...
            {
                prev_var.value = datautils.convert(value, ntype);
    ...
    _pDatasetBase._addColumn = function (id, type, size, prop, text, datapath, label, userattrs)
    {
        ...
        if (size == 0)
        {
            size = datautils._default_sizes[ntype];
        }


        var idx = this.colinfos.length;
        var colinfo = new nexacro.DSColumnInfo(id, type, ntype, size, prop, text, datapath, idx, label, datautils);
        if (userattrs)
        {
    ...
    _pDatasetBase._addColumnInfo = function (id, colinfo)
    {
        ...
        var newcolinfo = new nexacro.DSColumnInfo(id, colinfo.type, colinfo.ntype, colinfo.size, colinfo.prop, colinfo.sumtext, colinfo.datapath, this.colinfos.length, colinfo.label, colinfo._datautils); // RP_38601
    ...
    _pDatasetBase._appendColList = function (colList)
    {
        if (colList._type_name == "DSColumnInfoList")
        {
            ...
            function __appendColList_loopFn(i)
            {
                ...
                var newcolinfo = new nexacro.DSColumnInfo(id, colinfo.type, colinfo.ntype, colinfo.size, colinfo.prop, colinfo.sumtext, colinfo.datapath, this.colinfos.length, colinfo.label, colinfo._datautils);
    ...
    //생성시 한번 호출, 테스트시에만 동적변경 Column info에 데이터 유틸 정보도 변경
    _pDatasetBase._initDatasetRuleFuncs = function (v)
    {
        this._datautils = nexacro.DataUtilsSet[v];
        ...
        let i;
        let colList = this.colinfos;
        for (i = 0; i < colList.length; i++)
        {
            let colinfo = colList[i];               
            colinfo._setDataUtils(this._datautils);                
        }   
    };

    _pDatasetBase._getDataUtils = function ()
    {
    ...
    _pDatasetBase.deleteAll = function ()
    {
        ...
        if (cnt > 0)
        {
            ...
            if (this._p_updatecontrol == false && this._isTwowayDataobjectBindMode() && this._binddataobject)
                this._binddataobject.deleteAllDataInPath(this._p_dataobjectpath, this.id);
        }
        return cnt;
    };
    ...
    */
    ...
    {
        var env = this._getEnvironment();
        var locale = env?._p_locale ? env._p_locale : nexacro._getLocale();
        var pThis = this;
    ...
    _pDatasetBase._reFilter = function ()
    {
        ...
        if (this._p_filterstr.length > 0)
        {
            ...
            {
                var filterFn = this._createExprFunc(this._p_filterstr, false);
    ...
    _pDatasetBase._apply_columnchanged = function (rowRow, colinfo, fromval, evt)
    {
        ...
        if (this._isTwowayDataobjectBindMode())
        {
            ...
            else
            {
                ...
                this._binddataobject.setDataValue(this._p_dataobjectpath, fromval, rowRow._rawidx, this._getPathFromColinfo(colinfo), this.id);
            }
        }
    };
            ...
            (this.onvaluechanged && this.onvaluechanged._has_handlers)))
        {
            ...
            if ((this.cancolumnchange && this.cancolumnchange._has_handlers))
            {
                if (this.on_fire_cancolumnchange(evt))
                {
                    ...
                    {
                        this._apply_columnchanged(rowRow, colinfo, fromval, evt);
                        return true;
                    }
                }
                else
    ...
    _pDatasetBase._identifyExpr = function (expr)
    {
        ...
        if (ex == "EXPR" || ex == "BIND")
        {
            ...
            var exprfn = this._createExprFunc(expr, true);
            if (typeof exprfn == "function")
            {
    ...
    _pDatasetBase.__getCaseCount = function (records, cmpExpr, start, end, args)
    {
        ...
        // expr
        var cmpFn = this._createExprFunc(cmpExpr, true);
    ...
    _pDatasetBase.__getCaseSum = function (records, cmpExpr, valExpr, start, end, args, valargs)
    {
        ...
        // expr  value
        var valFn = this._createExprFunc(valExpr, true);
    ...
    _pDatasetBase._createDataset = function (records, dataset_id, select_list, where_expr, start, end)
    {
        ...
        function __parse_selct_loopFn(i)
        {
            ...
            if (seppos > 0)
            {
                ...
                if (selval && selval != "")
                {
                    valFn = this._createExprFunc(selval, true);
                    if (typeof valFn == "function")
                    {
        ...
        {
            whereFn = this._createExprFunc(where_expr, true);
        ...
        if (xmlStr)
        {
            ...
            if (nexacro._use_firefirstcount && bClear && this.firefirstcount > 0)
            {
                ...
                if (this.firefirstcount == this._p_rowcount)
                {
                    this._reFilter();
                    this._resetSortGroup();
                    this.on_fire_onload(errorcode, errormsg, 1, undefined, true); //nexacro.Dataset.REASON_LOADPROCESS
                    this._forcesetRowPosition(0, 51); //nexacro.Dataset.REASON_ROWCHANGE;
                    this._p_rowposition = 0;
            ...
            if (this._eventstat)
            {
                this.on_fire_onload(errorcode, errormsg, bClear ? 0 : 12, undefined, true); //nexacro.Dataset.REASON_LOAD  or nexacro.Dataset.REASON_APPEND
                if (this._viewRecords && this._viewRecords.length > 0)
                {
                    this._forcesetRowPosition(0, 51); //nexacro.Dataset.REASON_ROWCHANGE;
                }
    ...
    _pDatasetBase._saveXML = function (id, type, depth, savenan, saveinfinity, saveinvaliddate, saveextraprop)
    {
        ...
        if (constList.length + colList.length)
        {
            ...
            function __saveXML_colinfo_loopFn(i)
            {
                ...
                var colType = colinfo.ntype == 9 ? "STRING" : colinfo.type ? colinfo.type : datautils.toTypeName(colinfo.ntype);
                var colSize = colinfo.ntype == 9 ? datautils._default_sizes[1] : colinfo.size;
                var colProp = colinfo.prop;
    ...
    _pDatasetBase._getValueByColtype = function (value, coltype)
    {
        ...
        switch (coltype)
        {
            case 1:
                ...
                break;
            case 2: //int
                ret = datautils.toIntFromText(ret);
                break;
            case 3: //float
                ret = datautils.toFloatFromText(ret);
                break;
            case 4: //bigdecimal
                ret = datautils.toDecimalFromText(ret);
                break;
            case 5: //date
                ret = datautils.toDateFromText(ret);
                break;
            case 6: //time
                ret = datautils.toTimeFromText(ret);
                break;
            case 7: //datetime
                ret = datautils.toDateTimeFromText(ret);
                break;
            case 8: //blob
                ret = datautils.toBlobFromText(ret);
                break;
            default:
                // variant
                ret = datautils.toTextFromVariant(ret);
                break;
        }
        return ret;
    };
    ...
    // load SSV
    //---------------------------------------------
    _pDatasetBase.__makeDataConvertStepHandler = function (targetIdx, srcIdx, ntype, datautils, checkUd, ud)
    {
        switch (ntype)
        {
            case 1:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = arr[srcIdx]; } } :
                        function (target, arr) { target[targetIdx] = arr[srcIdx]; };
            case 2:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = datautils.toIntFromText(arr[srcIdx]); } } :
                        function (target, arr) { target[targetIdx] = datautils.toIntFromText(arr[srcIdx]); };
            case 3:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = datautils.toFloatFromText(arr[srcIdx]); } } :
                        function (target, arr) { target[targetIdx] = datautils.toFloatFromText(arr[srcIdx]); };
            case 4:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = datautils.toDecimalFromText(arr[srcIdx]); } } :
                        function (target, arr) { target[targetIdx] = datautils.toDecimalFromText(arr[srcIdx]); };
            case 5:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = datautils.toDateFromText(arr[srcIdx]); } } :
                        function (target, arr) { target[targetIdx] = datautils.toDateFromText(arr[srcIdx]); };
            case 6:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = datautils.toTimeFromText(arr[srcIdx]); } } :
                        function (target, arr) { target[targetIdx] = datautils.toTimeFromText(arr[srcIdx]); };
            case 7:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = datautils.toDateTimeFromText(arr[srcIdx]); } } :
                        function (target, arr) { target[targetIdx] = datautils.toDateTimeFromText(arr[srcIdx]); };
            case 8:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = datautils.toBlobFromText(arr[srcIdx]); } } :
                        function (target, arr) { target[targetIdx] = datautils.toBlobFromText(arr[srcIdx]); };
            default:
                return checkUd ?
                        function (target, arr) { if (ud != arr[srcIdx]) { target[targetIdx] = datautils.toTextFromVariant(arr[srcIdx]); } } :
                        function (target, arr) { target[targetIdx] = datautils.toTextFromVariant(arr[srcIdx]); };
        }
    };
    _pDatasetBase.__makeDataConvertFunc = function (type)
    {
        const colinfos = this.colinfos;
        const colLen = colinfos.length;
        const datautils = this._datautils;
        const checkud = (type === "S");
        const ud = checkud ? String.fromCharCode(3) : null;
        const steps = [];

        for (let idx = 0; idx < colLen; idx++)
        {
            const ntype = colinfos[idx].ntype;
            steps.push(this.__makeDataConvertStepHandler(idx, idx, ntype, datautils, checkud, ud));
        }

        const stepCnt = steps.length;
        return checkud ?
                function ssvDataConverter(target, arr) { target.length = colLen; for (let i = 0; i < stepCnt; i++) { steps[i](target, arr); } } :
                function csvDataConverter(target, arr) { for (let i = 0; i < stepCnt; i++) { steps[i](target, arr); } };
    };
    ...
    _pDatasetBase.__makeDataMappingFunc = function (colArr, colCnt, type)
    {
        ...
        for (let i = 0; i < colLen; i++)
        {
            ...
            const idx = idMap[colinfo.id];
            if (idx != null)
            {
                steps.push(this.__makeDataConvertStepHandler(colinfo._index, idx, colinfo.ntype, datautils, checkud, ud));
            }
        }

        const stepCnt = steps.length;
        return checkud ?
                function ssvDataMappingFunc(target, arr) { target.length = colLen; for (let i = 0; i < stepCnt; i++) { steps[i](target, arr); } } :
                function csvDataMappingFunc(target, arr) { for (let i = 0; i < stepCnt; i++) { steps[i](target, arr); } };
    };
    ...
    _pDatasetBase.__ssvSetConstColInfo = function (strColInfo)
    {
        ...
        var env = this._getEnvironment();    
        var _cs_ = env?._getSSVUnitSeparator() || nexacro.fromCharCode(0x1f);
    ...
    _pDatasetBase._getColLinesFromSSVLines_with_arraybuffer = function (data, offset, sep, colLines)
    {
        if (sep == undefined)
        {
            sep = this._getEnvironment()?._getSSVRecordSeparator() || nexacro.fromCharCode(0x1e);
        }
    ...
    {
        var _rs_ = this._getEnvironment()?._getSSVRecordSeparator() || nexacro.fromCharCode(0x1e);
    ...
    _pDatasetBase.__writeSSVRowData = function (list, type, rowRow)
    {
        ...
        var _rs_ = env?._getSSVRecordSeparator() || nexacro.fromCharCode(0x1e);
        var _cs_ = env?._getSSVUnitSeparator() || nexacro.fromCharCode(0x1f);
    ...
    // load BIN
    //---------------------------------------------
    _pDatasetBase.__makeBINDataMappingStepHandler = function (targetIdx, srcIdx, targetNtype, sourcetype, datautils)
    {
        if (targetNtype === sourcetype)
        {
            if (sourcetype === 4)
            {
                return function (target, arr) { target[targetIdx] = datautils.toDecimalFromText(arr[srcIdx]); };
            }
            return function (target, arr) { target[targetIdx] = arr[srcIdx]; };
        }

        const is_date = (sourcetype === 5 || sourcetype === 6 || sourcetype === 7);
        switch (targetNtype)
        {
            case 1:
                ...
                if (sourcetype === 2)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toTextFromInt(arr[srcIdx]); };
                }
                if (sourcetype === 3)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toTextFromFloat(arr[srcIdx]); };
                }
                if (is_date)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toTextFromDateTime(arr[srcIdx]); };
                }
                return function (target, arr) { target[targetIdx] = arr[srcIdx]; };
            case 2:
                if (sourcetype === 1 || sourcetype === 4)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toIntFromText(arr[srcIdx]); };
                }
                if (sourcetype === 2)
                {
                    return function (target, arr) { target[targetIdx] = arr[srcIdx]; };
                ...
                if (sourcetype === 3)
                {
                    return function (target, arr) { target[targetIdx] = nexacro._toInt(arr[srcIdx]); };
                }
                if (is_date)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toIntFromText(arr[srcIdx]); };
            ...
            case 3:
                ...
                return function (target, arr) { target[targetIdx] = datautils.toFloatFromText(arr[srcIdx]); };
            case 4:
                if (sourcetype === 1 || sourcetype === 4)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toDecimalFromText(arr[srcIdx]); };
                }
                return function (target, arr) { target[targetIdx] = datautils.toDecimal(arr[srcIdx]); };
            case 5:
                if (sourcetype === 1 || sourcetype === 4)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toDateFromText(arr[srcIdx]); };
                }
                return function (target, arr) { target[targetIdx] = datautils.toDate(arr[srcIdx]); };
            case 6:
                if (sourcetype === 1 || sourcetype === 4)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toTimeFromText(arr[srcIdx]); };
                }
                return function (target, arr) { target[targetIdx] = datautils.toTime(arr[srcIdx]); };
            case 7:
                if (sourcetype === 1 || sourcetype === 4)
                {
                    return function (target, arr) { target[targetIdx] = datautils.toDateTimeFromText(arr[srcIdx]); };
                }
                return function (target, arr) { target[targetIdx] = datautils.toDateTime(arr[srcIdx]); };
            case 8:
                return null;
            default: 
                return null;
    ...
    _pDatasetBase.__makeBINDataConvertFunc = function (type)
    {
        ...
        for (let idx = 0; idx < colLen; idx++)
        {
            if (colinfos[idx].ntype == 4)
            {
                steps.push(function (target, arr) { target[idx] = datautils.toDecimalFromText(arr[idx]); });
            }
            else
            {
                steps.push(function (target, arr) { target[idx] = arr[idx]; });
            }
        }

        const stepCnt = steps.length;
        return function binDataConverter(target, arr) {
            target.length = colLen;
    ...
    _pDatasetBase.__makeBINDataMappingFunc = function (colArr, colCnt, type)
    {
        ...
        const typeArr = Array.from({ length: colCnt });
        for (let i = 0; i < colCnt; i++)
        {
            idMap[colArr[i].id] = i;
            typeArr[i] = datautils._typeint[colArr[i].type];
        }
        for (let i = 0; i < colLen; i++)
        {
            const colinfo = colinfos[i];
            ...
            if (idx != null)
            {
                const step = this.__makeBINDataMappingStepHandler(colinfo._index, idx, colinfo.ntype, typeArr[idx], datautils);
                if (step)
                {
                    steps.push(step);
                }
        ...
        const stepCnt = steps.length;
        return function binDataMappingFunc(target, arr)
        {
            target.length = colLen;
            for (let i = 0; i < stepCnt; i++)
            {
            ...
            function __saveBIN_constcol_loopFn(i)
            {
                ...
                switch (constVar.ntype) //_typeint 
                {
                    ...
                    case 2: //int, long
                        ...
                        var value = this._datautils.convert(this._convertValueBySaveProp(colVal), constVar.ntype);
    ...
    nexacro.TransactionItem = function (path, context, svcid, inDatasetsParam, outDatasetsParam, argsParam, datatype, async, last_modified, version)
    {
        ...
        nexacro._CommunicationItem.call(this, path, "data", false, last_modified, version, env); //"data"type -> this.type
        ...
        var hascookie = env._hasCookieVariables();
    ...
    _pTransactionItem._getCacheList = function (path)
    {
        if (this._env)
        {
            return this._env._getModuleCacheList(path, "ds");
        }
        return nexacro._DataCacheList[path];
    };

    _pTransactionItem._addCacheList = function (path, data)
    {
        if (this._env)
        {
            return this._env._addModuleCacheList(path, data, "ds");
        }
        return nexacro._DataCacheList[path] = data;
    };
    ...
    _pTransactionItem.on_load_data = function (data, cookie, last_modified)
    {
        ...
        if (bcache)
        {
            var d_cache = this._getCacheList(this.path);
            if (!d_cache)
            {
                this._addCacheList(this.path, new nexacro._DataCache(parameters, datasets, last_modified, this.version)._setContext(this.context));
            }
            else
            {
        ...
        if (view && view._is_view)
        {
            ...
            {
                triggertype = "onmodelloadsuccess";
            }
            else
            {
                triggertype = "onmodelloadfail";
            }
            let evt = new nexacro.EventInfo(this, triggertype);
            manager._notifyTrigger(triggertype, triggerobj, triggerview, evt);
        }
    ...
    _pTransactionItem.on_load_xmldom = function (xmldom, cookie, last_modified)
    {
        ...
        if (this.bcache)
        {
            ...
            if (!d_cache)
            {
                this._addCacheList(this.path, new nexacro._DataCache(ret[1], ret[2], last_modified, this.version)._setContext(this.context));
            }
            else
            {
    ...
    _pTransactionItem.on_error = function (errstatus, fireerrorcode, returncode, locationurl, extramsg)
    {
        ...
        if (n > 0)
        {
            for (var i = 0; i < n; i++)
            {
                ...
                if (target._is_alive != false)
                {
                    const env = target.context._getEnvironment();
                    if (env)
                    ...
                    if (env)
                        nexacro._popCurrentEnvironment();
                    if (ret)
                    {
                        if (this._usewaitcursor)
                        {
            ...
            if (view && view._is_view)
            {
                for (var j = 0; this.outputDatasets.length > j; j++)
                {
                    if (this.outputDatasets[j].lval == view._p_viewdataset)
                    {
                        ...
                        let evt = new nexacro.EventInfo(this, "onmodelloadfail");
                        const env = form._getEnvironment();
                        if (env)
                            nexacro._pushCurrentEnvironment(env);
                        manager._notifyTrigger("onmodelloadfail", triggerobj, triggerview, evt);
                        if (env)
                            nexacro._popCurrentEnvironment();
                        break;
                    }
    ...
    _pTransactionItem.__serializeXML = function ()
    {
        ...
        var env = this._getEnvironment();
        var enginecookievars = env._getCookieVariables(4);
        if (enginecookievars)
        {
        ...
        enginecookievars = env._getCookieVariables(6);  // secure cookie
        if (enginecookievars)
        {
            for (pro in enginecookievars)
            {
    ...
    _pTransactionItem._deserializeUint8Array = function (data_array)
    {
        ...
        {
            const env = this._getEnvironment();
            _rs_ = env?._getSSVRecordSeparator() || nexacro.fromCharCode(0x1e);
        }
    ...
    _pTransactionItem._setParamter = function (id, val)
    {
        ...
        else //   2.application globalvariable
        {
            ...
            {
                const env = this._getEnvironment();
                const hasvariable = env?._hasEnvironmentVariable(id);
                if (hasvariable)
                    env._setEnvironmentVariable(id, val);
            }
                        ...
                        if (remoteId && remoteId.length)
                        {
                            ...
                            if (localIds)
                            {
                                ...
                                for (i = 0; i < localIds.length; i++)
                                {
                                    ...
                                    if (!ds)
                                    {
                                        ds = new nexacro.DatasetBase(remoteId, this.context);
                                    }
