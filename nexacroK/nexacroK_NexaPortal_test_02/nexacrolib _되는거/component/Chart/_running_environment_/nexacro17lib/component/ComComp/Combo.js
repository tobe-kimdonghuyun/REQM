...
if (!nexacro.Combo)
{
    ...
    _pCombo.on_created_contents = function (win)
    {
        ...
        if (nexacro._enableaccessibility)
        {
            ...
            //  this._setAccessibilityActiveDescendant(this.comboedit._input_element);
    ...
    _pCombo._on_drop_onclick = function (obj, e) { }; // control
    ...
    _pCombo._showPopup = function (ds, index)
    {
        ...
        if (ret)
        {
            ...
            if (rowcnt != this._innerdataset.rowcount)
                index = this.index; // filter등에서 변경됨.
    ...
    _pComboEditControl.on_keydown_basic_action = function (keycode, alt_key, ctrl_key, shift_key/*, refer_comp*/)
    {
        if (this.readonly || !this._isEnable())
        {
            return;
    ...
    _pComboPopupControl._getPopupPosition = function ()
    {
        ...
        if (combo && combolist && mainframe)
        {
            ...
            if (screen_avail_height > window_height && mainframe_elem_pos.y + window_height > screen_avail_height) // browser under screen
