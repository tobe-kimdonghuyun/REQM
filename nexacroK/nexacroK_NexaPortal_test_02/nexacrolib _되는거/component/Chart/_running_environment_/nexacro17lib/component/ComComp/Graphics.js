    ...
    _pGraphicsQuadTree.add = function (item)
    {
        ...
        while (!this._checkRegion(item))
        {
            if (i == 20)
            {
				...
				trace("error checkRegion (add) " + item.id + ":" + rect.left + "," + rect.top + "," + rect.width + "," + rect.height);
                return;
            }
            i++;
        }
...
if (!nexacro.GraphicsRect)
{
    ...
    _pGraphicsRect.on_drawShape = function (ctx, strokeMatrix)
    {
        var sz = this._size,
			...
			//x = -w / 2,
            //y = -h / 2,
        var kappa = nexacro._GraphicsLib._KAPPA;
        if (rx > mx)
            rx = mx/* * kappa*/;
        if (ry > my)
            ry = my/* * kappa*/;
...
if (!nexacro.GraphicsImage)
{
    ...
    _pGraphicsImage.set_image = function (v)
	{
		if (v instanceof nexacro.Image)
		{
			...
			{
				/*if (v.handle && v.src && v.width && v.height)
				{
					if (!this._imgobj)
						this._imgobj = {};
					...
					if ((this.width <= 0 || this.width != v.width) && v.width > 0)
					{
						this.imagewidth = v.width;
						this.set_width(this.imagewidth);
					}
					if ((this.height <= 0 || this.height != v.height)  && v.height > 0)
					{
						this.imageheight = v.height;
...
if (!nexacro.GraphicsPath)
{
    ...
    _pGraphicsPath.arcTo = function (x , y , radiusx , radiusy , rotation, clockwise, large)
    {
    ...
    _pGraphicsPath.on_getRect = function (bStrokeWidth, iscurrent)
    {
		...
		if (bStrokeWidth)
		{
			...
			var boundx;
			var boundy;
			var checkrect = new nexacro.Rect();
			for (i = 0, l = segs.length; i < l; i++)
			{
				var seg = segs[i];
				ptPos.x = seg.point.x;
...
if (!nexacro.GraphicsLine)
{
	...
	_pGraphicsLine.on_getRect = function (bStrokeWidth, iscurrent)
	{
		...
		if ((this.x1 == this.x2) || (this.y1 == this.y2))
		{
			...
			if (isSameLine)
			{
				if (this.x1 == this.x2) isxsame = true;
				if (this.y1 == this.y2) isysame = true;
				bStrokeWidth = true;
			}
		}
		if (iscurrent) rect = null;
...
if (!nexacro._GraphicsControl)
{
    //==============================================================================
    // nexacro._GraphicsControl
    //==============================================================================
    nexacro._GraphicsControl = function (id, left, top, width, height, right, bottom, minwidth, maxwidth, minheight, maxheight, parent)
    {
    ...
    var _pGraphicsControl = nexacro._createPrototype(nexacro.Component, nexacro._GraphicsControl);
    nexacro._GraphicsControl.prototype = _pGraphicsControl;
    ...
    //===============================================================
    // nexacro._GraphicsControl : Create & Destroy & Update
    //===============================================================	
    ...
    //===============================================================
    // nexacro._GraphicsControl : Properties
    //===============================================================

    //===============================================================
    // nexacro._GraphicsControl : Methods
    //===============================================================
    ...
    _pGraphicsControl.on_apply_accessibilitypattern = function (index, bselect)
    {
        ...
        else if (index == 5)
        {
            ...
            pctx.setElementStrokeStyle(nexacro.ColorObject(patterncolor));
            var x0 = 2;
            var x1 = pctx.width - x0;
            var y0 = 2;
            var y1 = pctx.height - y0;
    ...
    //===============================================================
    // nexacro._GraphicsControl : Event Handlers
    //===============================================================	

    //===============================================================
    // nexacro._GraphicsControl : Logical part
    //===============================================================
    // 검토 후 노출
    ...
    //===============================================================
    // nexacro._GraphicsControl : Util Function
    //===============================================================
