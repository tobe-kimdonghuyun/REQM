...
if (!nexacro.ImageViewer)
{
    ...
    //===============================================================
    // nexacro.ImageViewr : Event Handlers
    //===============================================================
    ...
    _pImageViewer.on_fire_sys_onkeyup = function (key_code, alt_key, ctrl_key, shift_key, from_comp, from_refer_comp) //  override for keyup 'enter' or 'space'
    {
    ...
    //===============================================================
    // nexacro.ImageViewr : Util Function
    //===============================================================
