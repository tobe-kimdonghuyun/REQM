(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Grid("Grid00","236","93","344","311",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("Button02","50","232","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("transactionpromise");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("Button03","50","298","170","68",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("await / async ");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("Button06","53","172","165","52",null,null,null,null,null,null,this);
            obj.set_taborder("4");
        ...
        // User Script
        this.registerScript("promisetest_trasaction.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.Button02_onclick = function(obj,e)
        {
        	...
        	const req = this.transaction(svrid,"http://172.10.12.45:9090/service_jsp/RP_103514_dummyXML.jsp","input1=Dataset02","Dataset03=output",sArgs, "", false);
        	trace(req);
        	// 결과 처리
        	if(req)
        	{
        ...
        this.loadIncludeScript("promisetest_trasaction.xfdl");
