(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj.getSetter("onerror").set("fileDownTrans_onerror");
            obj.getSetter("onprogress").set("fileDownTrans_onprogress");
            obj.getSetter("onsuccess").set("fileDownTrans_onsuccess");
            this.addChild(obj.name, obj);


            obj = new nexacro.FileUpTransfer("fileUpTrans", this);
            obj.getSetter("onerror").set("fileUpTrans_onerror");
            obj.getSetter("onprogress").set("fileUpTrans_onprogress");
            obj.getSetter("onsuccess").set("fileUpTrans_onsuccess");
            this.addChild(obj.name, obj);


            obj = new nexacro.FileDialog("fileDialog", this);
            obj.getSetter("onclose").set("fileDialog_onclose");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("RP_104566_FileUpTransfer_FileDownTransfer_Sample08.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.loadIncludeScript("RP_104566_FileUpTransfer_FileDownTransfer_Sample08.xfdl");
