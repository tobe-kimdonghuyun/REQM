(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Div("div00","439","22","331","178",null,null,null,null,null,null,this);
            obj.set_border("1px solid blue");
            obj.set_taborder("3");
            obj.set_text("div00");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn00","261","152","120","50",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("0");
            obj.set_text("btn00");
            this.div00.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt00","100","149","140","58",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("1");
            this.div00.addChild(obj.name, obj);

            obj = new nexacro.Div("div01","805","21","345","189",null,null,null,null,null,null,this);
            obj.set_border("1px solid red");
            obj.set_taborder("4");
            obj.set_text("div01");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn00","224","160","120","50",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("0");
            obj.set_text("btn00");
            this.div01.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt00","74","160","140","48",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("1");
            this.div01.addChild(obj.name, obj);

            obj = new nexacro.Button("Button01_00","58","1125","1002","50",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Button01");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt00","700","207","140","58",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt00_00","691","530","140","58",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("Form_Work1.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        {
        	this.div00.form.addEventHandler("onmousewheel", this.div00_onmousewheel, this);
        };
