(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("btn02","50","270","590","50",null,null,null,null,null,null,this);
            obj.set_icon("url(\'theme://images/btn_RF_1Depth01.png\')");
            obj.set_taborder("4");
            obj.set_text("btn02");
            this.addChild(obj.name, obj);

            obj = new nexacro.TextField("TextField00","442","92","250","60",null,null,null,null,null,null,this);
            obj.set_labeltext("TextField00");
            obj.set_taborder("5");
            this.addChild(obj.name, obj);

            obj = new nexacro.DateField("DateField00","433","376","250","60",null,null,null,null,null,null,this);
            obj.set_labeltext("DateField00");
            obj.set_taborder("6");
            this.addChild(obj.name, obj);

            obj = new nexacro.DateRangePicker("DateRangePicker00","217","385","250","330",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            this.addChild(obj.name, obj);

            // Layout Functions
            //-- Default Layout : this
            obj = new nexacro.Layout("default","mobile,medium,large,desktop",640,720,this,function(p){});
        ...
        // User Script
        this.registerScript("MLM_640.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.loadIncludeScript("MLM_640.xfdl");
