(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("btn00","30","93","7rem","2.5rem",null,null,null,null,null,null,this);
            obj.set_font("1.5rem/normal \"-apple-system\",\"BlinkMacSystemFont\",\"Roboto\",\"Helvetica\",\"Arial\",\"Apple SD Gothic Neo\",\"sans-serif\"");
            obj.set_taborder("2");
            obj.set_text("btn00");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn02","30","171","120","50",null,null,null,null,null,null,this);
            obj.set_font("18px/normal \"-apple-system\",\"BlinkMacSystemFont\",\"Roboto\",\"Helvetica\",\"Arial\",\"Apple SD Gothic Neo\",\"sans-serif\"");
            obj.set_taborder("4");
            obj.set_text("btn02");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn03","243","345","247","65",null,null,null,null,null,null,this);
            obj.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01S.png\')");
            obj.set_taborder("5");
            obj.set_text("btn00 btn01 btn02 btn03 btn04");
            obj.set_textwidth("150");
            obj.set_tooltiptext("btn00 btn01 btn02 btn03 btn04");
            obj.set_wordWrap("char");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn03_00","243","418","247","65",null,null,null,null,null,null,this);
            obj.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01S.png\')");
            obj.set_taborder("6");
            obj.set_text("btn00 btn01 btn02 btn03 ");
            obj.set_textwidth("150");
            obj.set_tooltiptext("btn00 btn01 btn02 btn03 ");
            obj.set_wordWrap("char");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn03_00_00","243","498","247","65",null,null,null,null,null,null,this);
            obj.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01S.png\')");
            obj.set_taborder("7");
            obj.set_text("btn00 btn01 btn02 btn03 ");
            obj.set_tooltiptext("btn00 btn01 btn02 btn03 ");
            ...
            obj = new nexacro.Button("btn03_01","243","270","247","65",null,null,null,null,null,null,this);
            obj.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01S.png\')");
            obj.set_taborder("8");
            obj.set_text("btn00 btn01 btn02 btn03 btn04");
            obj.set_tooltiptext("btn00 btn01 btn02 btn03 btn04");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new nexacro.Layout("default","mobile,medium,large,desktop",800,720,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.btn00.move("30","93","7rem","2.5rem",null,null);
                ...
                p.btn02.move("30","171","120","50",null,null);

                p.btn03.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01S.png\')");
                p.btn03.set_taborder("5");
                p.btn03.set_text("btn00 btn01 btn02 btn03 btn04");
                p.btn03.set_textwidth("150");
                p.btn03.set_tooltiptext("btn00 btn01 btn02 btn03 btn04");
                p.btn03.set_wordWrap("char");
                p.btn03.move("243","345","247","65",null,null);

                p.btn03_00.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01S.png\')");
                p.btn03_00.set_taborder("6");
                p.btn03_00.set_text("btn00 btn01 btn02 btn03 ");
                p.btn03_00.set_textwidth("150");
                p.btn03_00.set_tooltiptext("btn00 btn01 btn02 btn03 ");
                p.btn03_00.set_wordWrap("char");
                p.btn03_00.move("243","418","247","65",null,null);

                p.btn03_00_00.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01S.png\')");
                p.btn03_00_00.set_taborder("7");
                p.btn03_00_00.set_text("btn00 btn01 btn02 btn03 ");
                p.btn03_00_00.set_tooltiptext("btn00 btn01 btn02 btn03 ");
                p.btn03_00_00.set_wordWrap("char");
                p.btn03_00_00.move("243","498","247","65",null,null);

                p.btn03_01.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01S.png\')");
                p.btn03_01.set_taborder("8");
                p.btn03_01.set_text("btn00 btn01 btn02 btn03 btn04");
                p.btn03_01.set_tooltiptext("btn00 btn01 btn02 btn03 btn04");
                p.btn03_01.set_wordWrap("char");
                p.btn03_01.move("243","270","247","65",null,null);
            	}
            );
        ...
        // User Script
        this.registerScript("MLM_320_640.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        {
        	if (this.getLayoutInfo(e.newlayout, "width") == "320")
        ...
        this.loadIncludeScript("MLM_320_640.xfdl");
