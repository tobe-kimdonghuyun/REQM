(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Grid("Grid00","2","59","302","116",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_updateSortGroup_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_updateSortGroup_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_updateSortGroup_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_updateSortGroup_01.xfdl");
