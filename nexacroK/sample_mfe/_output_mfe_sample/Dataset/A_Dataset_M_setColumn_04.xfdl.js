(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_setColumn_04.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_setColumn_04.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_setColumn_04.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        ...
        tc1.task['getCellText'] = function(nRow, varCol){
        	...
        	result.push(this.Grid2.getCellText(nRow, varCol));
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST01"]],   ev: [true,,,"TEST01"]},
        				{vc: [[tapi.VBT_HIGHER,5],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST02"]],   ev: [false,"","",""]},
        				{vc: [[tapi.VBT_MAX,4],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST03"]],   ev: [true,,,"TEST03"]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST04"]],   ev: [true,,,"TEST04"]},
        				{vc: [[tapi.VBT_EXCEPTION,undefined],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST05"]],   ev: [true,,,"TEST05"]},
        				{vc: [[tapi.VBT_EXCEPTION,null],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST06"]],   ev: [true,,,"TEST06"]},
        				{vc: [[tapi.VBT_NORMAL,0],[tapi.VBT_EXCEPTION,"colA"],[tapi.VBT_NORMAL,"TEST07"]],   ev: [true,,,"TEST07"]},
        				...
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_MIN,0],[tapi.VBT_NORMAL,"TEST10"]],   ev: [true,,,"TEST10"]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_HIGHER,4],[tapi.VBT_NORMAL,"TEST11"]],   ev: [true,,,"TEST11"]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_MAX,4],[tapi.VBT_NORMAL,"TEST12"]],   ev: [true,,,"TEST12"]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,"TEST13"]],   ev: [true,,,"TEST13"]},
        				{vc: [[tapi.VBT_EXCEPTION,undefined],[tapi.VBT_EXCEPTION,undefined],[tapi.VBT_NORMAL,"TEST14"]],   ev: [true,,,"TEST14"]},
        				{vc: [[tapi.VBT_EXCEPTION,null],[tapi.VBT_EXCEPTION,null],[tapi.VBT_NORMAL,"TEST15"]],   ev: [true,,,"TEST15"]},
        				//cancolumnchange 리턴값 false 후
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST16"]],   ev: [false,"","","TEST04"]},
        				//filter 후
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST17"]],   ev: [true,,,"TEST17"]},
        				//keystring group 후
        				{vc: [[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST18"]],   ev: [false,"","","TEST17"]},
        			]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        		...
        		if(vdAdt.getIndexVC() == 17)
        		{
        			...
        			this.ds_data2.set_filterstr("colA != '1'");
        		}
        		if(vdAdt.getIndexVC() == 18)
        		{
        			this.dataset.set_filterstr("");
        			this.ds_data2.set_filterstr("");
        			this.dataset.set_keystring("G:-colA");
        			this.ds_data2.set_keystring("G:-colA");
        		}
        	},
        	run: function () {
        		var vdAdt = tapi.getVdAdaptor();
        ...
        ***********************************************************************/
        ...
        this.ds_data2_cancolumnchange = function(obj,e)
        {
        ...
        this.ds_data2_oncolumnchanged = function(obj,e)
        {
        ...
        this.loadIncludeScript("A_Dataset_M_setColumn_04.xfdl");
