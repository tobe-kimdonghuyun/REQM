(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_extractRowsNF_01_v2");
            this.set_titletext("TA_Dataset_M_extractRowsNF_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_extractRowsNF_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Grid("Grid00","5","61","295","159",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_extractRowsNF_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_extractRowsNF_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_extractRowsNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset extractRowsNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset extractRowsNF Method Test",
        ...
        tc1.task['extractRowsNF'] = function(strExpr, nStartIdx, nEndIdx, arrArgs) {
        	var result = [];
        	var rtnextractRowsNF;

        	if(nStartIdx == "생략" && nEndIdx == "생략" && arrArgs == "생략")
        		rtnextractRowsNF = this.dataset.extractRowsNF(strExpr);
        	else if(nEndIdx == "생략" && arrArgs == "생략")
        		rtnextractRowsNF = this.dataset.extractRowsNF(strExpr, nStartIdx);
        	else if(arrArgs == "생략")
        		rtnextractRowsNF = this.dataset.extractRowsNF(strExpr, nStartIdx, nEndIdx);
        	else
        		rtnextractRowsNF = this.dataset.extractRowsNF(strExpr, nStartIdx, nEndIdx, arrArgs);

        	for(var i=0; i<rtnextractRowsNF.length; i++)
        		result.push(rtnextractRowsNF[i]);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "extractRowsNF(strExpr, nStartIdx, nEndIdx, arrArgs) 수행",
        	autoTaskFlow : ["extractRowsNF"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : strExpr, nStartIdx, nEndIdx, arrArgs, ev : 리턴값
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [1,2]},
         				{vc: [[tapi.VBT_NORMAL,"colA == '1'"],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [0]},
        				{vc: [[tapi.VBT_NORMAL,"ConstC == 'C'"],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [0,1,2,3,4]},
        				{vc: [[tapi.VBT_EXCEPTION,"test == 'C'"],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [""]},
        				{vc: [[tapi.VBT_EXCEPTION,"colC == '1000'"],[tapi.VBT_EXCEPTION,0],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [""]},
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_NORMAL,2],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [2]},
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_MAX,5],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [""]},
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_LOWER,-1],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [1,2]},
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_HIGHER,6],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [""]},
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_EXCEPTION,undefined],[tapi.VBT_MAX,5],[tapi.VBT_EXCEPTION,"생략"]],ev: [1,2]},
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_MIN,0],[tapi.VBT_EXCEPTION,null],[tapi.VBT_EXCEPTION,"생략"]],ev: [1,2]},
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_EXCEPTION,"생략"],[tapi.VBT_EXCEPTION,"생략"],[tapi.VBT_EXCEPTION,"생략"]],ev: [1,2]},
        				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"],[tapi.VBT_EXCEPTION,"생략"]],ev: [2]},
        				{vc: [[tapi.VBT_NORMAL,"colC == $0"],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5],[tapi.VBT_NORMAL,tc1.userdata.arrArgs]],ev: [1,2]},
        				//filter 후
         				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"],[tapi.VBT_EXCEPTION,"생략"]],ev: [2]},
         				//grouping 후
        				{vc: [[tapi.VBT_NORMAL,"colC == '400'"],[tapi.VBT_MIN,0],[tapi.VBT_EXCEPTION,"생략"],[tapi.VBT_EXCEPTION,"생략"]],ev: [4]},
        			]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "extractRowsNF":
        			var rtn = tc1.task['extractRowsNF'].call(this, strExpr, nStartIdx, nEndIdx, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_extractRowsNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_extractRowsNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_extractRowsNF_01.xfdl");
