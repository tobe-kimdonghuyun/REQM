(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_DataObject_E_onsuccess_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_DataObject_E_onsuccess_01.xfdl","libevent::event.util.xjs");
        this.addIncludeScript("A_DataObject_E_onsuccess_01.xfdl","libevent::event.wrapper.xjs");
        this.registerScript("A_DataObject_E_onsuccess_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "DataObject onsuccess Event Test",
        ...
        tc1.task['eventChk'] = function(eventtype) {
        	var result = [];
           	...
           	this.request_do2.request("test1","GET","http://172.10.12.253:8080/nx17TestSystem/jsp/RESTAPI/test.json");
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "폼 실행후 request GET 통신",
        	autoTaskFlow : ["eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        			{vc : [[tapi.VBT_NORMAL, "request"]], 		ev : ["request_do2","onsuccess",'[{"id":"tobe","type":"admin"},{"id":"test","type":"guest"}]',"test1","http://172.10.12.253:8080/nx17TestSystem/jsp/RESTAPI/test.json",this.request_do2.id,this.request_do2.id]}
        			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        		]
        	},
        	prepare: function () {
        ...
        ***********************************************************************/
        ...
        this.request_do2_onsuccess = function(obj,e)
        {
        	var vdAdt = tapi.getVdAdaptor();
        	if (vdAdt)
        		vdAdt.releaseWait();
        	...
        	tc1.userdata.eventChkList1.push(e.serviceid);
        ...
        this.on_initEvent = function()
        {
            ...
            this.request_do2.addEventHandler("onsuccess",this.request_do2_onsuccess,this);
        };

        this.loadIncludeScript("A_DataObject_E_onsuccess_01.xfdl");
