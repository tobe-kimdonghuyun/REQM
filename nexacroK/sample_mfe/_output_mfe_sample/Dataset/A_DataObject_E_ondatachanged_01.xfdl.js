(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_DataObject_E_ondatachanged_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_DataObject_E_ondatachanged_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_DataObject_E_ondatachanged_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        ...
        tc1.task['setColumn'] = function(nRow, varCol, varVal) {
        	...
        	if (varVal == "TEST01" || varVal == "TEST03" || varVal == "TEST05")
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST01"]],   ev: [true,"ondatachanged",true,1,"ds_data1","DataObject00","TEST01"]},
        				{vc: [[tapi.VBT_MIN,1],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST02"]],   ev: [true,"",1]},
        				{vc: [[tapi.VBT_MIN,1],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,"TEST03"]],   ev: [true,"ondatachanged",true,1,"ds_data1","DataObject00","TEST03"]},
        				{vc: [[tapi.VBT_MIN,2],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST04"]],   ev: [true,"",2]},
        				{vc: [[tapi.VBT_MIN,3],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,"TEST05"]],   ev: [true,"ondatachanged",true,2,"ds_data1","DataObject00","TEST05"]},
        ...
        ***********************************************************************/
        ...
        this.DataObject00_ondatachanged = function(obj,e)
        {
        	...
        	tc1.userdata.eventChkList1.push(e.infoarray[0].sourcedatasetid);
        ...
        this.loadIncludeScript("A_DataObject_E_ondatachanged_01.xfdl");
