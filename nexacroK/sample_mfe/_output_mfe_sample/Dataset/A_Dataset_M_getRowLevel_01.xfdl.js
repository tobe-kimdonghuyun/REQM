(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getRowLevel_01_v2");
            this.set_titletext("TA_Dataset_M_getRowLevel_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getRowLevel_48139_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","298","295","142",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Edit("edt_strKeyString","104","189","197","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_value("G:+colA-colB");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_getRowLevel","123","258","114","31",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("getRowLevel()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static00","6","186","106","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_text("strKeyString::");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_updateSortGroup_keystring","79","221","222","31",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("10");
            obj.set_text("updateSortGroup(strKeyString)");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static05","14","262","58","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("11");
            obj.set_text("nRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_nRow","73","259","42","31",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("12");
            obj.set_value("0");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getRowLevel_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getRowLevel_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getRowLevel_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getRowLevel Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getRowLevel Method Test",
        ...
        tc1.task['getRowLevel'] = function(nRow) {
        	var result = [];

        	var rtngetRowLevel = this.dataset.getRowLevel(nRow);

        	result.push(rtngetRowLevel);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getRowLevel() 수행",
        	autoTaskFlow : ["getRowLevel"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        			...
        			{vc: [[tapi.VBT_HIGHER,10]],   ev: [0]},
        			{vc: [[tapi.VBT_MAX,9]],  	  ev: [1]},
        			{vc: [[tapi.VBT_NORMAL,5]],   ev: [1]},
        	...
        	prepare: function () {
        		...
        		if(vdAdt.getIndexVC() == 0)
        			this.dataset.set_keystring("G:+colA-colB");
        	},
        	run: function () {
        		var vdAdt = tapi.getVdAdaptor();
        		...
        		switch(taskName) {
        		case "getRowLevel":
        			var rtn = tc1.task['getRowLevel'].call(this, nRow);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getRowLevel_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getRowLevel_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_getRowLevel.addEventHandler("onclick",this.btn_getRowLevel_onclick,this);
            this.btn_updateSortGroup_keystring.addEventHandler("onclick",this.btn_updateSortGroup_keystring_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getRowLevel_01.xfdl");
