(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getConstColumn_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getConstColumn_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getConstColumn_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0]],   	  ev: ["a"]},
        				{vc: [[tapi.VBT_HIGHER,3]],   ev: [""]},
        				{vc: [[tapi.VBT_MAX,2]],  	  ev: ["c"]},
        				{vc: [[tapi.VBT_NORMAL,1]],   ev: ["b"]},
        				...
        				{vc: [[tapi.VBT_EXCEPTION,undefined]],   ev: ["a"]},
        				{vc: [[tapi.VBT_EXCEPTION,null]],   ev: ["a"]},
        			]
        	},
        	prepare: function () {
        	},
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_getConstColumn_01.xfdl");
