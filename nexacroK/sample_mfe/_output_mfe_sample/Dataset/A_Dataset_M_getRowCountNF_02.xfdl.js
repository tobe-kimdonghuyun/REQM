(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getRowCountNF_02.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getRowCountNF_02.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getRowCountNF_02.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_getRowCountNF_02.xfdl");
