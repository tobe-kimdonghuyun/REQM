(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_loadCSV_01_v2");
            this.set_titletext("TA_Dataset_M_loadCSV_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_loadCSV_78827_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_loadCSV_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_loadCSV_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_loadCSV_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset loadCSV Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.03.05  김형철   최초 작성
        *     2021.04.06  최창열   ","로 시작하는 데이터 CASE(RP 91917)
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset loadCSV Method Test",
        ...
        tc1.task['loadCSV'] = function(varCsvData, bClear) {
        	var result = [];
        	var rtnloadCSV;
        	var getrowPosition;

        	if(bClear == "생략")
        		rtnloadCSV = this.dataset3.loadCSV(varCsvData);
        	else
        		rtnloadCSV = this.dataset3.loadCSV(varCsvData, bClear);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "loadCSV(varCsvData, bClear) 수행",
        	autoTaskFlow : ["loadCSV", "getCellText", "eventChk"],
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_NORMAL,true]],   ev: [5,0,4,"ds_data3",1,",유동규",100,"투우","","","","onload",0]},
        				{vc: [[tapi.VBT_EXCEPTION,"생략"]], ev: [5,0,4,"ds_data3",1,",유동규",100,"투우","","","","onload",0]},
        		]
        	},
        	prepare: function () {
        		var vdAdt = tapi.getVdAdaptor();
        		if(vdAdt.getIndexVC() == 0)
        			tc1.userdata.strCSV = this.dataset1.saveCSV();
        	...
        	run: function () {
        		...
        		var varCsvData = tc1.userdata.strCSV;
        		var bClear = vdAdt.getValue(0);

        		switch(taskName) {
        		case "loadCSV":
        			var rtn = tc1.task['loadCSV'].call(this, varCsvData, bClear);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_loadCSV_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_loadCSV_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_M_loadCSV_01.xfdl");
