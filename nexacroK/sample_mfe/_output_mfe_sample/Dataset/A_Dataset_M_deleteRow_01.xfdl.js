(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_deleteRow_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_deleteRow_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_deleteRow_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0]],      ev: [true,0,"onrowsetchanged",20,"canrowposchange","onrowposchanged","onvaluechanged"]},
        				{vc: [[tapi.VBT_HIGHER,10]],  ev: [false, 0, "", "", "", ""]},
        				{vc: [[tapi.VBT_MAX,3]],      ev: [true,0,"onrowsetchanged",20,"","",""]},
        				{vc: [[tapi.VBT_NORMAL,1]],   ev: [true,0,"onrowsetchanged",20,"","",""]},
        				//삭제된 Row 가 마지막 위치의 Row 이면
        				{vc: [[tapi.VBT_NORMAL,1]],   ev: [true,0,"onrowsetchanged",20,"","",""]},
        				//모든 데이터가 삭제되면
        				{vc: [[tapi.VBT_MIN,0]],   ev: [true,-1,"onrowsetchanged",20,"","onrowposchanged","onvaluechanged"]}
        		]
        	},
        	prepare: function () {
        ...
        tc1.validator ['tc1_vd2'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				//vc : nRow, ev : 리턴값, rowposition, 이벤트정보
        			    {vc: [[tapi.VBT_LOWER,-1]],   ev: [false,0,"","","",""]},
        				{vc: [[tapi.VBT_MIN,0]],      ev: [true,0,"onrowsetchanged",20,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_HIGHER,10]],  ev: [false, 0, "", "", "", ""]},
        				{vc: [[tapi.VBT_MAX,3]],      ev: [true,0,"onrowsetchanged",20,"","",""]},
        				{vc: [[tapi.VBT_NORMAL,1]],   ev: [true,0,"onrowsetchanged",20,"","",""]},
        				{vc: [[tapi.VBT_EXCEPTION,undefined]],   ev: [true,0,"onrowsetchanged",20,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_EXCEPTION,null]],   ev: [true,-1,"onrowsetchanged",20,"","onrowposchanged","onvaluechanged"]}
        		]
        	},
        	prepare: function () {
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_deleteRow_01.xfdl");
