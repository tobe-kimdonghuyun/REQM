(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_findNFRowIndex_01_v2");
            this.set_titletext("TA_Dataset_M_findNFRowIndex_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_findNFRowIndex_48139_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_findNFRowIndex_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_findNFRowIndex_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_findNFRowIndex_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset findNFRowIndex Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset findNFRowIndex Method Test",
        ...
        tc1.task['filter'] = function() {
        	this.dataset.set_filterstr("colA > 1");
        }

        tc1.task['findNFRowIndex'] = function(nRowPos) {
        	var result = [];

        	var rtnfindNFRowIndex = this.dataset.findNFRowIndex(nRowPos);

        	result.push(rtnfindNFRowIndex);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "filter 후 findNFRowIndex() 수행",
        	autoTaskFlow : ["filter", "findNFRowIndex"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        			args : [
        			//vc : nRowPos, ev : 리턴값
        			{vc: [[tapi.VBT_LOWER,-1]],   ev: [-1]},
        			{vc: [[tapi.VBT_MIN,0]],   	  ev: [2]},
        			{vc: [[tapi.VBT_HIGHER,5]],   ev: [-1]},
        			{vc: [[tapi.VBT_MAX,2]],  	  ev: [4]},
        			{vc: [[tapi.VBT_NORMAL,1]],   ev: [3]},
        		]
        	},
        	prepare: function () {
        	},
        	run: function () {
        		...
        		var nRowPos = vdAdt.getValue(0);

        		switch(taskName) {
        		case "filter":
        			tc1.task['filter'].call(this);
        			break;
        		case "findNFRowIndex":
        			var rtn = tc1.task['findNFRowIndex'].call(this, nRowPos);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_findNFRowIndex_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_findNFRowIndex_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_findNFRowIndex_01.xfdl");
