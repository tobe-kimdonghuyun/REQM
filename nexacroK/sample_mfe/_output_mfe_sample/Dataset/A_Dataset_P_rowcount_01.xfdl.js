(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_P_rowcount_01_v2");
            this.set_titletext("TA_Dataset_P_rowcount_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_P_rowcount_48082_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","352","298","91",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_clear","241","272","63","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("Static00","13","238","73","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("rowcount");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txt_value","87","230","217","40",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_value("100");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_set","35","272","92","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("set");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_get","139","272","92","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_text("get");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_addRow","35","312","92","37",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("addRow");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_P_rowcount_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_P_rowcount_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_P_rowcount_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset rowcount Property
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset rowcount Property Test",
        ...
        tc1.task['rowcount'] = function() {
        	var result = [];
        	var rtngrowcount = this.dataset.rowcount;

        	result.push(rtngrowcount);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "rowcount 수행",
        	autoTaskFlow : ["rowcount"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "rowcount":
        			var rtn = tc1.task['rowcount'].call(this);
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "deleteRow 후 rowcount() 수행",
        	autoTaskFlow : ["rowcount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        ...
        tc1.validator ['tc1_vd3'] = {
        	description: "addRow 후 rowcount() 수행",
        	autoTaskFlow : ["rowcount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        ...
        tc1.validator ['tc1_vd4'] = {
        	description: "filterstr 후 rowcount() 수행",
        	autoTaskFlow : ["rowcount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        ...
        ***********************************************************************/
        this.TA_Dataset_P_rowcount_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_P_rowcount_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_P_rowcount_01.xfdl");
