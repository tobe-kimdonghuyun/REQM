(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Dataset("dsBtnMenu", this);
            obj._setContents({"ColumnInfo" : {"Column" : [{"id" : "MENU_ID","size" : "256","type" : "STRING"},{"id" : "MENU_NM","size" : "256","type" : "STRING"},{"id" : "MENU_LV","size" : "256","type" : "STRING"},{"id" : "HIPO_MENU_ID","size" : "256","type" : "STRING"},{"id" : "MENU_URL","size" : "256","type" : "STRING"},{"id" : "MODULE_CD","size" : "256","type" : "STRING"}]}});
            this.addChild(obj.name, obj);


            obj = new nexacro.Dataset("dsSettingsMenu", this);
            obj._setContents({"ColumnInfo" : {"Column" : [{"id" : "MENU_ENGL_NM","size" : "32","type" : "string"},{"id" : "ENGL_DISPLAY_PATH","size" : "32","type" : "string"},{"id" : "MODULE_CD","size" : "32","type" : "string"},{"id" : "CMMNBTNADD","size" : "32","type" : "string"},{"id" : "DISPLAY_PATH","size" : "32","type" : "string"},{"id" : "SYTM_FLAG_CD","size" : "32","type" : "string"},{"id" : "MENU_ORDR","size" : "16","type" : "bigdecimal"},{"id" : "PARM","size" : "0","type" : "undefined"},{"id" : "CMMNBTNSAVE","size" : "32","type" : "string"},{"id" : "MENU_ID","size" : "32","type" : "string"},{"id" : "MENU_URL","size" : "0","type" : "undefined"},{"id" : "PRGM_FILE_NM","size" : "0","type" : "undefined"},{"id" : "MENU_LV","size" : "16","type" : "bigdecimal"},{"id" : "SEARCH_SCOPE_CD","size" : "0","type" : "undefined"},{"id" : "MENU_PATH","size" : "32","type" : "string"},{"id" : "MENU_FLAG_CD","size" : "32","type" : "string"},{"id" : "CMMNBTNINIT","size" : "32","type" : "string"},{"id" : "CMMNBTNPRINT","size" : "32","type" : "string"},{"id" : "CMMNBTNEXCELDOWN","size" : "32","type" : "string"},{"id" : "CMMNBTNSEARCH","size" : "32","type" : "string"},{"id" : "CMMNBTNDEL","size" : "32","type" : "string"},{"id" : "MENU_NM","size" : "32","type" : "string"},{"id" : "REMK","size" : "0","type" : "undefined"},{"id" : "HIPO_MENU_ID","size" : "32","type" : "string"},{"id" : "PRGM_ID","size" : "0","type" : "undefined"},{"id" : "PRGM_PATH","size" : "0","type" : "undefined"}]},"Rows" : [{"MENU_ENGL_NM" : "설정","ENGL_DISPLAY_PATH" : "설정","CMMNBTNADD" : "0","DISPLAY_PATH" : "설정","SYTM_FLAG_CD" : "MO","MENU_ORDR" : "5","CMMNBTNSAVE" : "0","MENU_ID" : "SET00M","MENU_LV" : "0","MENU_PATH" : ",SET00M","MENU_FLAG_CD" : "M","CMMNBTNINIT" : "0","CMMNBTNPRINT" : "0","CMMNBTNEXCELDOWN" : "0","CMMNBTNSEARCH" : "0","CMMNBTNDEL" : "0","MENU_NM" : "설정","REMK" : "","HIPO_MENU_ID" : "0000000000","MODULE_CD" : "US"},{"MENU_ENGL_NM" : "사용자 설정","ENGL_DISPLAY_PATH" : "설정 > 사용자 설정","CMMNBTNADD" : "0","DISPLAY_PATH" : "설정 > 사용자 설정","SYTM_FLAG_CD" : "MO","MENU_ORDR" : "1","CMMNBTNSAVE" : "0","MENU_ID" : "SET10M","MENU_LV" : "1","MENU_PATH" : ",SET00M,SET10M","MENU_FLAG_CD" : "M","CMMNBTNINIT" : "0","CMMNBTNPRINT" : "0","CMMNBTNEXCELDOWN" : "0","CMMNBTNSEARCH" : "0","CMMNBTNDEL" : "0","MENU_NM" : "사용자 설정","HIPO_MENU_ID" : "SET00M","MODULE_CD" : "US"},{"MENU_ENGL_NM" : "테마 설정","ENGL_DISPLAY_PATH" : "설정 > 사용자 설정 > 테마 설정","CMMNBTNADD" : "0","DISPLAY_PATH" : "설정 > 사용자 설정 > 테마 설정","SYTM_FLAG_CD" : "MO","MENU_ORDR" : "1","CMMNBTNSAVE" : "0","MENU_ID" : "SET11M","MENU_LV" : "2","MENU_PATH" : ",SET00M,SET10M,SET11M","MENU_FLAG_CD" : "M","CMMNBTNPRINT" : "0","CMMNBTNINIT" : "0","CMMNBTNEXCELDOWN" : "0","CMMNBTNSEARCH" : "0","CMMNBTNDEL" : "0","MENU_NM" : "테마 설정","HIPO_MENU_ID" : "SET10M","MODULE_CD" : "US","MENU_URL" : "frame::frmThemeSetting.xfdl","PRGM_FILE_NM" : "frmThemeSetting.xfdl","PRGM_PATH" : "frame::frmThemeSetting.xfdl","PRGM_ID" : "SET11M"}]});
            this.addChild(obj.name, obj);


            obj = new nexacro.Dataset("dsGrdMenu", this);
            obj._setContents({"ColumnInfo" : {"Column" : [{"id" : "MENU_ID","size" : "256","type" : "STRING"},{"id" : "MENU_NM","size" : "256","type" : "STRING"},{"id" : "MENU_LV","size" : "256","type" : "STRING"},{"id" : "HIPO_MENU_ID","size" : "256","type" : "STRING"},{"id" : "MENU_URL","size" : "256","type" : "STRING"},{"id" : "MODULE_CD","size" : "256","type" : "STRING"}]}});
            this.addChild(obj.name, obj);


            obj = new nexacro.Dataset("dsSearchMenu", this);
            obj._setContents({"ColumnInfo" : {"Column" : [{"id" : "MENU_ENGL_NM","size" : "32","type" : "string"},{"id" : "ENGL_DISPLAY_PATH","size" : "32","type" : "string"},{"id" : "MODULE_CD","size" : "32","type" : "string"},{"id" : "CMMNBTNADD","size" : "32","type" : "string"},{"id" : "DISPLAY_PATH","size" : "32","type" : "string"},{"id" : "SYTM_FLAG_CD","size" : "32","type" : "string"},{"id" : "MENU_ORDR","size" : "16","type" : "bigdecimal"},{"id" : "PARM","size" : "0","type" : "undefined"},{"id" : "CMMNBTNSAVE","size" : "32","type" : "string"},{"id" : "MENU_ID","size" : "32","type" : "string"},{"id" : "MENU_URL","size" : "0","type" : "undefined"},{"id" : "PRGM_FILE_NM","size" : "0","type" : "undefined"},{"id" : "MENU_LV","size" : "16","type" : "bigdecimal"},{"id" : "SEARCH_SCOPE_CD","size" : "0","type" : "undefined"},{"id" : "MENU_PATH","size" : "32","type" : "string"},{"id" : "MENU_FLAG_CD","size" : "32","type" : "string"},{"id" : "CMMNBTNINIT","size" : "32","type" : "string"},{"id" : "CMMNBTNPRINT","size" : "32","type" : "string"},{"id" : "CMMNBTNEXCELDOWN","size" : "32","type" : "string"},{"id" : "CMMNBTNSEARCH","size" : "32","type" : "string"},{"id" : "CMMNBTNDEL","size" : "32","type" : "string"},{"id" : "MENU_NM","size" : "32","type" : "string"},{"id" : "REMK","size" : "0","type" : "undefined"},{"id" : "HIPO_MENU_ID","size" : "32","type" : "string"},{"id" : "PRGM_ID","size" : "0","type" : "undefined"},{"id" : "PRGM_PATH","size" : "0","type" : "undefined"}]}});
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new nexacro.Static("sta00","0","0",null,"160","0",null,null,null,null,null,this);
            obj.set_cssclass("sta_RF_Bg");
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Div("divMenu","0","160","120",null,null,"0",null,null,null,null,this);
            obj.set_cssclass("div_RF_1Depth");
            obj.set_taborder("1");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static00",null,"0","1",null,"0","0",null,null,null,null,this.divMenu.form);
            obj.set_cssclass("sta_RF_LineDepth");
            obj.set_taborder("0");
            this.divMenu.addChild(obj.name, obj);

            obj = new nexacro.Grid("grdMenu","142","180",null,null,"0","40",null,null,null,null,this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/></Columns><Rows><Row size=\"55\"/></Rows><Band id=\"body\"><Cell cssclass=\"EXPR(MENU_LV==&apos;1&apos;?&quot;cell_RF_Lev0&quot;:MENU_LV==&apos;2&apos;?&quot;cell_RF_Lev1&quot;:&quot;&quot;)\" displaytype=\"treeitemcontrol\" edittype=\"tree\" text=\"bind:MENU_NM\" treelevel=\"bind:MENU_LV\" treestartlevel=\"1\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new nexacro.PopupDiv("pdivSearchMenu","550","100","420","225",null,null,null,null,null,null,this);
            obj.set_text("pdiv00");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new nexacro.Grid("grd00","0","0","420",null,null,"0",null,null,null,null,this.pdivSearchMenu.form);
            obj.set_autofittype("col");
            ...
            obj = new nexacro.Static("Static02","35","71",null,"1","35",null,null,null,null,null,this);
            obj.set_cssclass("sta_RF_Line");
            obj.set_taborder("3");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btnClose",null,"20","40","40","30",null,null,null,null,null,this);
            obj.set_cssclass("btn_TF_Close");
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btnHome",null,"20","40","40","75",null,null,null,null,null,this);
            obj.set_cssclass("btn_RF_Home");
            obj.set_taborder("5");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("sta01","30","20","110","40",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Static("Static01_00","sta01:0","20","30","40",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("btnLogout","Static01_00:10","25","110","30",null,null,null,null,null,null,this);
            obj.set_cssclass("btn_RF_Logout");
            obj.set_taborder("8");
            obj.set_text("로그아웃");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edtSearch","30","90",null,"50","30",null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("btnSearch","edtSearch:-50","90","50","50",null,null,null,null,null,null,this);
            obj.set_cssclass("btn_RF_Sch");
            obj.set_taborder("10");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new nexacro.Menu("mnu00","526","33","685","25",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            this.addChild(obj.name, obj);

            // Layout Functions
            //-- Default Layout : this.divMenu.form
            obj = new nexacro.Layout("default","",0,0,this.divMenu.form,function(p){});
            this.divMenu.form.addLayout(obj.name, obj);

            //-- Default Layout : this.pdivSearchMenu.form
            obj = new nexacro.Layout("default","",0,0,this.pdivSearchMenu.form,function(p){});
        ...
        // User Script
        this.registerScript("frmMenu.xfdl", function(nexacro, system, trace, environment, application) {
        /**
        *  Mobile 프로젝트
