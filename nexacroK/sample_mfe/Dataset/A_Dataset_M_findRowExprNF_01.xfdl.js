(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_findRowExprNF_01_v2");
            this.set_titletext("TA_Dataset_M_findRowExprNF_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_findRowExprNF_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_findRowExprNF_01.xfdl","lib::libCommon.xjs");
        this.registerScript("A_Dataset_M_findRowExprNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset findRowExprNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset findRowExprNF Method Test",
        ...
        tc1.task['findRowExprNF'] = function(strExpr, nStartIdx, nEndIdx, arrArgs) {
        	var result = [];
        	var rtnfindRowExprNF;

        	if(nStartIdx == "생략" && nEndIdx == "생략" && arrArgs == "생략")
        		rtnfindRowExprNF = this.dataset.findRowExprNF(strExpr);
        	else if(nEndIdx == "생략" && arrArgs == "생략")
        		rtnfindRowExprNF = this.dataset.findRowExprNF(strExpr, nStartIdx);
        	else if(arrArgs == "생략")
        		rtnfindRowExprNF = this.dataset.findRowExprNF(strExpr, nStartIdx, nEndIdx);
        	else
        		rtnfindRowExprNF = this.dataset.findRowExprNF(strExpr, nStartIdx, nEndIdx, arrArgs);

        	result.push(rtnfindRowExprNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "findRowExprNF(strExpr, nStartIdx, nEndIdx, arrArgs) 수행",
        	autoTaskFlow : ["findRowExprNF"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "findRowExprNF":
        			var rtn = tc1.task['findRowExprNF'].call(this, strExpr, nStartIdx, nEndIdx, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_findRowExprNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_findRowExprNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_findRowExprNF_01.xfdl");
