(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_lookupAsNF_01_v2");
            this.set_titletext("TA_Dataset_M_lookupAsNF_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_lookupAsNF_48119_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_lookupAsNF","139","264","92","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("lookupAsNF");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_lookupAsNF_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_lookupAsNF_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_lookupAsNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset lookupAsNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.03.21  김형철   최초 작성
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset lookupAsNF Method Test",
        ...
        tc1.task['lookupAsNF'] = function(strColID, varCmpVal, strOutputColID, arrArgs) {
        	var result = [];
        	var rtnlookupAsNF;

        	if(arrArgs == "생략")
        		rtnlookupAsNF = this.dataset.lookupAsNF(strColID, varCmpVal, strOutputColID);
        	else
        		rtnlookupAsNF = this.dataset.lookupAsNF(strColID, varCmpVal, strOutputColID, arrArgs);

        	result.push(rtnlookupAsNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "lookupAsNF(strColID, varCmpVal, strOutputColID, arrArgs) 수행",
        	autoTaskFlow : ["lookupAsNF"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : strColID, varCmpVal, strOutputColID, arrArgs, ev : 리턴값
        			    {vc: [[tapi.VBT_NORMAL,"colB"],[tapi.VBT_NORMAL,"유"],[tapi.VBT_NORMAL,"colC"],[tapi.VBT_EXCEPTION,"생략"]],ev: [100]},
        				{vc: [[tapi.VBT_NORMAL,"colB"],[tapi.VBT_NORMAL,"유"],[tapi.VBT_EXCEPTION,"test"],[tapi.VBT_EXCEPTION,"생략"]],ev: [""]},
        				{vc: [[tapi.VBT_EXCEPTION,"test"],[tapi.VBT_NORMAL,"유"],[tapi.VBT_NORMAL,"colC"],[tapi.VBT_EXCEPTION,"생략"]],ev: [""]},
        				...
        				{vc: [[tapi.VBT_NORMAL,"colB"],[tapi.VBT_NORMAL,"유동"],[tapi.VBT_NORMAL,"colC"],[tapi.VBT_EXCEPTION,"생략"]],ev: [100]},
        				...
        				{vc: [[tapi.VBT_MAX,3],[tapi.VBT_NORMAL,"비"],[tapi.VBT_MIN,0],[tapi.VBT_EXCEPTION,"생략"]],ev: [1]},
        				...
        				{vc: [[tapi.VBT_NORMAL,"colD"],[tapi.VBT_NORMAL,"비이"],[tapi.VBT_NORMAL,"colB"],[tapi.VBT_EXCEPTION,"생략"]],ev: ["주인희"]}
        			]
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "lookupAsNF":
        			var rtn = tc1.task['lookupAsNF'].call(this, strColID, varCmpVal, strOutputColID, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_lookupAsNF_01_v2_onload = function(obj,e)
        {
        ...
        * 07 : 사용자 정의 함수 선언부
        ***********************************************************************/
        this.btn_lookupAsNF_onclick = function(obj,e)
        {
        	var strColID = "$0";
        	var varCmpVal = "유동규"
        	var strOutputColID = "colC";
        	var arrArgs = new Array("colB");
        	var rtnlookup = this.dataset.lookupAsNF(strColID, varCmpVal, strOutputColID, arrArgs);
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_lookupAsNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_lookupAsNF.addEventHandler("onclick",this.btn_lookupAsNF_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_lookupAsNF_01.xfdl");
