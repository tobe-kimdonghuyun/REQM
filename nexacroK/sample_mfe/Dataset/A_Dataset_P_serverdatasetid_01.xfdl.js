(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("Dataset_P_serverdatasetid_01");
            this.set_titletext("Dataset_P_serverdatasetid_01");
            ...
            obj.set_text("[Dataset_P_serverdatasetid_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_P_serverdatasetid_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_P_serverdatasetid_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_P_serverdatasetid_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset serverdatasetid Property
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset serverdatasetid Property Test",
        ...
        tc1.task['serverdatasetid'] = function(strDatasetID) {
        	this.dataset.set_serverdatasetid(strDatasetID);
        }
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "load(strDatasetID) 수행",
        	autoTaskFlow : ["serverdatasetid", "load", "eventChk", "getCellText"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : strDatasetID, ev : 이벤트 정보, getCellText
        			    {vc: [[tapi.VBT_NORMAL,"serverdataset01"]],ev: ["onload","가","나","다","라","마","바"]},
        				{vc: [[tapi.VBT_NORMAL,"output"]],ev: ["onload","DNL3-N611","0825_R VALVE SEAT FOR INDICATOR VALVE HJ-S TYPE (","H10Y3836","DNL3-N611","0825_R VALVE SEAT FOR INDICATOR VALVE HJ-S TYPE (","H10Y3836"]},
        				{vc: [[tapi.VBT_EXCEPTION,"test"]],ev: ["",""]},
        		]
        	},
        	prepare: function () {
        		this.dataset.set_url("servicejsp::TA_Dataset_P_serverdatasetid_01_v2.xml");
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "serverdatasetid":
        			tc1.task['serverdatasetid'].call(this, strDatasetID);
        			break;
        		case "load":
        	...
        	teardown: function () {
        		//초기 상태로
        		this.dataset.assign(this.dataset_2);
        		this.grid.createFormat();
        	}
        };
        ...
        ***********************************************************************/
        this.Dataset_P_serverdatasetid_01_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.Dataset_P_serverdatasetid_01_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_P_serverdatasetid_01.xfdl");
