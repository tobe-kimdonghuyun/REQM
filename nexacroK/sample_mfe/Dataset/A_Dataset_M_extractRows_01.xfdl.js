(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_extractRows_01_v2");
            this.set_titletext("TA_Dataset_M_extractRows_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_extractRows_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_extractRows_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_extractRows_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_extractRows_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset extractRows Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset extractRows Method Test",
        ...
        tc1.task['extractRows'] = function(strExpr, nStartIdx, nEndIdx, arrArgs) {
        	var result = [];
        	var rtnextractRows;

        	if(nStartIdx == "생략" && nEndIdx == "생략" && arrArgs == "생략")
        		rtnextractRows = this.dataset.extractRows(strExpr);
        	else if(nEndIdx == "생략" && arrArgs == "생략")
        		rtnextractRows = this.dataset.extractRows(strExpr, nStartIdx);
        	else if(arrArgs == "생략")
        		rtnextractRows = this.dataset.extractRows(strExpr, nStartIdx, nEndIdx);
        	else
        		rtnextractRows = this.dataset.extractRows(strExpr, nStartIdx, nEndIdx, arrArgs);

        	for(var i=0; i<rtnextractRows.length; i++)
        		result.push(rtnextractRows[i]);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "extractRows(strExpr, nStartIdx, nEndIdx, arrArgs) 수행",
        	autoTaskFlow : ["extractRows"],
        	vcinfo : {
        		...
        		args : [
        				...
        				//filter 후
         				{vc: [[tapi.VBT_NORMAL,"colC == '200'"],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"],[tapi.VBT_EXCEPTION,"생략"]],ev: [""]},
         				//grouping 후
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "extractRows":
        			var rtn = tc1.task['extractRows'].call(this, strExpr, nStartIdx, nEndIdx, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_extractRows_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_extractRows_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_extractRows_01.xfdl");
