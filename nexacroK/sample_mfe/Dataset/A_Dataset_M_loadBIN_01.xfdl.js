(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_loadBIN_01_v2");
            this.set_titletext("TA_Dataset_M_loadBIN_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_loadBIN_78827_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_loadBIN_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_loadBIN_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_loadBIN_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset loadBIN Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset loadBIN Method Test",
        ...
        tc1.task['loadBIN'] = function(varBinData) {
        	var result = [];
        	var rtnloadBIN;
        	var getrowPosition;

        	rtnloadBIN = this.dataset3.loadBIN(varBinData);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "loadBIN(varBinData) 수행",
        	autoTaskFlow : ["loadBIN", "getCellText", "eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        	prepare: function () {
        		var vdAdt = tapi.getVdAdaptor();
        		tc1.userdata.strBIN = this.dataset1.saveBIN();
        	...
        	run: function () {
        		...
        		var varBinData = tc1.userdata.strBIN;

        		switch(taskName) {
        		case "loadBIN":
        			var rtn = tc1.task['loadBIN'].call(this, varBinData);
        	...
        	check: function (resultValue) {
        		//ev : 리턴값, rowposition, colcount, id, getCellText, 이벤트 정보
        		var expectedValue = [5,0,7,"ds_data3",1,"유동규",100,"투우","A","B","C","onload",0];
        ...
        ***********************************************************************/
        this.TA_Dataset_M_loadBIN_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_loadBIN_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_M_loadBIN_01.xfdl");
