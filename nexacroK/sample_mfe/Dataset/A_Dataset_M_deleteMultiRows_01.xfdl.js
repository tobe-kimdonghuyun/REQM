(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_deleteMultiRows_01_v2");
            this.set_titletext("TA_Dataset_M_deleteMultiRows_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_deleteMultiRows_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_deleteMultiRows","114","288","107","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("5");
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_deleteMultiRows_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_deleteMultiRows_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_deleteMultiRows_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset deleteMultiRows Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset deleteMultiRows Method Test",
        ...
        tc1.task['rowMultiSelect'] = function() {
        	var target = this.grid;

        	nexacro.test.Event.nx_common_click(target, 'lbutton', false, false, false, 60, 36);
        	nexacro.test.Event.nx_common_click(target, 'lbutton', false, true, false, 60, 60);
        }

        tc1.task['deleteMultiRows'] = function(arrRowlist) {
        	var result = [];
        	var getRowCount;

        	this.dataset.deleteMultiRows(arrRowlist);
        ...
        tc1.task['getCellText'] = function(arrRowlist){
        	var result = [];
        	...
        	for(var j=0; j<this.dataset.rowcount; j++)
        	{
        		for(var i=0; i<7; i++)
        		{
        			result.push(this.grid.getCellText(arrRowlist[j], i));
        		}
        	}
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "deleteMultiRows(arrRowlist) 수행",
        	autoTaskFlow : ["deleteMultiRows", "getCellText"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		var arrRowlist = new Array(0,1,3);

        		switch(taskName) {
        		case "deleteMultiRows":
        			var rtn = tc1.task['deleteMultiRows'].call(this, arrRowlist);
        			tc1.userdata.result.push(rtn);
        			break;
        		case "getCellText":
        			var rtn = tc1.task['getCellText'].call(this, arrRowlist);
        			tc1.userdata.result.push(rtn);
        			break;
        		}
        	...
        	check: function (resultValue) {
        		//ev : rowcount, getCellText
        		var expectedValue = [2,2,"고준영",200,"소오","A","B","C",4,"김선주",400,"비이","A","B","C"];
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "Grid 의 getSelectedDatasetRows() 메소드 결과값을 인수로 사용",
        	autoTaskFlow : ["rowMultiSelect", "deleteMultiRows", "getCellText"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "rowMultiSelect":
        			tc1.task['rowMultiSelect'].call(this);
        			break;
        		case "deleteMultiRows":
        			arrRowlist = this.grid.getSelectedDatasetRows();
        			var rtn = tc1.task['deleteMultiRows'].call(this, arrRowlist);
        			tc1.userdata.result.push(rtn);
        			break;
        		case "getCellText":
        ...
        ***********************************************************************/
        this.TA_Dataset_M_deleteMultiRows_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_deleteMultiRows_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_deleteMultiRows.addEventHandler("onclick",this.btn_deleteMultiRows_onclick,this);
            this.btn_reset.addEventHandler("onclick",this.btn_reset_onclick,this);
            this.ds_data1.addEventHandler("canrowposchange",this.ds_data1_canrowposchange,this);
            this.ds_data1.addEventHandler("onrowposchanged",this.ds_data1_onrowposchanged,this);
            this.ds_data1.addEventHandler("onrowsetchanged",this.ds_data1_onrowsetchanged,this);
            this.ds_data1.addEventHandler("onvaluechanged",this.ds_data1_onvaluechanged,this);
        };

        this.loadIncludeScript("A_Dataset_M_deleteMultiRows_01.xfdl");
