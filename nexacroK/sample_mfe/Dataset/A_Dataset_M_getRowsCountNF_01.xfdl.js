(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getRowsCountNF_01_v2");
            this.set_titletext("TA_Dataset_M_getRowsCountNF_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getRowsCountNF_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_getRowsCountNF","162","296","69","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("11");
            obj.set_text("getRowsCountNF");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getRowsCountNF_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getRowsCountNF_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getRowsCountNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getRowsCountNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getRowsCountNF Method Test",
        ...
        tc1.task['getRowsCountNF'] = function(arrRows, strColExpr, arrArgs) {
        	var result = [];
        	var rtngetRowsCountNF;

        	if(arrArgs == "생략")
        		rtngetRowsCountNF = this.dataset.getRowsCountNF(arrRows, strColExpr);
        	else
        		rtngetRowsCountNF = this.dataset.getRowsCountNF(arrRows, strColExpr, arrArgs);

        	result.push(rtngetRowsCountNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getRowsCountNF(arrRows, strColExpr, arrArgs) 수행",
        	autoTaskFlow : ["getRowsCountNF"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : arrRows, strColExpr, arrArgs, ev : 리턴값
        				//[확인필요] datasetvalidation 수정 후 기대값 수정이 필요해 보임(set Null, Set Empty, undefined, null), setNull만 제외하고 있음
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "getRowsCountNF":
        			var rtn = tc1.task['getRowsCountNF'].call(this, arrRows, strColExpr, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getRowsCountNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getRowsCountNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_getRowsCountNF.addEventHandler("onclick",this.btn_getRowsCountNF_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_getRowsCountNF_01.xfdl");
