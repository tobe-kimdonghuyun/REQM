(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("ColumnInfo_P_sumtext_01_v2");
            this.set_titletext("ColumnInfo_P_sumtext_01_v2");
            ...
            obj.set_text("[ColumnInfo_P_sumtext_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_ColumnInfo_P_sumtext_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_ColumnInfo_P_sumtext_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_ColumnInfo_P_sumtext_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : ColumnInfo sumtext Property
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "ColumnInfo sumtext Property Test",
        ...
        tc1.task['sumtext'] = function(strSumtext) {
        	this.dataset.colinfos["연봉"].set_sumtext(strSumtext);
        }
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "sumtext(strSumtext) 설정하고 그룹핑 후 논리적 레코드 확인",
        	autoTaskFlow : ["sumtext", "prop", "keystring", "getCellText"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : enumProp, strSumtext, ev : getCellText
        				//prop : 미설정
        				{vc: [[tapi.VBT_NORMAL,"default"],[tapi.VBT_NORMAL,"1"]],  ev: ["111","112","113","114","10,000","15,000","7,000","17,000"]},
        				//prop : Count
        				{vc: [[tapi.VBT_NORMAL,"COUNT"],[tapi.VBT_NORMAL,"2"]],  ev: ["111","112","113","114","2","2","1","2"]},
        				//prop : SUM
        				{vc: [[tapi.VBT_NORMAL,"SUM"],[tapi.VBT_NORMAL,"3"]],  ev: ["111","112","113","114","10,000","15,000","7,000","17,000"]},
        				//prop : MAX
        				{vc: [[tapi.VBT_NORMAL,"MAX"],[tapi.VBT_NORMAL,"4"]],  ev: ["111","112","113","114","6,000","10,000","7,000","9,000"]},
        				//prop : MIN
        				{vc: [[tapi.VBT_NORMAL,"MIN"],[tapi.VBT_NORMAL,"5"]],  ev: ["111","112","113","114","4,000","5,000","7,000","8,000"]},
        				//prop : AVG
        				{vc: [[tapi.VBT_NORMAL,"AVG"],[tapi.VBT_NORMAL,"6"]],  ev: ["111","112","113","114","5,000","7,500","7,000","8,500"]},
        				//prop : TEXT
        				{vc: [[tapi.VBT_NORMAL,"TEXT"],[tapi.VBT_NORMAL,"7"]],  ev: ["111","112","113","114","7","7","7","7"]},
        				//prop : NONE : 숫자컬럼
        				{vc: [[tapi.VBT_NORMAL,"NONE"],[tapi.VBT_NORMAL,"8"]],  ev: ["111","112","113","114","10,000","15,000","7,000","17,000"]},
        				//prop : NONE : 문자컬럼
        				{vc: [[tapi.VBT_NORMAL,"STRING"],[tapi.VBT_NORMAL,"9"]],  ev: ["111","112","113","114","","","",""]},
        				//prop : NONE : 날짜컬럼
        				{vc: [[tapi.VBT_NORMAL,"DATE"],[tapi.VBT_NORMAL,"10"]],  ev: ["111","112","113","114","0000-01-01","0000-01-01","0000-01-01","0000-01-01"]},
        		]
        	},
        	prepare: function () {
        	},
        	run: function () {
        		...
        		var strSumtext = vdAdt.getValue(1);

        		switch(taskName) {
        		case "sumtext":
        			tc1.task['sumtext'].call(this, strSumtext);
        		case "prop":
        ...
        ***********************************************************************/
        this.ColumnInfo_P_sumtext_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.ColumnInfo_P_sumtext_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_ColumnInfo_P_sumtext_01.xfdl");
