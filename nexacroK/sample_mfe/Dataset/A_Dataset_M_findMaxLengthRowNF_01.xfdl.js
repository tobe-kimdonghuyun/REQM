(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_findMaxLengthRowNF_01_v2");
            this.set_titletext("TA_Dataset_M_findMaxLengthRowNF_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_findMaxLengthRowNF_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_findMaxLengthRowNF_01.xfdl","lib::libCommon.xjs");
        this.registerScript("A_Dataset_M_findMaxLengthRowNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset findMaxLengthRowNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset findMaxLengthRowNF Method Test",
        ...
        tc1.task['findMaxLengthRowNF'] = function(strColID, nStartIdx , nEndIdx) {
        	var result = [];
        	var rtnfindMaxLengthRowNF;

        	if(nStartIdx == "생략" && nEndIdx == "생략")
        		rtnfindMaxLengthRowNF = this.dataset.findMaxLengthRowNF(strColID);
        	else if(nEndIdx == "생략")
        		rtnfindMaxLengthRowNF = this.dataset.findMaxLengthRowNF(strColID, nStartIdx);
        	else
        		rtnfindMaxLengthRowNF = this.dataset.findMaxLengthRowNF(strColID, nStartIdx , nEndIdx);

        	result.push(rtnfindMaxLengthRowNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "findMaxLengthRowNF(strColID, nStartIdx , nEndIdx) 수행",
        	autoTaskFlow : ["findMaxLengthRowNF"],
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"]],ev: [3]},
          				//filter 후
         				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_MIN,0],[tapi.VBT_EXCEPTION,"생략"]],ev: [3]},
        			]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "findMaxLengthRowNF":
        			var rtn = tc1.task['findMaxLengthRowNF'].call(this, strColID, nStartIdx, nEndIdx);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_findMaxLengthRowNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_findMaxLengthRowNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_findMaxLengthRowNF_01.xfdl");
