(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_E_onrowposchanged_01_v2");
            this.set_titletext("TA_Dataset_E_onrowposchanged_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_E_onrowposchanged_48076_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","272","298","200",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_value("//");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_clear","233","240","63","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("5");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("Static00","10","243","58","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_text("nRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_nRow","53","240","67","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_value("2");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_rowposition","137","240","85","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
        ...
        // User Script
        this.addIncludeScript("A_Dataset_E_onrowposchanged_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_E_onrowposchanged_01.xfdl","libevent::event.util.xjs");
        this.addIncludeScript("A_Dataset_E_onrowposchanged_01.xfdl","libevent::event.wrapper.xjs");
        this.registerScript("A_Dataset_E_onrowposchanged_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset onrowposchanged Event
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset onrowposchanged Event Test",
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "canrowposchange 리턴값에 따른 rowposition 변경",
        	autoTaskFlow : ["returnValue","rowposition","eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        		//vc : 1.bCancolumnchange, 2.nRow, ev : 1.이벤트 정보
        		{vc: [[tapi.VBT_NORMAL,true], [tapi.VBT_NORMAL,2]],  ev: ["canrowposchange",51,2,"ds_data1","onrowposchanged","[object Dataset]","[object Dataset]",2,0,51]},
        		{vc: [[tapi.VBT_NORMAL,false], [tapi.VBT_NORMAL,3]], ev: ["canrowposchange",51,""]},
        		{vc: [[tapi.VBT_NORMAL,true], [tapi.VBT_NORMAL,3]],  ev: ["canrowposchange",51,3,"ds_data1","onrowposchanged","[object Dataset]","[object Dataset]",3,2,51]},
        		{vc: [[tapi.VBT_EXCEPTION,"생략"], [tapi.VBT_NORMAL,4]],  ev: ["canrowposchange",51,4,"ds_data1","onrowposchanged","[object Dataset]","[object Dataset]",4,3,51]}
        		]
        	},
        	prepare: function () {
        		tc1.userdata.eventReturnValue = "true";
        	...
        	run: function () {
        		...
        		case "returnValue":
        			...
        			break;
        		case "rowposition":
        			tc1.task['rowposition'].call(this, nRow);
        			break;
        		case "eventChk":
        ...
        ***********************************************************************/
        this.TA_Dataset_E_onrowposchanged_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
        	tc1.userdata.eventChkList2.push(this.dataset.rowposition);
        	...
        	tc1.userdata.eventChkList2.push(e.newrow);
        	tc1.userdata.eventChkList2.push(e.oldrow);
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_E_onrowposchanged_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_E_onrowposchanged_01.xfdl");
