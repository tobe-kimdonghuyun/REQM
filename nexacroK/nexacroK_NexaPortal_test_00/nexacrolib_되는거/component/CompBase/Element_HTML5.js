            ...
            if (contentsType != ContentType.EMPTY)
            {
                ...
                if (contentsType != ContentType.TEXT)
                {
                    ...
                    if (this.icon)
                    {
                        ...
                        icon_style += nexacro.__getHTMLStyle_ContentSize(this.icon.width, this.icon.height);
                    }
            ...
            if (handle)
            {
                ...
                if (contentsType != ContentType.TEXT)
                {
                    ...
                    if (this.icon)
                    {
                        ...
                        nexacro.__setDOMStyle_ContentSize(icon_node.style, this.icon.width, this.icon.height);
                    }
                    if (this.iconAnimation)
        ...
        if (this.icon != icon)
        {
            ...
            if (this.handle)
            {
                ...
                if (icon_node)
                {
                    ...
                    nexacro.__setDOMStyle_ContentSize(icon_node.style, icon?.width, icon?.height);
                }
            }
        }
    };
