...
if (!nexacro.ExcelImportObject)
{
    ...
    _pExcelImport.commdataformat = "XML";
    _pExcelImport._commdataformat = 0;

    _pExcelImport.commandversion = "1.0";
    ...
    {
        this._unique_id = this.parent._unique_id + "_" + this.id;
    };
    ...
    _pExcelImport.set_separator = function (v)
    {
        ...
        {
            this.separator = "0x" + v.toString(16);
        }
    ...
    _pExcelImport.importData = function (fileurl, range, responseData, userData)
    {
        ...
        //nexacro._append_hidden_item(this.id, "upfile", this._checkUploadFile, this, this._hidden_frame_handle);
    ...
    _pExcelImport._requestImport = function (fileUrl)
    {
        ...
        ds_command.setColumn(0, "format", this.commandversion == "1.0" ? formatdata : (this.commandversion == "2.0" ? nexacro.base64Encode(formatdata) : nexacro.base32Encode(formatdata)));
        ...
        ds_command.setColumn(0, "commandversion", this.commandversion);
        if (this._iscors)
        {
        ...
        _pExcelImport._uploadComplete = function (status, data, url/*, errcode, httpcode, errmsg*/)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (nexacro._Browser == "IE" && !xmldoc.body)
                    {
