...
if (!nexacro.PopupDiv)
{
    ...
    _pPopupDiv.visible = false;  // component'base is true but popup'base is false
    ...
    /* accessibility */
    _pPopupDiv.accessibilityrole = "none";
    ...
    _pPopupDiv.trackPopup = function (left, top, width, height, callbackfn, bcapture)
	{
        ...
        var is_fluid = layoutmanager ? layoutmanager.isFluidLayoutType(this.parent) : false;
        ...
        if (is_fluid)
        {
            width = (width == null) ? this._convToPixel(this.width, this.parent._adjust_width) : +width;
            height = (height == null) ? this._convToPixel(this.height, this.parent._adjust_height) : +height;
        }
        else
        {
