...
if (!nexacro.DatePickerControl)
{
    ...
    _pDatePickerControl.on_create_contents = function ()
    {
        ...
        if (control_elem)
        {
            ...
            this.on_apply_datepickerchangetype(this.parent.datepickerchangetype);
        }
    };
    ...
    _pDatePickerControl._on_head_onkeydown = function (obj, e)
    {
        ...
        if (this._changetype == "button")
        {
            if (this.head.monthstatic.visible)
            {
                this._changeDate(obj, e);
            }
            else if (!this.head.monthstatic.visible && this.head.yearstatic.text.length < 6)
            {
        ...
        if (!enableaccessibility)
        {
            ...
            {
                if (this._changetype != "button" || this.head.monthstatic.visible)
                {
    ...
    _pDatePickerControl._changeMonth = function (obj, e)
    {
        ...
        if (keycode == 37 || keycode == 38 || keycode == 39 || keycode == 40 || keycode == 13)
        {
            ...
            for (i = 0; i < this.body._maxMonth; i++)
            {
    ...
    _pDatePickerHeadControl._on_static_mobile_onclick = function (obj, e)
	{
        ...
        var body = calendar.datepicker.body;
        ...
        {
            if (this.parent._changetype == "button")
            {
    ...
    _pDatePickerHeadControl._on_button_onprevclick = function (obj, e)
	{
        ...
        if (!this.monthstatic.visible && this.parent._changetype == "button")
        {
    ...
    _pDatePickerBodyControl.on_create_contents = function ()
    {
        ...
        if (control_elem)
        {
            ...
            this.parent.on_apply_datepickerchangetype(this.parent.parent.datepickerchangetype);
    ...
    {
        var year_range = this.parent.head.yearstatic.text.split(" - ");
        ...
        if (parseInt(obj.text) == min_year)
        {
            ...
            yearstr = min_year + " - " + max_year;
            this.parent.head.yearstatic.set_text(yearstr);
        }
    ...
    _pDatePickerBodyControl._months_visible = function (v)
    {
        ...
        for (var i = 0; i < maxMonth; i++)
        {
			if (months[i])
            {
                ...
                if (i + 1 == parseInt(this.parent.head._date.int_month))
                {
        ...
        if (min_year)
        {
            for (i = 0; i < maxYear; i++)
            {
				if (years[i])
                {
                    ...
                    if (min_year + i == parseInt(this.parent.head._date.int_year))
                    {
    ...
    _pDatePickerMonthItemControl.accessibilityrole = "gridcell";
    ...
    _pDatePickerYearItemControl.accessibilityrole = "gridcell";
