...
if (!nexacro.Combo)
{
    ...
    _pCombo.acceptvaluetype = "allowinvalid";   //allowinvalid | ignoreinvalid

    _pCombo.selectbyarrowkey = false;
    ...
    {
        return this.comboedit ? this.comboedit._getInputElement() : null;
    };
    ...
    {
        v = nexacro._toBoolean(v);
        if (this.selectbyarrowkey != v)
        {
            this.selectbyarrowkey = v;
        }
    };
    ...
    {
        if (this.getElement() && this.comboedit && !this._isDropdownType())
        {
    ...
    _pCombo._closePopup = function ()
    {
        ...
        if (popupcontrol)
        {
			...
			nexacro._refreshWindow(_window.handle, true); //RP 100560;간헐적으로 콤보가 깨지는 현상을 최소화시킴
        }
    ...
    _pComboEditControl.on_keydown_basic_action = function (keycode, alt_key, ctrl_key, shift_key, refer_comp, meta_key)
    {
        ...
        if (input_elem)
		{
            ...
            else if (!alt_key && !shift_key && ctrl_key && keycode == 90) // 'z'
            {
                ...
                if (this._undostack && !this.parent._isDropdownType())
                {
    ...
    /* accessibility */
    _pComboPopupControl.accessibilityrole = "listbox";
