...
if (!nexacro.PopupMenu)
{
	...
	_pPopupMenu._trackPopup = function (obj, direction, x, y)
	{
		...
		{
			var p_padding = parent.padding ? parent.padding : parent._getCSSStyleValue("padding", parent._status);
	...
	_pPopupMenu._reCalcSize = function (/*w,h*/)
	{
		...
		if (ds && this.captioncolumn)
		{
			...
			var padding = this.padding ? this.padding : this._getCSSStyleValue("padding", currentstatus);
