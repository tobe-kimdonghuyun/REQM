...
if (!nexacro.Sketch)
{
    ...
    _pSketch.editmode = "stroke";                  // "text", "erase", default "stroke"
    ...
    */
    ...
    {        
        ...
        if (nexacro._isMobile && nexacro._isMobile())
        {
            ...
            {
                this._initPath(this._path_style, this.editmode, (x - this._default_edit_gap), y);
                this._drawPath(x, y);
            }
        }
        else
    ...
    */
    ...
    _pSketch._drawBcurve = function (path, canavs_elem)
    {
        ...
        */
        ...
        {
            for (n = this._drawpathcount; n < length; n++)
            {
                p1 = path[n];
                p2 = path[n + 1];
    ...
    {
        var sketchtextarea = this.sketchtextarea;
        if (sketchtextarea.visible == false) return;
