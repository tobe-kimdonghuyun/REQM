...
if (!nexacro.StatusBarControl)
{
    ...
    /* internal variable */
    // combozoom 기능 삭제 - runtime에서 성능저하요인 
    ...
    nexacro.StatusBarControl._default_progressbarwidth = 200; //new nexacro.Style_value("200");
    nexacro.StatusBarControl._default_progressbarheight = 19; //new nexacro.Style_value("20");
    nexacro.StatusBarControl._default_progressbargap = 1; //new nexacro.Style_value("1");

    //===============================================================
    // nexacro.StatusBarControl CSS Property Part
    //===============================================================
    ...
    _pStatusBarControl.on_apply_progressbar = function (/*v*/)
    {
    ...
    _pStatusBarControl.on_apply_resizable = function (resizable)
    {
        ...
        if (ownerframe && resizegrip)
        {
            ...
            */
            ...
            // cursor & nc hittest
            //this.resizegrip_elem.setElementCursor(cursor);

            //this.resizegrip_elem.setElementHittestType(hittest_type);            
    ...
    //===============================================================
    // nexacro.StatusBarControl : Create & Destroy & Update
    //===============================================================
    _pStatusBarControl.onCreateComponent = function (parent_elem)
    {
    ...
    {
        this.on_apply_resizable(this.resizable);  // 내부에서 recalcLayout 호출됨
    ...
    //===============================================================
    // nexacro.StatusBarControl Property Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.StatusBarControl : Logical Part
    //===============================================================


    _pStatusBarControl._on_load_resizegripicon = function (/*width, height*/)
    {
    ...
    {
        //[statusbar padding-left][statustext][progressbarsize][progressbargap][zoomcombosize][zoomcombogap][resizegrip:border+padding+iconwidth][statusbar padding-right]		
        var left = width;
