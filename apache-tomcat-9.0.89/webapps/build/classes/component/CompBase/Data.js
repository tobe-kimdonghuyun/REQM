...
if (!nexacro.Dataset)
{
    ...
    nexacro._DatasetRuleFuncsSet["list"] = ["_isInvalidValue",
        "_compareValue",
        "_getSumValue",
        "_getSumExpr",
        "_getRowsSumValue",
    ...
    nexacro._DatasetRuleFuncsSet["2.0"] = {
        ...
        "_compareValue": function (val1, val2, coltype, locale, localeoption)
        {
            if (val1 != null && val2 != null)
            {
                ...
                else if (coltype == 1) //string
                {
                    ...
                    if (!locale && (collation == "none" || !collation)) //check
                    {
                        if (val1 == val2)
                            return 0;
    ...
    if (nexacro._Browser == "IE" && nexacro._BrowserVersion <= 9)
    {
        nexacro.__whileLoop = function (thisArg, _func)
        {
            ...
            while (true)
            {
                if (__whileLoop_loopFn(thisArg)) break;
                if (__whileLoop_loopFn(thisArg)) break;
                if (__whileLoop_loopFn(thisArg)) break;
                if (__whileLoop_loopFn(thisArg)) break;
                if (__whileLoop_loopFn(thisArg)) break;
        ...
        nexacro.__forLoop = function (thisArg, i, end, _func)
        {
            ...
            while (true)
            {
                if (__forLoop_loopFn(thisArg)) break;
                if (__forLoop_loopFn(thisArg)) break;
                if (__forLoop_loopFn(thisArg)) break;
                if (__forLoop_loopFn(thisArg)) break;
                if (__forLoop_loopFn(thisArg)) break;
        ...
        nexacro.__reverseForLoop = function (thisArg, i, end, _func)
        {
            ...
            while (true)
            {
                if (__reverseForLoop_loopFn(thisArg)) break;
                if (__reverseForLoop_loopFn(thisArg)) break;
                if (__reverseForLoop_loopFn(thisArg)) break;
                if (__reverseForLoop_loopFn(thisArg)) break;
                if (__reverseForLoop_loopFn(thisArg)) break;
    ...
    */
    ...
    nexacro.DSColumnInfo = function (id, type, ntype, size, prop, sumtext, datapath, idx)
    {
        this.id = id;
        this.name = id;
        this.type = type;  //string : on caller this id Nomalized typeName : toLowerCase()
    ...
    //_pDataset.updateresetcontrol = true;   // this is flag for Check to change row type as Nomal Type when column updated
    _pDataset.keystring = "";
    _pDataset.collation = undefined;

    _pDataset.filterstr = "";

    _pDataset.loadkeymode = "keep"; //nexacro.Dataset.LOADMODE_KEEP;
    _pDataset.loadfiltermode = "keep"; //nexacro.Dataset.LOADMODE_KEEP;
    ...
    _pDataset.dataobjectbindmode = undefined;
    ...
    _pDataset._is_reftype = false;          // if Shared Dataset, this is true

    // Add for lazy parse error when cache level session,static
    _pDataset._dataType = "";
    _pDataset._colInfoLines = null;
    _pDataset._cachedConvertFn = null;
    ...
    _pDataset.destroy = function ()
    {
		...
		//if (this.onworkcompleted) {
		//    this.onworkcompleted._clearAll();
		//    this.onworkcompleted = null;
		//}
    ...
    _pDataset.on_apply_collation = function (v)
    {
        this.updateSortGroup(this.keystring, true);
    };
    // ----------------- event handling ------------------ //
    ...
    _pDataset._removeRawRow = function (rowRow)
    {
        ...
        if (idx >= 0)
        {
            ...
            if (this.updatecontrol && this._isTwowayDataobjectBindMode())
            {
    ...
    _pDataset._compareValue = function (val1, val2, coltype, locale, localeoption, bSysLang)
    {
        if (val1 != null && val2 != null)
        {
            if (coltype == 4 || coltype < 0)
    ...
    _pDataset.appendRow = function ()
    {
        ...
        if (idx >= 0)
        {
            ...
            if (this.updatecontrol == false && this._isTwowayDataobjectBindMode())
            {                
    ...
    _pDataset.insertRow = function (row)
    {
        ...
        if (idx >= 0)
        {
            if (this._eventstat)
            {
                ...
                {
                    if (oldpos == idx)
                        this._setRowPosition(idx, 53, true); //Dataset.REASON_ROWOBJECTCHANGE
                    else
            ...
            if (this.updatecontrol == false && this._isTwowayDataobjectBindMode() && this._binddataobject)
            {
    ...
    _pDataset._deleteRow = function (row)
    {
        ...
        if (this.updatecontrol)
        {
            ...
            if (rowRow)
            {
                ...
                else if (rowRow._rtype == 2 || rowRow._rtype == 16) //nexacro.Dataset.ROWTYPE_INSERT
                {
    ...
    _pDataset.deleteRow = function (row)
    {
        ...
        if (idx >= 0)
        {
            ...
            if (this.updatecontrol == false && this._isTwowayDataobjectBindMode() && this._binddataobject)
               this._binddataobject.deleteDataInPath(this.dataobjectpath, null, idx, this.id);
        }
            ...
            function _deleteMultiRows_loop2(i)
            {
                ...
                if (rowRow)
                {
                    ...
                    if (this._isTwowayDataobjectBindMode() && this._binddataobject)
                        this._binddataobject.deleteDataInPath(this.dataobjectpath, null, del_rows[i], this.id);
                }
            }
        ...
        if (this._isTwowayDataobjectBindMode())
        {
            ...
            else
            {
                if (this._binddataobject)
                {
                    ...
                    this._binddataobject.deleteDataInPath(this.dataobjectpath, temp, oldrow, this.id);
                    this._binddataobject.insertData(this.dataobjectpath, temp, newrow, this.id);
                }
            }
        }
        ...
        if (this._isTwowayDataobjectBindMode())
        {
            ...
            else
            {
                if (this._isTwowayDataobjectBindMode())
                {
                    ...
                    this._binddataobject.setDataInPath(this.dataobjectpath, temp, row2, this.id);
                    this._binddataobject.setDataInPath(this.dataobjectpath, temp2, row1, this.id);
                    /*
                    if (row2 > row1)
                    {
                        this._binddataobject.deleteDataInPath(this.dataobjectpath, temp, row1, this.id);
                        this._binddataobject.insertDataInPath(this.dataobjectpath, temp, row2, this.id);
                        this._binddataobject.deleteDataInPath(this.dataobjectpath, temp2, row2, this.id);
                        this._binddataobject.insertDataInPath(this.dataobjectpath, temp2, row1, this.id);
                    }
                    else
                    {
                        this._binddataobject.deleteDataInPath(this.dataobjectpath, temp2, row2,this.id);
    ...
    */
    _pDataset.__splitLocaleString = function (str, start_locale)
    {
        var str_locale = "";
        var loc_ind = 2;
    ...
    */
    _pDataset.__parseLocaleString = function (str)
    {
        //파싱 로직을 바꿀지 고민
    ...
    _pDataset._parseKeyCols = function ()
    {
        ...
        if (str.length > 0)
        {
            ...
            if (nexacro._SupportLocaleCollator && str_locale)
            {
    ...
    _pDataset._calcGroupData = function (grpRow, col_levels)
    {
        ...
        //nexacro._forEach(this, colList, 0, colList.length, _calcGroupData_loop);
                ...
                if (chklvl > 0)
                {
                    if (this.reversesubsum)
                    {
                        function __createGroupData_reversegrp_loopFn(lvl)
                        {
                            ...
                            grpRow._grpend = idx + maxlevel; // last index after all rows added
                        }
    ...
    _pDataset.updateSortGroup = function (strkey, apply_method)
    {
        ...
        {
            var isReset = false;
            if (this.keystring == "" || this.keystring == "S:" || this.keystring == "G:" || this.keystring == "O:")
            {
                isReset = true;
            }
        ...
        if (this._eventstat && ((this.cancolumnchange && this.cancolumnchange._has_handlers) || (this.oncolumnchanged && this.oncolumnchanged._has_handlers) || (this.onvaluechanged && this.onvaluechanged._has_handlers)))
        {
            ...
            if (this.on_fire_cancolumnchange(evt))
            {
                ...
                if (value !== constVar.value)
                {
                    ...
                    {
                        //if (this.updatecontrol == true)
                        // {
                        //    this._addDirtyindex(-1, "update", null);
                        //}
                        //else
                             this._binddataobject.setDataValue(this.dataobjectpath, value, -1, constVar.datapath, this.id);
                    }
                    return true;
                }
            }
    ...
    _pDataset._updateColumn = function (viewrow, rowRow, colinfo, value)
    {
        ...
        if (oldVal === value || rowRow._rtype == 16) //nexacro.Dataset.ROWTYPE_GROUP, ROWTYPE_DELETE때도 value 반영
        {
            return false;
        }
                    ...
                    if (this._updateColumn(row, rowRow, colinfo, fromval))
                    {
                        ...
                        if (this._isTwowayDataobjectBindMode())
                        {
                            ...
                            else
                            {
                                ...
                                this._binddataobject.setDataValue(this.dataobjectpath, value, rowRow._rawidx, this._getPathFromColinfo(colinfo), this.id);
                            }
                        }
    ...
    _pDataset._copyRowList = function (srcds, srcRecords)
    {
        ...
        var cnt = 0;
        var is_updatecontrol = this.updatecontrol;
        function __copyRowList_loopFn(i)
        {
            ...
            if ((srcRow._level == 0) && (srcRow._rtype & 7))
            {
                ...
                if (this._isTwowayDataobjectBindMode())
                {
                    ...
                    {
                        if (this._binddataobject)
                            this._binddataobject.addDataInPath(this.dataobjectpath, this._rowToData(rowRow), idx, this.id);
                    }
                }
        ...
        function __appendRowList_loopFn(i)
        {
            ...
            if ((srcRow._level == 0) && (srcRow._rtype & 7))
            {
                ...
                if (this._isTwowayDataobjectBindMode())
                {
                    ...
                    {
                        if (this._binddataobject)
                            this._binddataobject.addDataInPath(this.dataobjectpath, null, index, this.id);
                    }
                }
                cnt++;
            }
            ...
            if (idx_map)
            {
                ...
                if (this._eventstat && ((this.oncolumnchanged && this.oncolumnchanged._has_handlers) || (this.onvaluechanged && this.onvaluechanged._has_handlers)))
                {
                    ...
                    if (this._isTwowayDataobjectBindMode())
                    {
                        ...
                        {
                            this._binddataobject.setDataInPath(this.dataobjectpath, this._rowToData(destRow), torow, this.id);
                        }
                    }
                }
                return true;
    ...
    _pDataset.applyChange = function ()
    {
        ...
        function applyChange_loop(i)
        {
            ...
            {
                var rowRow = rawRecords[i];
                if (rowRow._rtype == 0 || rowRow._rtype == 8 || rowRow._rtype == 16) // nexacro.Dataset.ROWTYPE_EMPTY, nexacro.Dataset.ROWTYPE_DELETE
                {
                    rawRecords.splice(i, 1);
                    rowRow.length = 0;
                    delcnt++;
    ...
    _pDataset.reset = function ()
    {
        ...
        {
            var rowRow = rawRecords[i];
            if (rowRow._rtype == 0 || rowRow._rtype == 2 || rowRow._rtype == 16) // nexacro.Dataset.ROWTYPE_EMPTY, nexacro.Dataset.ROWTYPE_INSERT
            {
                rawRecords.splice(i, 1);
                b_sort = true;
            }
    ...
    // load from XML
    //---------------------------------------------
    _pDataset._setConstColInfoFromXMLStr = function (xmlStr)
    {
        var xml_parse_pos = 0;
    ...
    _pDataset._saveJSON = function (id, type, depth, savenan, saveinfinity, saveinvaliddate)
    {
        if (!depth) depth = 0;
        var saveId = (id ? id : this.id);
    ...
    _pDataset.__writeJSONData = function (list, str, depth)
    {
        list.push(this._TABS[depth] + str);
    };

     _pDataset.__addStringJSONData = function (list, str, depth)
    {
        list[list.length -1] += str;
    };

    _pDataset.__writeJSONNormalRow = function (list, rowRow, depth)
    {
        this.__writeJSONRowData(list, "", rowRow, depth);
    };

    _pDataset.__writeJSONCrudRow = function (list, rowRow, depth)
    {
        var buffer = "{";
    ...
    _pDataset.__writeJSONRowData = function (list, buffer, rowRow, depth)
    {
        var colList = this.colinfos;
    ...
    _pDataset.saveJSON = function (id, type, savenan, saveinfinity, saveinvaliddate)
    {
    ...
    // load JSON
    //---------------------------------------------
    _pDataset.loadFromDataObject = function (/*dataobject, jsonpath*/)
    {
        var dataobj = this._binddataobject;
        if (dataobj)
        {
            //this._clearData();
            this._loadFromJSONObject(dataobj.data, this.dataobjectpath);
            this._endLoad(0, "SUCCESS", 0);
        }
    };

    _pDataset._loadFromJSONObject = function (jsonobj, jsonpath)
    {
        this.loadstatus = true;
        this._eventstat = !this.loadstatus && this.enableevent;

        var _convertFn = this.__makeJSONDataMappingFunc;
        /*this.rowcount  = */this._loadRecordFromJSONObj(jsonobj, jsonpath, _convertFn);
        this.constcount = this._constVars.length;
        this.colcount = this.colinfos.length + this.constcount;
        this.rowcount = this._viewRecords.length;
    ...
    _pDataset._isTwowayDataobjectBindMode = function ()
    {
        if (this.dataobjectbindmode == "twoway" && !this._is_data_updating && this._binddataobject)
        {
            return true;
        }
        return false;
    ...
    _pDataset.loadJSON = function (strJSON, bClear)
    {
        return this._loadFromJSONStr(strJSON, bClear);
    };

    _pDataset._loadFromJSONStr = function (JSONStr, bClear, bAppend, errorcode, errormsg)
    {
        if (bClear == null)
        {
            bClear = true;
     ...
     _pDataset._loadFromJSONObj = function (jsonobj, bClear, bAppend, errorcode, errormsg)
    {
        if (bClear == null)
        {
            bClear = true;
        ...
        if (jsonobj)
        {
            ...
            this.__loadFromJSONObj(jsonobj, 0, -1, bOrgLayout, bClear);
    ...
    _pDataset.__loadFromJSONStr = function (JSONStr, JSON_parse_pos, loadCnt, bOrgLayout, bClear)
    {
        this.loadstatus = true;
        this._eventstat = !this.loadstatus && this.enableevent;
    ...
    _pDataset.__loadFromJSONObj = function (jsonobj, JSON_parse_pos, loadCnt, bOrgLayout, bClear)
    {
        this.loadstatus = true;
        this._eventstat = !this.loadstatus && this.enableevent;
    ...
    _pDataset._setConstColInfoFromJSONObj = function (jsonobj)
    {
    ...
    _pDataset._setColInfoFromJSONObj = function (jsonobj)
    {
        var JSON_parse_pos = 0;
        var colInfo = jsonobj.ColumnInfo;
        if (colInfo)
    ...
    _pDataset._loadRecordFromJSONObject = function (rowsobj)
    {
        var colList = this.colinfos;
        var rawRecords = this._rawRecords;
        var delRecords = this._deletedRecords;
        ...
        function __loadFromJSONObj_row_loopFn()
        {
            ...
            for (var key in rowInfo)
            {
                ...
                else
                {
                    ...
                    if (value && nexacro._isString(value))
                    {
                        value = value.replace(/\\n/gi, '\n');     
                        value = value.replace(/\\t/gi, '\t');   
                    }
    ...
    //_pDataset.__makeJSONDataMappingFunc = function (rowRow, rowData)
    ...
    _pDataset._loadFromSSVUint8Array = function (data, offset, ssvColLines, loadCnt, bOrgLayout, bClear, convertFn)
    {
        this.loadstatus = true;
        this._eventstat = !this.loadstatus && this.enableevent;
    ...
    _pDataset._getColLinesFromSSVLines_with_arraybuffer = function (data, offset, sep, colLines)
    {
        if (sep == undefined)
        {
    ...
    _pDataset._lazyParseRecordFromSSVLine_with_Uint8Array = function (rowRow, _convertFn)
    {
        //var _cs_ = String.fromCharCode(31);
        var _cs_ = nexacro._getSSVUnitSeparator();
    ...
    _pDataset._loadRecordFromSSVLines = function (ssvLines, curIdx, loadCnt, _convertFn)
    {
        ...
        {
            prefix = '!';	// for huge data memory leak
            typePos = 1;
        }
    ...
    _pDataset._loadRecordFromSSVUint8Array = function (data, offset, loadCnt, _convertFn)
    {
    ...
    _pDataset.loadSSVFromUint8Array = function (data, offset, bClear, bAppend, errorcode, errormsg)
    {
        if (bClear == null)
        {
            bClear = true;
    ...
    _pDataset._lazyParseRecordFromCSVLine_with_Uint8Array = function (rowRow, _convertFn)
    {
        var dataArray = rowRow._data;
        var cinfo = nexacro._Array2DataUtil.substring(dataArray, 0);
        var curData = cinfo.string;
    ...
    _pDataset._loadRecordFromCSVLines = function (csvLines, curIdx, loadCnt, _convertFn)
    {
		...
		if (nexacro._Browser == "IE" || (nexacro._Browser == "Edge" && nexacro._BrowserType == "Edge"))
        {
            postfix = ',';	// for huge data memory leak
        }
    ...
    _pDataset._loadRecordFromCSVUint8Array = function (data, offset, loadCnt, _convertFn, rs)
    {
        var pos = offset/*, length = data.length, cinfo*/, tinfo;
        var nullRecord = false;
    ...
    _pDataset._loadFromCSVUint8Array = function (data, offset, csvColLines, loadCnt, bOrgLayout, bClear, convertFn, rs)
    {
        this.loadstatus = true;
        this._eventstat = !this.loadstatus && this.enableevent;
    ...
    _pDataset._getColLinesFromCSVLines_with_arraybuffer = function (data, offset, sep, colLines)
    {
    ...
    _pDataset.loadCSVFromUint8Array = function (data, offset, bClear, bAppend, errorcode, errormsg, rs)
    {
        if (bClear == null)
        {
            bClear = true;
    ...
    _pDataset._addDirtyindex = function(idx, type, _row)
    {
    ...
    _pDataset._refreshDirty = function ()
    {
        var dirty_rows = [];
        var obj = this._binddataobject;
        if (obj)
        {
            var path = this.dataobjectpath;
            //var rawRecords = this._rawRecords;
    ...
    _pDataset._rowToData = function (srcRow)
    {
        var destRow = {};
        var colList = this.colinfos;
        function __copyRowData_loopFn(i)
    ...
    _pDataset._setDataInPath = function (target, path, data)
    {
        var temp_target = [];                
    ...
    _pDataset._getPathFromColumninfo = function (colitem)
    {
    ...
    _pTransactionItem._deserializeUint8Array = function (data_array)
    {
        ...
        cinfo = nexacro._Array2DataUtil.substr(data_array, pos, 10);
        var data_type = this._getStreamType(cinfo.string);
    ...
    _pTransactionItem.__deserializePPX = function (strRecvData)
    {
        ...
        for (; curIdx < lineCnt; curIdx++)
        {
            ...
            if (curType == "P")
            {
				...
				else if (id in this.context)    //1.form(application) variable
                {
