...
if (!nexacro.ScrollBarControl)
{
    ...
    _pScrollBar.line = 1; //readonly
    _pScrollBar.page = 3; //readonly
    _pScrollBar.view = -1; //???
    _pScrollBar.max = 0; // default : 0
    _pScrollBar.min = 0;
    _pScrollBar.pos = 0;    
    ...
    _pScrollBar.on_create_contents = function ()
    {
        ...
        if (control_elem)
        {
            ...
            this.decbutton._is_focus_accept = false;
            ...
            this.incbutton._is_focus_accept = false;
            ...
            this.trackbar._is_focus_accept = false;
