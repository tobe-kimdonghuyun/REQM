...
if (!nexacro.Component)
{
    ...
    nexacro.Component = function (id, left, top, width, height, right, bottom, minwidth, maxwidth, minheight, maxheight, parent)
    {
        ...
        if (horz >= 2 && vert >= 2)
        {
            ...
            this.width = width;
            // TODO2 : %pixel 처리 필요
            //this.width = this._setWidth(width);
            this.height = height;
    ...
    _pComponent.itemaccessibilityenable = false;


    /* Fluid Layout Component Init*/
    _pComponent.flexgrow = undefined;
    _pComponent.flexshrink = undefined;
    _pComponent.layoutorder = 0;
    _pComponent.tablecellarea = "";
    ...
    _pComponent.createComponent = function (bCreateOnly)
    {
        ...
        {
            if (!bCreateOnly && this.parent && this.parent._control_element && this.parent._control_element.handle)
            {
                this.on_created(this._getWindow());
            }

            if (this.parent && this.parent._control_element)
                this.onCreateComponentAfter(this.parent._control_element);
    ...
    _pComponent._initControlElementLayoutProps = function ()
    {
        ...
        if (this._is_fluid_control && !this._is_nc_control && !this._is_subcontrol)
        {
    ...
    _pComponent.set_layoutorder = function (v)
    {
        ...
        if (this.layoutorder != v)
        {
            this.layoutorder = parseInt(v);
    ...
    _pComponent.set_tablecellarea = function (v)
    {
        ...
        if (this.tablecellarea !== v)
        {
            this.tablecellarea = v;
    ...
    {
        this._tablecellarea = this.tablecellarea;
        var manager = nexacro._getLayoutManager();
        if (manager)
        {           
    ...
    _pComponent._applyElementVisible = function (v) // HTML visibility vs display
    {
        ...
        if (!this._is_subcontrol || !this._is_nc_control)
        {
    ...
    _pComponent.setFocus = function (bResetScroll, bInnerFocus)
    {
        ...
        if (nexacro._enableaccessibility)
        {
            ...
            if (!this._isAccessibilityEnable() && !this._isItemAccessibilityEnable() && focus_direction > 1 && focus_direction < 4)
			{
				return;
			}
    ...
    */
    ...
    {
        return this._tablecellarea ? this._tablecellarea : this.tablecellarea;
    };
    ...
    _pComponent._convToPixel = function (val, parentsize)
    {
        ...
        {
            return (parentsize * parseFloat(val)) / 100;
        }
    ...
    _pComponent._isFluidContainer = function (binner)
    {
        ...
        var form = binner ? this.parent._getForm() : this._getForm();
    ...
    */
    ...
    _pComponent._getPopupContainerCSSSelector = function ()
    {
        ...
        if (popupcontrol)
        {
            ...
            {
                var cssclass;
                var cssclass_arr = parent.cssclass.split(",");
    ...
    _pComponent._isVisible = function ()
    {
        ...
        while (form != null)
        {
            if (form.visible == false && !form._isNotProcessedWheelZoom)
                return false;
            if (form._is_window)
                break;
    ...
    _pPopupControl.accessibilityrole = "application";
