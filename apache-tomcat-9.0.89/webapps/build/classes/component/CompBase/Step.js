...
if (!nexacro.StepControl)
{
    ...
    _pStepControl.on_change_containerRect = function (/*width, height*/)
    {
        if (this._is_created)
        {
            this._redrawStepButton();
            //this._updateStepLayout(); 하위만 업데이트 필요해서 막음
        }
    };
    ...
    //===============================================================
    // nexacro.StepControl : Override
    //===============================================================


    //===============================================================
    // nexacro.StepControl : Properties
    //===============================================================
    ...
    _pStepControl.on_apply_stepcount = function (/*stepcount*/)
    {
        var control_elem = this.getElement();
        if (control_elem)
        {
                ...
                if (form)
                {
                    ...
                    if (form_control_elem)
                    {
                        ...
                        for (var i = 0; i < comp_len; i++)
                        {
                            ...
                            // TODO2 : positionstep -1 인 경우 처리 필요
                            if (comp.positionstep == -1)
                            {
                                before_comp = comp;
                                before_elem = form_control_elem.getContainerElement(before_comp.positionstep);
                            }

                            if (before_comp && before_comp != comp)
                            {
                                cur_elem = form_control_elem.getContainerElement(comp.positionstep);
                                if (before_elem == cur_elem)
                                {
                                    before_comp.moveToNext(comp.id);
                                    before_comp = null;
                                }
                            }
                    ...
                    if (manager)
                    {
                        manager.setLayoutProperty(form, "", "stepindex", stepindex);
                    }
                }
            }
        }
    ...
    //===============================================================
    // nexacro.StepControl : Event Handler
    //===============================================================
    ...
    _pStepControl._on_button_onclick = function (obj/*, e*/)
    {
    ...
    //===============================================================
    // nexacro.StepControl : Logical Part
    //===============================================================
    ...
    //===============================================================
    // nexacro.StepControl : Util Function
    //===============================================================
