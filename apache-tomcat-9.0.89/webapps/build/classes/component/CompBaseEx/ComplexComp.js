...
if (!nexacro.ComplexComponent)
{
    ...
    */
    ...
    _pComplexComponent._getNCChildren = function ()
    {
        ...
        if (this._is_nc_scroll)
        {
            if (this.vscrollbar && this.vscrollbar.visible) children.push(this.vscrollbar);
            if (this.hscrollbar && this.hscrollbar.visible) children.push(this.hscrollbar);
        }
        if (this._is_nc_expand)
        {
            if (this.expandbar && this.expandbar.visible) children.push(this.expandbar);
        }
