(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_text("버튼 동적 생성 시 moveToPrev();로 순서 바꿨을 때.\r\n방향키와 TAB 읽어주는게 다름.");
            this.addChild(obj.name, obj);
        ...
        this.btnSub1Menu_onclick = function (obj, e)
        {
        	...
        	for (var i = 0; i < this.dsSubMenu1.getRowCount(); i++)
        	{
        		...
        		objBtn.menuid = sMenuId;
        		objBtn.show();
        		trace("objPrev.id  "+objPrev.id);
        		trace("objPrev.taborder  "+objPrev.taborder);
        		trace("objBtn.id  "+objBtn.id);
        		trace("objBtn.taborder  "+objBtn.taborder);
