(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Radio("Radio00","292","623","620","88",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            var Radio00_innerdataset = new nexacro.NormalDataset("Radio00_innerdataset", obj);
            Radio00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">a</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">b</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">c</Col></Row><Row><Col id=\"codecolumn\">4</Col><Col id=\"datacolumn\">d</Col></Row></Rows>");
            obj.set_innerdataset(Radio00_innerdataset);
            this.addChild(obj.name, obj);

            obj = new Button("Button02","1021","650","150","64",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("Button02");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1280,830,this,function(p){});
        ...
        this.loadIncludeScript("RP_101801_comboTest (3).xfdl");
