if (nexacro.Environment)
{
    ...
    env.on_init = function ()
    {
        ...
        this.set_accessibilitydescreadtype("label,action,description");
        this.set_accessibilitycontentsearchkey("false");
    };
    ...
    {
    	nexacro.getEnvironment().accessibilitycontentsearchkey = false;
    };
