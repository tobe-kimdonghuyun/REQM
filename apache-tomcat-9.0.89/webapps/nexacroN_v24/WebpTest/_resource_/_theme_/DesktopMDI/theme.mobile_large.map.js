(function()
{
	return function()
	{
            ...
            "TitleBarControl" :
            			...
            			"Form" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						...
            						"font" : nexacro.FontObject("300 13px \"Malgun Gothic\"")
            					},
            					"contents" :
            					{
            					}
            						...
            						"btn_TF_Menu" :
            						{
            							"self" :
            							{
            								...
            								"selected" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("0px 25px 0px 25px"),
            									"color" : nexacro.ColorObject("#2e4198"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            								"mouseover" :
            								{
            					...
            					},
            					{
            						"btn_MDI_Menu" :
            						{
            							"self" :
            							{
            								...
            								"selected" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #e1e2e7, 1px solid #ffffff, 0px none"),
            									"padding" : nexacro.PaddingObject("0px 40px 0px 20px"),
            									"color" : nexacro.ColorObject("#333333"),
            									"font" : nexacro.FontObject("bold 13px \"Malgun Gothic\"")
            								},
            					...
            					},
            					{
            						"btn_MF_Quick01" :
            						{
            							"self" :
            							{
            								...
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("1px solid #21bdca")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #21bdca")
            					...
            					},
            					{
            						"btn_WF_Custom" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #66738a"),
            					...
            					},
            					{
            						"btn_WF_Search" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #13aab7"),
            					...
            					},
            					{
            						"chk_LOGIN_Id" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"icon" : nexacro.UrlObject("url('theme://images/chk_LOGIN_box.png')"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 5px"),
            									"color" : nexacro.ColorObject("#666666"),
            									"font" : nexacro.FontObject("12px \"Malgun Gothic\"")
            								},
            								...
            								"mouseover" :
            								{
            									"icon" : nexacro.UrlObject("url('theme://images/chk_LOGIN_boxO.png')")
            								},
            								"selected" :
            								{
            									"icon" : nexacro.UrlObject("url('theme://images/chk_LOGIN_boxS.png')")
            								},
            								"mouseover_selected" :
            								{
            									"icon" : nexacro.UrlObject("url('theme://images/chk_LOGIN_boxS.png')")
            												...
            												"cal_MF_Cal" :
            												{
            													"self" :
            													{
            														"enabled" :
            														{
            															...
            															"font" : nexacro.FontObject("bold 20px \"Myriad Pro\"")
            														}
            													}
            												}
            											}
            						...
            						"edi_LF_Sch" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"color" : nexacro.ColorObject("#9ba4cd"),
            								...
            								"nulltext" :
            								{
            									"color" : nexacro.ColorObject("#656e99")
            								}
            							}
            						}
            					},
            			...
            			"Grid" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid #b8bac3,1px solid #e1e2e7,1px solid #e1e2e7,1px solid #e1e2e7")
            					}
            				},
            				"class" :
            				[
            											...
            											},
            											{
            												"grd_LF_Menu" :
            												{
            													"self" :
            													{
            														...
            														"selected" :
            														{
            															"color" : nexacro.ColorObject("#21bdca"),
            															"font" : nexacro.FontObject("bold 14px \"Malgun Gothic\"")
            														}
            													}
            												}
            													...
            													[
            														{
            															"grd_LF_Menu" :
            															{
            																"self" :
            																{
            																	...
            																	{
            																		"border" : nexacro.BorderObject("0px none"),
            																		"padding" : nexacro.PaddingObject("15px 0px 5px 6px"),
            																		"color" : nexacro.ColorObject("#ffffff"),
            																		"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            																	},
            																	"selected" :
            															...
            															"grd_MF_Todo" :
            															{
            																"self" :
            																{
            																	"enabled" :
            																	{
            																		"border" : nexacro.BorderObject("0px none"),
            																		"padding" : nexacro.PaddingObject("0px 0px 0px 0px"),
            																		"font" : nexacro.FontObject("8px \"Malgun Gothic\"")
            																	},
            																	"mouseover" :
            																	{
            																		"border" : nexacro.BorderObject("0px none"),
            						...
            						"sta_MF_Menu" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 25px"),
            									"font" : nexacro.FontObject("bold 23px \"Malgun Gothic\""),
            									"letterSpacing" : nexacro.CSSValueObject("-1px")
            								}
            							}
            						}
            						...
            						"sta_WF_BoxTitle" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"padding" : nexacro.PaddingObject("0px 0px 0px 30px"),
            									"color" : nexacro.ColorObject("#333333"),
            									"font" : nexacro.FontObject("20px \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"sta_WF_TestTitle" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#333333"),
            									"font" : nexacro.FontObject("bold 30px \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            				...
            				"parent" :
            				{
            					"Tab" :
            					{
            						"self" :
            						{
            							...
            							"selected" :
            							{
            								"border" : nexacro.BorderObject("1px solid #c8cdd7,1px solid #c8cdd7,0px none,1px solid #c8cdd7"),
            								"color" : nexacro.ColorObject("#333333")
            							},
            							"disabled" :
            							{
            							...
            							"Tab" :
            							{
            								"self" :
            								{
            									"enabled" :
            									{
            										...
            										"font" : nexacro.FontObject("bold 14px/32px \"Malgun Gothic\"")
            									},
            									"mouseover" :
            									{
            									},
            			...
            			"TextArea" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						...
            						"wordWrap" : "char",
            						"font" : nexacro.FontObject("13px/18px \"Malgun Gothic\"")
            					},
            					"mouseover" :
            					{
            						"border" : nexacro.BorderObject("1px solid #6c7189")
            					...
            					},
            					{
            						"pdiv_LF_Sch" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #2e4198")
            								}
            							}
            						}
            					},
            				...
            				[
            					{
            						"div_WF_Search" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #d6e9eb")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"div_WF_Box" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #B7B7B7")
            								}
            							}
            						}
            					}
        ...
        imgcache[nexacro._getImageLocation("theme://images/titlebar_icon.png")] = { width:16, height:16 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/webp/btn_MF_Quick01.png")] = { width:63, height:87 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/btn_MF_Quick01.webp")] = { width:0, height:0 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/btn_MF_Quick02.png")] = { width:75, height:87 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/btn_MF_Quick02.webp")] = { width:0, height:0 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/btn_MF_Quick03.png")] = { width:52, height:87 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/btn_MF_Quick03.webp")] = { width:0, height:0 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sample01.png")] = { width:320, height:320 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sample01.webp")] = { width:0, height:0 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sample02.png")] = { width:320, height:320 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sample02.webp")] = { width:0, height:0 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sample03.png")] = { width:320, height:320 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sample03.webp")] = { width:0, height:0 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sample04.png")] = { width:580, height:580 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sample04.webp")] = { width:0, height:0 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sampleGif.gif")] = { width:400, height:400 };
        		imgcache[nexacro._getImageLocation("theme://images/webp/sampleGif.webp")] = { width:0, height:0 };
	};
}
)();
