(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new RaonkUpload("RaonkUpload","1880","4410","1020","200",null,null,null,null,null,null,this);
            obj.getSetter("taborder").set("5");
            obj.getSetter("DevelopLangage").set("JAVA");
            obj.getSetter("ExtensionAllowOrLimit").set("1");
            obj.getSetter("HandlerUrl").set("http://localhost:8080/common/uploadDownload.do");
            ...
            obj = new Layout("default","Desktop_screen,Phone_screen",1480,900,this,
                ...
                p.RaonkUpload.getSetter("taborder").set("5");
                p.RaonkUpload.getSetter("DevelopLangage").set("JAVA");
                p.RaonkUpload.getSetter("ExtensionAllowOrLimit").set("1");
                p.RaonkUpload.getSetter("HandlerUrl").set("http://localhost:8080/common/uploadDownload.do");
                ...
                p.RaonkUpload.move("1880","4410","1020","200",null,null);
            	}
            );
        ...
        // User Script
        this.addIncludeScript("LIF080M00_2.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF080M00_2.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("LIF080M00_2.xfdl");
