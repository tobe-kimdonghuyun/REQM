(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnGoPlayNexacro","btnGoTobesoft:8","250",null,"50","153",null,null,null,null,null,this.div00.form);
            obj.set_taborder("3");
            ...
            obj = new Button("btn00",null,"15","30","30","20",null,null,null,null,null,this.div00.form.divNoti.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_More");
            this.div00.form.divNoti.addChild(obj.name, obj);

            obj = new Div("div01","30","442",null,"80","30",null,null,null,null,null,this.div00.form);
            obj.set_taborder("6");
            obj.set_text("div01");
            this.div00.addChild(obj.name, obj);
