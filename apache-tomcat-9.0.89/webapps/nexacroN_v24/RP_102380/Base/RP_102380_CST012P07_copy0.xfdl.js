    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Layout("mobile","",0,0,this.divForm.form,
                ...
                p = rootobj;
                p.divSch.set_text("Div00");
                p.divSch.set_border("3px solid greenyellow");
            	}
            );
            obj.set_type("vertical");
            obj.set_verticalgap("30");
            ...
            obj = new Layout("mobile","Phone_screen",480,600,this,
                ...
                p.divForm.set_border("3px solid blue");
        ...
        // User Script
        this.registerScript("RP_102380_CST012P07_copy0.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("RP_102380_CST012P07_copy0.xfdl");
