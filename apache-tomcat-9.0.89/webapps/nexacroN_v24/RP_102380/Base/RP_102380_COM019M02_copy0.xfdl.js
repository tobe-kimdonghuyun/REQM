(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button00","177","22","369","52",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("PC");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new Layout("Layout0","",0,0,this.divForm.form.divGrd.form,
                ...
                p.btnGrdDel.move("316.00","0","45","64",null,null);

                p.btnGrdRegi.set_background("gold");
                p.btnGrdRegi.move("371.00","0","45","64",null,null);
            	}
            );
            obj.set_verticalgap("20");
            this.divForm.form.divGrd.form.addLayout(obj.name, obj);
            ...
            obj = new Layout("default","Desktop_screen",1480,900,this,
                ...
                p.Button00.set_text("PC");
                p.Button00.move("177","22","369","52",null,null);
            	}
            );
            ...
            //-- Normal Layout : this
            obj = new Layout("Layout0","Phone_screen,Desktop_screen",480,600,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.divForm.move("20","20",null,"390","20",null);

                p.divTitle.set_border("5px solid coral");
                p.divTitle.move("10","560",null,"50","-10",null);

                p.Button00.set_text("M");
                p.Button00.move("31","250","369","52",null,null);
            	}
            );
            obj.set_mobileorientation("Landscape");
        ...
        // User Script
        this.registerScript("RP_102380_COM019M02_copy0.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("RP_102380_COM019M02_copy0.xfdl");
