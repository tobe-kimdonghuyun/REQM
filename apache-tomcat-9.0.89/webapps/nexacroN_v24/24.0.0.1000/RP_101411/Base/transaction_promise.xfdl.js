(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button00","12","14","198","86",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Button00");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","15","123","715","297",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_binddataset("Dataset00");
            obj._setContents("<Formats><Format id=\"default\"/></Formats>");
            this.addChild(obj.name, obj);

            obj = new TextArea("TextArea00","253","16","390","90",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // 	trace("start upload-promise");
        	//const req = this.transaction(serviceID,"http://172.10.12.45:9090/service_jsp/B_TR_Binary.jsp","","Dataset00=output","","",true,"2");
        	this.transaction(serviceID,"http://172.10.12.45:9090/RP_99900_B_TR_XML.jsp","","Dataset00=output3","","callbackFunction1",true,"1");
