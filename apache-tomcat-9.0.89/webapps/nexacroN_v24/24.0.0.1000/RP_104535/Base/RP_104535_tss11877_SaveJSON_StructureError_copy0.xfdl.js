(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button01","636","383","157","52",null,null,null,null,null,null,this);
            obj.set_taborder("14");
        ...
        // User Script
        this.registerScript("RP_104535_tss11877_SaveJSON_StructureError_copy0.xfdl", function() {
        ...
        {
        	var sJSON = this.Dataset00.saveXML();
        	this.taSaveJSON.set_value(sJSON);
        };
        ...
        this.loadIncludeScript("RP_104535_tss11877_SaveJSON_StructureError_copy0.xfdl");
