(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_text("route_target : Sub System D main2.xfdl");
        ...
        // User Script
        this.registerScript("main2.xfdl", function() {

        this.main_onload = function(obj,e)
        {
        	this.Static00.text = "route_target : Sub System D main2.xfdl : "+`loaded from ${this._url}`;
        };
        ...
        this.loadIncludeScript("main2.xfdl");
