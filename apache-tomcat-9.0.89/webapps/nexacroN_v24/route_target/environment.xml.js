if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("SubA", "form", "./SubA/", "session", null, "", "0", "0");
        nexacro._addService("SubB", "form", "./SubB/", "session", null, "", "0", "0");
        nexacro._addService("SubC", "form", "./SubC/", "session", null, "", "0", "0");
        nexacro._addService("SubD", "form", "./SubD/", "session", null, "", "0", "0");
        nexacro._addService("lib", "js", "./lib/", "session", null, "", "0", "0");
        nexacro._addService("gtmd", "file", "./mmaMW/gtmd/", "session", null, "", "0", "0");
        nexacro._addService("mwps", "form", "./mmaMW/mwps/", "session", null, "", "0", "0");
