if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcUrl", "JSP", "http://127.0.0.1:4099/tsc/", "none", null, "", "0", "0");
        nexacro._addService("xjs", "js", "./xjs/", "session", null, "", "0", "0");
        nexacro._addService("common", "form", "./common/", "session", null, "", "0", "0");
        nexacro._addService("work", "form", "./work/", "session", null, "", "0", "0");
        nexacro._addService("publishing", "form", "./publishing/", "session", null, "", "0", "0");
        nexacro._addService("tsc_data", "file", "./tsc_data/", "session", null, "", "0", "0");
        nexacro._addService("RaonkUpload", "file", "./_extlib_/raonkupload/", "session", null, "", "0", "0");
