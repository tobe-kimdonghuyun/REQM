(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.FileUpload("FileUpload00","90","50","240","121",null,null,null,null,null,null,this);
        ...
        // User Script
        this.registerScript("fileupload_scroll.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.loadIncludeScript("fileupload_scroll.xfdl");
