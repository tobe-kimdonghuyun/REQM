(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01.png\')");
            obj.set_taborder("1");
            obj.set_text("btn01");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Layout("default","mobile,medium,large",1280,720,this,
                ...
                p.btn01.set_icon("url(\'theme::Mobile/images/btn_RF_1Depth01.png\')");
            ...
            //-- Normal Layout : this
            obj = new nexacro.Layout("Layout0","mobile,large",720,480,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
            ...
            //-- Normal Layout : this
            obj = new nexacro.Layout("Layout3","mobile,medium,large",640,720,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
        ...
        // User Script
        this.registerScript("MLM_1.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.loadIncludeScript("MLM_1.xfdl");
