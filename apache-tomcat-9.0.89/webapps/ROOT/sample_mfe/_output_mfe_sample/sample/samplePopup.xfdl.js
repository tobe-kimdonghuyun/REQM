(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("btnPopup","30","30",null,"60","51.04%",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("모달팝업");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btnPopup00","btnPopup:10","30",null,"60","30",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("모달리스 팝업");
            this.addChild(obj.name, obj);

            obj = new nexacro.Combo("cbo00","94","177","222","89",null,null,null,null,null,null,this);
            obj.set_rtl("true");
            obj.set_taborder("2");
            obj.set_text("cbo00");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("samplePopup.xfdl", function(nexacro, system, trace, environment, application) {
        /**
        *  Mobile 프로젝트
