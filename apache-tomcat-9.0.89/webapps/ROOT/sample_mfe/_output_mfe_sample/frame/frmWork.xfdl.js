(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Div("divWork","0","0",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            //-- Default Layout : this
            obj = new nexacro.Layout("default","",480,713,this,function(p){});
        ...
        // User Script
        this.registerScript("frmWork.xfdl", function(nexacro, system, trace, environment, application) {
        /**
        *  Mobile 프로젝트
