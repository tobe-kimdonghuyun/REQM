(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getDeletedRowset_01_v2");
            this.set_titletext("TA_Dataset_M_getDeletedRowset_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getDeletedRowset_48156_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","313","298","129",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_value("//");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_clear","241","242","63","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("5");
            obj.set_text("clear");
            this.addChild(obj.name, obj);

            obj = new nexacro.Grid("Grid00","5","61","295","139",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("btn_deleteRow","117","209","90","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_text("deleteRow()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static03","10","211","49","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("nRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_nRow","64","208","47","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_value("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_addRow","211","209","93","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("10");
            obj.set_text("addRow()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_getDeletedRowset","36","242","188","32",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("11");
            obj.set_text("getDeletedRowset()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_set_updatecontrol","253","281","51","26",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("set");
            this.addChild(obj.name, obj);

            obj = new nexacro.Radio("Radio00","112","277","130","38",null,null,null,null,null,null,this);
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_rowcount("1");
            obj.set_taborder("13");
            var Radio00_innerdataset = new nexacro.NormalDataset("Radio00_innerdataset", obj);
            Radio00_innerdataset._setContents({"ColumnInfo" : {"Column" : [{"id" : "codecolumn","size" : "256"},{"id" : "datacolumn","size" : "256"}]},"Rows" : [{"codecolumn" : "true","datacolumn" : "true"},{"codecolumn" : "false","datacolumn" : "false"}]});
            obj.set_innerdataset(Radio00_innerdataset);
            obj.set_value("false");
            obj.set_index("1");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static00","10","275","101","40",null,null,null,null,null,null,this);
            obj.set_taborder("14");
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getDeletedRowset_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getDeletedRowset_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getDeletedRowset_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getDeletedRowset Method
        ***********************************************************************
        *	  수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getDeletedRowset Method Test",
        ...
        tc1.task['getDeletedRowset'] = function() {
        	var result = [];
        	var objArr = this.dataset.getDeletedRowset();
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "updatecontrol=true, getDeletedRowset() 수행",
        	autoTaskFlow : ["deleteRow", "getDeletedRowset"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		case "deleteRow":
        			...
        			break;
        		case "getDeletedRowset":
        			var rtn = tc1.task['getDeletedRowset'].call(this);
        	...
        	check: function (resultValue) {
        		var expectedValue = [1,"유동규",100,"투우",1,"주인희",200,"비이"];
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "updatecontrol=false, getDeletedRowset() 수행",
        	autoTaskFlow : ["deleteRow", "getDeletedRowset"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getDeletedRowset_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getDeletedRowset_01_v2_onload,this);
            ...
            this.btn_getDeletedRowset.addEventHandler("onclick",this.btn_getDeletedRowset_onclick,this);
            this.btn_set_updatecontrol.addEventHandler("onclick",this.btn_set_updatecontrol_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getDeletedRowset_01.xfdl");
