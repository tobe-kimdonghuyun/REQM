(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_findRowNF_01_v2");
            this.set_titletext("TA_Dataset_M_findRowNF_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_findRowNF_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_findRowNF","151","248","69","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("findRowNF");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_findRowNF_01.xfdl","lib::libCommon.xjs");
        this.registerScript("A_Dataset_M_findRowNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset findRowNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset findRowNF Method Test",
        ...
        tc1.task['findRowNF'] = function(strColID, strVal, nStartIdx , nEndIdx) {
        	var result = [];
        	var rtnfindRowNF;

        	if(nStartIdx == "생략" && nEndIdx == "생략")
        		rtnfindRowNF = this.dataset.findRowNF(strColID, strVal);
        	else if(nEndIdx == "생략")
        		rtnfindRowNF = this.dataset.findRowNF(strColID, strVal, nStartIdx);
        	else
        		rtnfindRowNF = this.dataset.findRowNF(strColID, strVal, nStartIdx , nEndIdx);

        	result.push(rtnfindRowNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "findRowNF(strColID, strVal, nStartIdx , nEndIdx) 수행",
        	autoTaskFlow : ["findRowNF"],
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,200],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"]],ev: [2]},
        				//grouping 후
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,400],[tapi.VBT_MIN,0],[tapi.VBT_EXCEPTION,"생략"]],ev: [4]},
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "findRowNF":
        			var rtn = tc1.task['findRowNF'].call(this, strColID, strVal, nStartIdx, nEndIdx);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_findRowNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_findRowNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_findRowNF.addEventHandler("onclick",this.btn_findRowNF_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_findRowNF_01.xfdl");
