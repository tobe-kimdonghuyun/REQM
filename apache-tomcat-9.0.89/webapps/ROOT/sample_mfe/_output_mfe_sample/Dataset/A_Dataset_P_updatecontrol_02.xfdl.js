(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.TextArea("txt_result","11","443","298","98",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_value("//");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_clear","246","411","63","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_text("clear");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_addRow","216","380","93","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("5");
            obj.set_text("addRow()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_deleteRow","122","380","90","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("deleteRow()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static03","15","382","58","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_text("nRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_nRow","69","379","47","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_value("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_getRowType","69","413","170","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("10");
            obj.set_text("all getRowType()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static06","15","270","101","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("11");
            obj.set_text("updatecontrol");
            this.addChild(obj.name, obj);

            obj = new nexacro.Radio("rb_updatecontrol","120","263","101","36",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("btn_set","230","267","35","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("13");
            obj.set_text("set");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_get","270","267","35","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("14");
            obj.set_text("get");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static00","15","310","58","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("15");
            obj.set_text("nRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static02","15","342","90","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("16");
            obj.set_text("nRowType");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_nRow1","98","307","110","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("17");
            obj.set_value("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_setRowType1","216","307","93","56",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("18");
            obj.set_text("setRowType()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Combo("cb_nRowType","98","339","110","26",null,null,null,null,null,null,this);
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.getSetter("position").set("absolute");
            obj.set_taborder("19");
            ...
            obj = new nexacro.Grid("Grid00","8","60","295","190",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Grid("Grid2","320","59","295","194",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_P_updatecontrol_02.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_P_updatecontrol_02.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_P_updatecontrol_02.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        ...
        tc1.task['updatecontrol'] = function(bUpdatecontrol) {
        	if(bUpdatecontrol != "default")
        	{
        		...
        		this.ds_data2.set_updatecontrol(bUpdatecontrol);
        	}
        }
        ...
        tc1.task['getRowType'] = function() {
        	var result = [];
        	var rtnGetRowType;
        	if (this.dataset.updatecontrol !== false)
        		this.dataset.applyChange();
        	for(var i=0; i<this.ds_data2.getRowCount(); i++)
        	{
        		rtnGetRowType = this.ds_data2.getRowType(i);
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_P_updatecontrol_02.xfdl");
