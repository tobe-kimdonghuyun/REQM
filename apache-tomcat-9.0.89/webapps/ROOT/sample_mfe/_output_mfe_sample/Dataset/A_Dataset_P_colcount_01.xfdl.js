(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_P_colcount_48042_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","360","298","83",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("2");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_clear","241","256","63","19",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("Static00","5","225","82","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("5");
            obj.set_text("colcount");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txt_value","87","225","217","24",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_value("100");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_set","123","256","52","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_text("set");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_get","179","256","52","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("get");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_addColumn","12","255","68","21",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("addColumn");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static02","13","285","58","13",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("ColID");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static03","13","310","58","13",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("ColType");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static04","13","336","58","13",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("ColSize");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txtColID","80","282","219","18",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_value("colE");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txtColType","80","307","219","18",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_value("string");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txtColSize","80","333","219","18",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_P_colcount_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_P_colcount_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_P_colcount_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset colcount Property
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset colcount Property Test",
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "Column 추가 후 colcount",
        	autoTaskFlow : ["addColumn", "colcount"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		case "addColumn":
        			...
        			break;
        		case "colcount":
        			rtn = tc1.task['colcount'].call(this);
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "ConstColumn 추가 후 colcount",
        	autoTaskFlow : ["addConstColumn", "colcount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        	prepare: function () {
        ...
        tc1.validator ['tc1_vd3'] = {
        	description: "deleteColumn 후 colcount",
        	autoTaskFlow : ["deleteColumn", "colcount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        			//vc : colVal, ev : colcount
        			{vc: [[tapi.VBT_NORMAL,0]],  	ev: [8]},
        			{vc: [[tapi.VBT_NORMAL,"ConstA"]],  ev: [7]},
        		]
        	},
        	prepare: function () {
        	},
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_P_colcount_01.xfdl");
