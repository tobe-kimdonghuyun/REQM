(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_setRowType_01_v2");
            this.set_titletext("TA_Dataset_M_setRowType_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_setRowType_48101_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_setRowType_02.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_setRowType_02.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_setRowType_02.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset setRowType Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset setRowType Method Test",
        ...
        tc1.task['setRowType'] = function(nRow, varRowType) {
        	var result = [];
        	var rtnsetRowType = this.dataset.setRowType(nRow, varRowType);

        	result.push(rtnsetRowType);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "updatecontrol에 따른 setRowType(varCol, varVal) 수행",
        	autoTaskFlow : ["setRowType", "eventChk", "getRowType"],
        	vcinfo : {
        		...
        		args : [
        				...
        				//filter 후
        				{vc: [[tapi.VBT_NORMAL,3],[tapi.VBT_NORMAL,Dataset.ROWTYPE_EMPTY]],   ev: [false,"",0]},
        			]
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "setRowType":
        			var rtn = tc1.task['setRowType'].call(this, nRow, varRowType);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_setRowType_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_setRowType_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_M_setRowType_02.xfdl");
