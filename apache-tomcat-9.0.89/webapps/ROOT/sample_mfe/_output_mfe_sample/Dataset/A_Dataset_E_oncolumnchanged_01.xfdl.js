(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_E_oncolumnchanged_01_v2");
            this.set_titletext("TA_Dataset_E_oncolumnchanged_01_v2");
            ...
            obj._setContents({"ColumnInfo" : {"ConstColumn" : [{"id" : "ConstA","size" : "30","type" : "STRING","value" : "A"},{"id" : "ConstB","size" : "30","type" : "STRING","value" : "B"},{"id" : "ConstC","size" : "30","type" : "STRING","value" : "C"}],"Column" : [{"id" : "colA","size" : "256","type" : "BIGDECIMAL"},{"id" : "colB","size" : "256","type" : "STRING"},{"id" : "colC","size" : "256","type" : "INT"},{"id" : "colD","size" : "256","type" : "STRING"}]},"Rows" : [{"colB" : "유동규","colA" : "","colC" : "100","colD" : "투우"},{"colB" : "주인희","colA" : "1","colC" : "200","colD" : "비이"},{"colB" : "고준영","colA" : "2","colC" : "200","colD" : "소오"},{"colB" : "이정빈","colA" : "3","colC" : "300","colD" : "프트"},{"colA" : "4","colB" : "김선주","colC" : "400","colD" : "비이"}]});
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_E_oncolumnchanged_48079_01]");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"45\"/><Column size=\"45\"/><Column size=\"45\"/><Column size=\"45\"/><Column size=\"45\"/><Column size=\"45\"/><Column size=\"45\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"colA\"/><Cell col=\"1\" text=\"colB\"/><Cell col=\"2\" text=\"colC\"/><Cell col=\"3\" text=\"colD\"/><Cell col=\"4\" text=\"ConstA\"/><Cell col=\"5\" text=\"ConstB\"/><Cell col=\"6\" text=\"ConstC\"/></Band><Band id=\"body\"><Cell edittype=\"normal\" text=\"bind:colA\"/><Cell col=\"1\" text=\"bind:colB\"/><Cell col=\"2\" text=\"bind:colC\"/><Cell col=\"3\" text=\"bind:colD\"/><Cell col=\"4\" text=\"bind:ConstA\"/><Cell col=\"5\" text=\"bind:ConstB\"/><Cell col=\"6\" text=\"bind:ConstC\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_E_oncolumnchanged_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_E_oncolumnchanged_01.xfdl","libevent::event.util.xjs");
        this.addIncludeScript("A_Dataset_E_oncolumnchanged_01.xfdl","libevent::event.wrapper.xjs");
        this.registerScript("A_Dataset_E_oncolumnchanged_01.xfdl", function(nexacro, system, trace, environment, application) {
        /**********************************************************************
        * 설명      : Dataset oncolumnchanged Event
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.02.13  김형철   최초 작성
        	  ...
        	  2019.04.18  김형철   마우스API clickEx -> nx_common_click 변경
        **********************************************************************/
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset oncolumnchanged Event Test",
        	//-------------- beign user defined section
        	userdata : {
        		eventReturnValue : "", 	//cancolumnchange 리턴값 설정
        ...
        tc1.task['setConstColumn'] = function(colVar, varVal) {
        	this.dataset.setConstColumn(colVar, varVal);
        };

        tc1.task['inputData'] = function() {
        	// 대기 상태 시작
        	...
        	nexacro.test.Event.nx_common_click(comp, 'lbutton', false, false, false, 20, 30);

        	var edit = nexacro.test.Event.nx_getGridEditor(comp);
        	nexacro.test.Event.sendKeys(edit, ['1122']);

        	nexacro.test.Event.key_downup(comp, "Enter", 0, false, false, false, 20, 30);
        };
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "setColumn() 수행",
        	autoTaskFlow : ["returnValue","setColumn","eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : 1.bCancolumnchange, 2.nRow, 3.nColIdx, 4.varVal, ev : 1.이벤트 정보
        			    {vc: [[tapi.VBT_NORMAL,true], [tapi.VBT_NORMAL,0], [tapi.VBT_NORMAL,1], [tapi.VBT_NORMAL,"TEST00"]], ev: ["cancolumnchange","ds_data1",1,-1,"colB","oncolumnchanged","[object Dataset]", "[object Dataset]", "TEST00", "유동규", 0]},
        				{vc: [[tapi.VBT_NORMAL,false], [tapi.VBT_NORMAL,1], [tapi.VBT_NORMAL,1], [tapi.VBT_NORMAL,"TEST00"]], ev: ["cancolumnchange",""]},
        				{vc: [[tapi.VBT_NORMAL,true], [tapi.VBT_NORMAL,0], [tapi.VBT_NORMAL,1], [tapi.VBT_NORMAL,"TEST01"]], ev: ["cancolumnchange","ds_data1",1,-1,"colB","oncolumnchanged","[object Dataset]", "[object Dataset]", "NewValue", "TEST00", 0]},
        		]
        	},
        	prepare: function () {
        		tc1.userdata.eventReturnValue = "true";
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "마우스클릭 후 cell값 변경 수행",
        	autoTaskFlow : ["returnValue","inputData","eventChk"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "returnValue":
        			tc1.task['returnValue'].call(this, true);
        			break;
        		case "inputData":
        			tc1.task['inputData'].call(this);
        			break;
        		case "eventChk":
        			rtn = tc1.task['eventChk'].call(this);
        			tc1.userdata.result.push(rtn);
        	...
        	check: function (resultValue) {
        		var expectedValue = ["cancolumnchange","ds_data1",0,-1,"colA","oncolumnchanged","[object Dataset]","[object Dataset]",1122,"",0];
        		var chk = tc1.checker['equal'].call(this, resultValue, expectedValue);
        		return chk;
        	},
        	teardown: function () {
        ...
        tc1.validator ['tc1_vd3'] = {
        	description: "setConstColumn() 수행",
        	autoTaskFlow : ["returnValue","setConstColumn","eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : 1.bCancolumnchange, 2.nRow, 3.nColIdx, 4.varVal, ev : 1.이벤트 정보
        			    {vc: [[tapi.VBT_NORMAL,true], [tapi.VBT_NORMAL,0], [tapi.VBT_NORMAL,"TEST00"]], ev: ["cancolumnchange","ds_data1",4,-1,"ConstA","oncolumnchanged","[object Dataset]","[object Dataset]","TEST00","A",-1]},
        				{vc: [[tapi.VBT_NORMAL,false], [tapi.VBT_NORMAL,1], [tapi.VBT_NORMAL,"TEST00"]], ev: ["cancolumnchange",""]}
        		]
        	},
        	prepare: function () {
        		tc1.userdata.eventReturnValue = "true";
        	...
        	run: function () {
        		...
        		case "returnValue":
        			...
        			break;
        		case "setConstColumn":
        			tc1.task['setConstColumn'].call(this, colVar, varVal);
        			break;
        		case "eventChk":
        			rtn = tc1.task['eventChk'].call(this);
        			tc1.userdata.result.push(rtn);
        ...
        ***********************************************************************/
        this.TA_Dataset_E_oncolumnchanged_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        this.ds_data1_cancolumnchange = function(obj,e)
        {
        	...
        	if (e.newvalue == "TEST01")
        		e.set_newvalue("NewValue");
        ...
        ***********************************************************************/
        this.ds_data1_oncolumnchanged = function(obj,e)
        {
        	...
        	tc1.userdata.eventChkList2.push(e.col);
        	tc1.userdata.eventChkList2.push(e.colidx);
        	tc1.userdata.eventChkList2.push(e.columnid);
        	tc1.userdata.eventChkList2.push(e.eventid);
        	tc1.userdata.eventChkList2.push(e.fromobject);
        	tc1.userdata.eventChkList2.push(e.fromreferenceobject);
        	tc1.userdata.eventChkList2.push(e.newvalue);
        	tc1.userdata.eventChkList2.push(e.oldvalue);
        	tc1.userdata.eventChkList2.push(e.row);
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_E_oncolumnchanged_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.Grid00.addEventHandler("onclick",this.Grid00_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_E_oncolumnchanged_01.xfdl");
