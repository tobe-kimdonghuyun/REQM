(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getColumnNF_01_v2");
            this.set_titletext("TA_Dataset_M_getColumnNF_01_v2");
            ...
            obj._setContents({"ColumnInfo" : {"ConstColumn" : [{"id" : "ConstA","size" : "30","type" : "STRING","value" : "A"},{"id" : "ConstB","size" : "30","type" : "STRING","value" : "B"},{"id" : "ConstC","size" : "30","type" : "STRING","value" : "C"}],"Column" : [{"id" : "colA","size" : "256","type" : "STRING"},{"id" : "colB","size" : "256","type" : "STRING"},{"id" : "colC","size" : "256","type" : "INT"},{"id" : "colD","size" : "256","type" : "STRING"}]},"Rows" : [{"colB" : "유동규","colA" : "","colC" : "100","colD" : "투우"},{"colB" : "주인희","colA" : "1","colC" : "200","colD" : "비이"},{"colB" : "고준영","colA" : "2","colC" : "200","colD" : "소오"},{"colB" : "이정빈","colA" : "3","colC" : "300","colD" : "프트"},{"colA" : "4","colB" : "김선주","colC" : "400","colD" : "비이"}]});
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getColumnNF_48170_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_getColumnNF1","211","152","93","56",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("12");
            obj.set_text("getColumnNF()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_getColumnNF2","211","216","93","56",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("13");
            obj.set_text("getColumnNF()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getColumnNF_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getColumnNF_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getColumnNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getColumnNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.03.14  김형철   최초 작성
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getColumnNF Method Test",
        ...
        tc1.task['getColumnNF'] = function(nRow, nVar) {
        	var result = [];
        	var rtngetColumnNF = this.dataset.getColumnNF(nRow, nVar);

        	result.push(rtngetColumnNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getColumnNF(nRow, nVar) 수행",
        	autoTaskFlow : ["getColumnNF"],
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0],[tapi.VBT_NORMAL,1]],   ev: ["유동규"]},
        				//keystring group 후
        				{vc: [[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,1]],   ev: ["주인희"]},
        				//filter 후
        				{vc: [[tapi.VBT_MIN,0],[tapi.VBT_NORMAL,1]],   ev: ["유동규"]},
        			]
        	},
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "getColumnNF":
        			var rtn = tc1.task['getColumnNF'].call(this, nRow, nVar);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getColumnNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getColumnNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_getColumnNF1.addEventHandler("onclick",this.btn_getColumnNF1_onclick,this);
            this.btn_getColumnNF2.addEventHandler("onclick",this.btn_getColumnNF2_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_getColumnNF_01.xfdl");
