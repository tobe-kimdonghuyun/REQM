(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_DataObject_E_onvaluechanged_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_DataObject_E_onvaluechanged_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_DataObject_E_onvaluechanged_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST01"]],   ev: [true,"onvaluechanged",true,"$.dataset[*]","DataObject00",0,"colA","ds_data1","TEST01","TEST01"]},
        				{vc: [[tapi.VBT_MIN,1],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,"TEST02"]],   ev: [true,"onvaluechanged",true,"$.dataset[*]","DataObject00",1,"colB","ds_data1","TEST02","TEST02"]},
        				{vc: [[tapi.VBT_MIN,3],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,"TEST03"]],   ev: [true,"onvaluechanged",true,"$.dataset[*]","DataObject00",3,"colB","ds_data1","TEST03","TEST03"]},
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_DataObject_E_onvaluechanged_01.xfdl");
