(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("[ColumnInfo_P_type_01]");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"126\"/><Column size=\"50\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"그룹코드\"/><Cell col=\"1\" text=\"부서코드\"/><Cell col=\"2\" text=\"이름\"/><Cell col=\"3\" text=\"연봉\"/><Cell col=\"4\" text=\"비고\"/></Band><Band id=\"body\"><Cell text=\"bind:그룹코드\"/><Cell col=\"1\" text=\"bind:부서코드\"/><Cell col=\"2\" text=\"bind:이름\"/><Cell col=\"3\" text=\"bind:연봉\"/><Cell col=\"4\" displaytype=\"imagecontrol\" text=\"bind:비고\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_ColumnInfo_P_type_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_ColumnInfo_P_type_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_ColumnInfo_P_type_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : ColumnInfo type Property
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.03.27  김형철   최초 작성
              2020.07.07  홍현표   RP:85216
        	                        columninfo type 속성 기대값 변경 (enum 처리 조건에 맞게 수정)
        							date,time,datetiem에서 currenttime이 기본값이 아닌 DataObject 기준 기본값(현재동작)
        							에 맞도록 기대값 수정
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "ColumnInfo type Property Test",
        ...
        tc1.task['setColumn'] = function() {
        	...
        	//float
        	this.dataset.setColumn(2,"연봉",123.456);
        	//bigdecimal
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "type(strType) 설정하고 getColumnInfo 확인",
        	autoTaskFlow : ["type", "getColumnInfo", "setColumn", "getCellText"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : strType, ev : getColumnInfo
        				{vc: [[tapi.VBT_NORMAL,"default"]],  ev: ["STRING","abc123"]},
        				{vc: [[tapi.VBT_NORMAL,"STRING"]],  ev: ["STRING","abc123"]},
        				{vc: [[tapi.VBT_NORMAL,"INT"]],  ev: ["INT",123]},
        				{vc: [[tapi.VBT_NORMAL,"FLOAT"]],  ev: ["FLOAT",123.456]},
        				{vc: [[tapi.VBT_NORMAL,"BIGDECIMAL"]],  ev: ["BIGDECIMAL",123.45678945678945]},
        				{vc: [[tapi.VBT_NORMAL,"DATE"]],  ev: ["DATE","1970-01-01"]},
        				{vc: [[tapi.VBT_NORMAL,"TIME"]],  ev: ["TIME","09:46:50"]},
        				{vc: [[tapi.VBT_NORMAL,"DATETIME"]],  ev: ["DATETIME","0000-01-01 00:00:00"]},
        				{vc: [[tapi.VBT_NORMAL,"BLOB"]],  ev: ["BLOB","data:image;base64,/9j/4AAQSkZJRgABAQEAYABgAAD/2wBDAAIBAQIBAQICAgICAg"+
        				"ICAwUDAwMDAwYEBAMFBwYHBwcGBwcICQsJCAgKCAcHCg0KCgsMDAwMBwkODw0MDgsMDAz/2wBDAQICAgMDAwYDAwYMCAcIDAwMDAwMDAwMDAwMDAwMD"+
        				""]},
        				//[확인필요] strType 파라미터에 invalid 데이터 설정 시 STRING으로 동작은 하지만 getColumnInfo.type 값 접근하면 invalid 데이터가 설정되어 있음
        				{vc: [[tapi.VBT_EXCEPTION,"test"]],  ev: ["BLOB","abc123"]},
        		]
        	},
        	prepare: function () {
        	},
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_ColumnInfo_P_type_01.xfdl");
