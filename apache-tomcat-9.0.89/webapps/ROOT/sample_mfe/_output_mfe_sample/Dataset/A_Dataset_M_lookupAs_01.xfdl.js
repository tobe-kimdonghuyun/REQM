(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_lookupAs_01_v2");
            this.set_titletext("TA_Dataset_M_lookupAs_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_lookupAs_48119_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_lookupAs","139","264","92","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("lookupAs");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_lookupAs_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_lookupAs_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_lookupAs_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset lookupAs Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset lookupAs Method Test",
        ...
        tc1.task['lookupAs'] = function(strColID, varCmpVal, strOutputColID, arrArgs) {
        	var result = [];
        	var rtnlookupAs;

        	if(arrArgs == "생략")
        		rtnlookupAs = this.dataset.lookupAs(strColID, varCmpVal, strOutputColID);
        	else
        		rtnlookupAs = this.dataset.lookupAs(strColID, varCmpVal, strOutputColID, arrArgs);

        	result.push(rtnlookupAs);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "lookupAs(strColID, varCmpVal, strOutputColID, arrArgs) 수행",
        	autoTaskFlow : ["lookupAs"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "lookupAs":
        			var rtn = tc1.task['lookupAs'].call(this, strColID, varCmpVal, strOutputColID, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_lookupAs_01_v2_onload = function(obj,e)
        {
        ...
        * 07 : 사용자 정의 함수 선언부
        ***********************************************************************/
        this.btn_lookupAs_onclick = function(obj,e)
        {
        	var strColID = "$0";
        	var varCmpVal = "유동규"
        	var strOutputColID = "colC";
        	var arrArgs = new Array("colB");
        	var rtnlookup = this.dataset.lookupAs(strColID, varCmpVal, strOutputColID, arrArgs);
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_lookupAs_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_lookupAs.addEventHandler("onclick",this.btn_lookupAs_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_lookupAs_01.xfdl");
