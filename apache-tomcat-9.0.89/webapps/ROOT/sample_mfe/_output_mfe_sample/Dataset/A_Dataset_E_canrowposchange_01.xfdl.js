(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_E_canrowposchange_01_v2");
            this.set_titletext("TA_Dataset_E_canrowposchange_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_E_canrowposchange_48085_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","263","298","181",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("2");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_clear","241","216","63","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_addRow","139","216","92","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("5");
            obj.set_text("addRow");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("Static00","10","187","122","31",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_text("canrowposchange return");
            this.addChild(obj.name, obj);

            obj = new nexacro.Radio("rd_canrowreturn","139","184","161","26",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_E_canrowposchange_01.xfdl","lib::libCommon.xjs");
        this.registerScript("A_Dataset_E_canrowposchange_01.xfdl", function(nexacro, system, trace, environment, application) {
        /**********************************************************************
        * 설명      : Dataset canrowposchange Event
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.02.12  김형철   최초 작성
        	  ...
        	  2019.03.06  김형철   마우스API click1 -> cliclEx 변경
        	  2019.04.09  김형철   마우스API clickEx -> nx_common_click 변경
        **********************************************************************/
        ...
        ***********************************************************************/
        var tc1  = {
        	...
        	userdata : {
        		...
        		eventChkList2 : [],		//onrowposchanged 확인용
        ...
        tc1.task['rowClick'] = function() {
         	var comp = this.grid;
         	//nexacro.test.Event.clickEx(comp, 'lbutton', false, false, false, 5, 70);
        	nexacro.test.Event.nx_common_click(comp, 'lbutton', false, false, false, 5, 60);
        };
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "canrowposchange 리턴값 true, 마우스클릭으로 rowposition 변경",
        	autoTaskFlow : ["rowClick","eventChk"],
        	vcinfo : {
        	...
        	check: function (resultValue) {
        		// ev : rowposition, 이벤트 정보
        		var expectedValue = [0,"ds_data3","canrowposchange","[object Dataset]","[object Dataset]",1,0,51,"onrowposchanged"];
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "canrowposchange 리턴값 true, addRow()로 rowposition 변경",
        	...
        	check: function (resultValue) {
        		// ev : rowposition, 이벤트 정보
        		var expectedValue = [1,"ds_data3","canrowposchange","[object Dataset]","[object Dataset]",5,1,51,"onrowposchanged"];
        		var chk = tc1.checker['equal'].call(this, resultValue, expectedValue);
        		return chk;
        	},
        	teardown: function () {
        ...
        tc1.validator ['tc1_vd3'] = {
        	description: "canrowposchange 리턴값 false, addRow()로 rowposition 변경",
        	autoTaskFlow : ["addRow","eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        	...
        	check: function (resultValue) {
        		// ev : rowposition, 이벤트 정보
        		var expectedValue = [5,"ds_data3","canrowposchange","[object Dataset]","[object Dataset]",6,5,51,""];
        		var chk = tc1.checker['equal'].call(this, resultValue, expectedValue);
        		return chk;
        	},
        	teardown: function () {
        ...
        tc1.validator ['tc1_vd4'] = {
        	description: "canrowposchange 리턴값 true, deleteRow()로 rowposition 변경",
        	...
        	check: function (resultValue) {
        		// ev : rowposition, 이벤트 정보
        		var expectedValue = [0,"ds_data3","canrowposchange","[object Dataset]","[object Dataset]",0,0,53,"onrowposchanged"];
        		var chk = tc1.checker['equal'].call(this, resultValue, expectedValue);
        		return chk;
        	},
        	teardown: function () {
        ...
        tc1.validator ['tc1_vd5'] = {
        	description: "canrowposchange 리턴값 생략, deleteRow()로 rowposition 변경",
        	autoTaskFlow : ["deleteRow","eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        ...
        tc1.validator ['tc1_vd6'] = {
        	description: "clear()",
        	autoTaskFlow : ["clear","eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "clear":
        			var rtn = tc1.task['clear'].call(this);
        			break;
        		case "eventChk":
        			var rtn = tc1.task['eventChk'].call(this);
        			tc1.userdata.result.push(rtn);
        	...
        	check: function (resultValue) {
        		// ev : rowposition, 이벤트 정보
        		var expectedValue = ["","onrowposchanged"];
        		var chk = tc1.checker['equal'].call(this, resultValue, expectedValue);
        		return chk;
        	},
        	teardown: function () {
        ...
        ***********************************************************************/
        this.TA_Dataset_E_canrowposchange_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
        	tc1.userdata.eventChkList1.push(this.dataset.rowposition);
        	...
        	tc1.userdata.eventChkList1.push(e.newrow);
        	tc1.userdata.eventChkList1.push(e.oldrow);
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_E_canrowposchange_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_E_canrowposchange_01.xfdl");
