(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getConstColIndex_01_v2");
            this.set_titletext("TA_Dataset_M_getConstColIndex_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_getConstColIndex_48172_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getConstColIndex_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getConstColIndex_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getConstColIndex_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getConstColIndex Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getConstColIndex Method Test",
        ...
        tc1.task['getConstColIndex'] = function(strColID) {
        	var result = [];

        	var rtngetConstColIndex = this.dataset.getConstColIndex(strColID);

        	result.push(rtngetConstColIndex);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getConstColIndex(strColID) 수행",
        	autoTaskFlow : ["addColumn", "getConstColIndex",],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : strColID, ev : 리턴값
        			    {vc: [[tapi.VBT_EXCEPTION,"test"]],   ev: [-1]},
        				{vc: [[tapi.VBT_NORMAL,"colA"]],      ev: [-1]},
        				{vc: [[tapi.VBT_NORMAL,"ConstA"]],      ev: [0]},
        				{vc: [[tapi.VBT_NORMAL,"ConstC"]],   ev: [2]},
        				//addColumn 후
        				{vc: [[tapi.VBT_NORMAL,"colE"]],   ev: [-1]},
        				{vc: [[tapi.VBT_NORMAL,"ConstD"]],   ev: [3]},
        		]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		case "addColumn":
        			...
        			break;
        		case "getConstColIndex":
        			var rtn = tc1.task['getConstColIndex'].call(this, strColID);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getConstColIndex_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getConstColIndex_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getConstColIndex_01.xfdl");
