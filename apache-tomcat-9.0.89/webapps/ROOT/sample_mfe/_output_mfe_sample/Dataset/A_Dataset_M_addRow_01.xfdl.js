(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_addRow_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_addRow_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_addRow_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset addRow Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.01.09  김형철   최초 작성
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_NORMAL,true], [tapi.VBT_NORMAL,true]],  ev: [2,5,6,"onrowsetchanged", 12, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_NORMAL,true], [tapi.VBT_NORMAL,false]],  ev: [2,6,7,"onrowsetchanged",12,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_NORMAL,false], [tapi.VBT_NORMAL,true]],  ev: [1,7,8,"onrowsetchanged",12,"canrowposchange","onrowposchanged","onvaluechanged"]},
        				{vc: [[tapi.VBT_NORMAL,false], [tapi.VBT_NORMAL,false]],  ev: [1,8,9,"onrowsetchanged",12,"canrowposchange","",""]}
        		]
        	},
        	prepare: function () {
        	},
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_addRow_01.xfdl");
