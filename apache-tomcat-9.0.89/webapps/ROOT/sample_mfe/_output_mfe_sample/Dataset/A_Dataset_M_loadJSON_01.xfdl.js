(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_loadJSON_78827_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_loadJSON_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_loadJSON_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_loadJSON_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset loadJSON Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2021.07.14  함경곤   최초 작성
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset loadJSON Method Test",
        ...
        tc1.task['loadJSON'] = function(varCsvData, bClear) {
        	var result = [];
        	var rtnloadJSON;
        	var getrowPosition;

        	if(bClear == "생략")
        		rtnloadJSON = this.dataset3.loadJSON(varCsvData);
        	else
        		rtnloadJSON = this.dataset3.loadJSON(varCsvData, bClear);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "loadJSON(varCsvData, bClear) 수행",
        	autoTaskFlow : ["loadJSON", "getCellText", "eventChk"],
        	vcinfo : {
        	...
        	prepare: function () {
        		...
        		if(vdAdt.getIndexVC() == 0)
        			tc1.userdata.strJSON = this.dataset1.saveJSON();
        	...
        	run: function () {
        		...
        		var varCsvData = tc1.userdata.strJSON;
        		var bClear = vdAdt.getValue(0);

        		switch(taskName) {
        		case "loadJSON":
        			var rtn = tc1.task['loadJSON'].call(this, varCsvData, bClear);
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_loadJSON_01.xfdl");
