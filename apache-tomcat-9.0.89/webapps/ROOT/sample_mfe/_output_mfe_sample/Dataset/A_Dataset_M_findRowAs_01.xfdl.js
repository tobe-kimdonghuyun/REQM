(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("A_Dataset_M_findRowAs_01");
            this.set_titletext("A_Dataset_M_findRowAs_01");
            ...
            obj.set_updatecontrol("true");
            obj.set_useclientlayout("false");
            obj._setContents({"ColumnInfo" : {"ConstColumn" : [{"id" : "ConstA","size" : "30","type" : "STRING","value" : "A"},{"id" : "ConstB","size" : "30","type" : "STRING","value" : "B"},{"id" : "ConstC","size" : "30","type" : "STRING","value" : "C"}],"Column" : [{"id" : "colA","size" : "256","type" : "STRING"},{"id" : "colB","size" : "256","type" : "STRING"},{"id" : "colC","prop" : "SUM","size" : "256","type" : "INT"},{"id" : "colD","size" : "256","type" : "STRING"}]},"Rows" : [{"colB" : "유동규","colA" : "1","colC" : "100","colD" : "투우"},{"colB" : "주인희","colA" : "1","colC" : "200","colD" : "비이"},{"colB" : "고준영","colA" : "2","colC" : "200","colD" : "소오"},{"colB" : "이정빈","colA" : "3","colC" : "300","colD" : "프트"},{"colA" : "4","colB" : "김선주","colC" : "400","colD" : "비이"}]});
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_findRowAs_48154_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_findRowAs","151","248","69","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_findRowAs_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_findRowAs_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_findRowAs_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset findRowAs Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset findRowAs Method Test",
        ...
        tc1.task['findRowAs'] = function(strColID, strVal, nStartIdx , nEndIdx) {
        	var result = [];
        	var rtnfindRowAs;

        	if(nStartIdx == "생략" && nEndIdx == "생략")
        		rtnfindRowAs = this.dataset.findRowAs(strColID, strVal);
        	else if(nEndIdx == "생략")
        		rtnfindRowAs = this.dataset.findRowAs(strColID, strVal, nStartIdx);
        	else
        		rtnfindRowAs = this.dataset.findRowAs(strColID, strVal, nStartIdx , nEndIdx);

        	result.push(rtnfindRowAs);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "findRowAs(strColID, strVal, nStartIdx , nEndIdx) 수행",
        	autoTaskFlow : ["findRowAs"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : strColID, strVal, nStartIdx , nEndIdx, ev : 리턴값
        			    {vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5]],ev: [1]},
        				...
        				{vc: [[tapi.VBT_NORMAL,"colC"],[tapi.VBT_NORMAL,2],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5]],ev: [1]},
        				...
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,1],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5]],ev: [0]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_MAX,5]],ev: [2]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_MAX,5],[tapi.VBT_MAX,5]],ev: [-1]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_LOWER,-1],[tapi.VBT_MAX,5]],ev: [1]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_HIGHER,6],[tapi.VBT_MAX,5]],ev: [-1]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,undefined],[tapi.VBT_MAX,5]],ev: [1]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_MIN,0],[tapi.VBT_MAX,null]],ev: [1]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"],[tapi.VBT_EXCEPTION,"생략"]],ev: [1]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"]],ev: [2]},
         				//filter 후
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"]],ev: [-1]},
        				//grouping 후
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,4],[tapi.VBT_MIN,0],[tapi.VBT_EXCEPTION,"생략"]],ev: [7]},
        			]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "findRowAs":
        			var rtn = tc1.task['findRowAs'].call(this, strColID, strVal, nStartIdx, nEndIdx);
        ...
        ***********************************************************************/
        this.A_Dataset_M_findRowAs_01_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.A_Dataset_M_findRowAs_01_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_findRowAs.addEventHandler("onclick",this.btn_findRowAs_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_findRowAs_01.xfdl");
