(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Static("sta00","200","34","760","76",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("sta01","206","141","754","60",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Layout("default","mobile,medium,large,desktop",960,720,this,
                ...
                p.sta00.set_text("");
                p.sta00.move("200","34","760","76",null,null);
                ...
                p.sta01.set_text("");
                p.sta01.move("206","141","754","60",null,null);
        ...
        // User Script
        this.registerScript("MLM_320_640_rem.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.loadIncludeScript("MLM_320_640_rem.xfdl");
