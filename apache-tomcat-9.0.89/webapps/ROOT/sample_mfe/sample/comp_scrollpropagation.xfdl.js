(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.TextArea("txa00","230","92","135","149",null,null,null,null,null,null,this);
            obj.set_scrollpropagation("none");
            obj.set_taborder("1");
            ...
            obj = new nexacro.Button("btn00","85","11",null,"37","6",null,null,null,null,null,this.div00.form);
            obj.set_taborder("0");
            obj.set_text("btn00");
            ...
            obj = new nexacro.PopupDiv("PopupDiv00","742","255","238","177",null,null,null,null,null,null,this);
            obj.set_background("burlywood");
            obj.getSetter("formscrollpropagation").set("none");
            ...
            obj = new nexacro.Button("Button00","740","447","140","50",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            ...
            obj = new nexacro.Button("btn00_00_00","976","20","120","50",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("set scrollpropagation");
            this.addChild(obj.name, obj);

            obj = new nexacro.GroupBox("grb00_01","792","10","174","187",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("scrollpropagation");
            this.addChild(obj.name, obj);

            obj = new nexacro.Radio("rdo_scrollpropagation","810","35","138","143",null,null,null,null,null,null,this);
        ...
        // User Script
        this.registerScript("comp_scrollpropagation.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.btn00_00_00_onclick = function(obj,e)
        {
        	...
        	{
        		if (this.components[i]._type_name == "Div")
        			this.components[i].formscrollpropagation = this.rdo_scrollpropagation.value;
        		else
        			this.components[i].scrollpropagation = this.rdo_scrollpropagation.value;
        	}
        };
        ...
        this.loadIncludeScript("comp_scrollpropagation.xfdl");
