(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("btn02","30","270","590","50",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("640");
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new nexacro.Layout("default","mobile,medium,large,desktop",640,720,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.btn02.set_text("640");
                p.btn02.move("30","270","590","50",null,null);
            	}
            );
            ...
            //-- Normal Layout : this
            obj = new nexacro.Layout("Layout1","mobile,medium,large,desktop",480,720,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.btn02.set_text("480");
                p.btn02.move("50","270","420","50",null,null);
            	}
            );
            obj.set_type("default");
            this.addLayout(obj.name, obj);
        ...
        // User Script
        this.registerScript("MLM_480_640.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.loadIncludeScript("MLM_480_640.xfdl");
