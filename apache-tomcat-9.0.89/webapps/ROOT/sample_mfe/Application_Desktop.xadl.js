(function()
{
    return function(nexacro, system, trace, environment, application)  
	{
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            frame0.set_separatesize("150,*");
            this.addChild(frame0.name, frame0);
            this.frame=frame0;

            var frame1 = new nexacro.ChildFrame("TopFrame",null,null,null,null,null,null,"Environment::openurl.xfdl",frame0);
            frame1.set_showstatusbar("false");
            frame1.set_showtitlebar("false");
            frame0.addChild(frame1.name, frame1);
            frame1.set_formurl("Environment::openurl.xfdl");
            ...
            var frame4 = new nexacro.FrameSet("FrameSet00",null,null,null,null,null,null,frame2);
            frame4.set_navid("TargetFrameSet");
            frame4.set_navtype("auto");
            frame4.set_showtitlebar("true");
            frame2.addChild(frame4.name, frame4);

            var frame5 = new nexacro.ChildFrame("WorkFrame",null,null,null,null,null,null,"sample_nav::navform.xfdl",frame4);
            frame5.set_openstatus("maximize");
            frame5.set_showstatusbar("false");
            frame5.set_showtitlebar("false");
            frame4.addChild(frame5.name, frame5);
            frame5.set_formurl("sample_nav::navform.xfdl");


            var frame6 = new nexacro.ChildFrame("WorkFrame1",null,null,null,null,null,null,"sample_nav::navform2.xfdl",frame4);
            frame6.set_openstatus("maximize");
            frame6.set_showstatusbar("false");
            frame6.set_showtitlebar("false");
            frame4.addChild(frame6.name, frame6);
            frame6.set_formurl("sample_nav::navform2.xfdl");
        };
