(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_findRowAsNF_01_v2");
            this.set_titletext("TA_Dataset_M_findRowAsNF_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_findRowAsNF_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Grid("Grid00","6","61","295","159",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_findRowAsNF_01.xfdl","lib::libCommon.xjs");
        this.registerScript("A_Dataset_M_findRowAsNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset findRowAsNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset findRowAsNF Method Test",
        ...
        tc1.task['findRowAsNF'] = function(strColID, strVal, nStartIdx , nEndIdx) {
        	var result = [];
        	var rtnfindRowAsNF;

        	if(nStartIdx == "생략" && nEndIdx == "생략")
        		rtnfindRowAsNF = this.dataset.findRowAsNF(strColID, strVal);
        	else if(nEndIdx == "생략")
        		rtnfindRowAsNF = this.dataset.findRowAsNF(strColID, strVal, nStartIdx);
        	else
        		rtnfindRowAsNF = this.dataset.findRowAsNF(strColID, strVal, nStartIdx , nEndIdx);

        	result.push(rtnfindRowAsNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "findRowAsNF(strColID, strVal, nStartIdx , nEndIdx) 수행",
        	autoTaskFlow : ["findRowAsNF"],
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,2],[tapi.VBT_EXCEPTION,"생략"]],ev: [2]},
        				//grouping 후
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,4],[tapi.VBT_MIN,0],[tapi.VBT_EXCEPTION,"생략"]],ev: [4]},
        			]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "findRowAsNF":
        			var rtn = tc1.task['findRowAsNF'].call(this, strColID, strVal, nStartIdx, nEndIdx);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_findRowAsNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_findRowAsNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_findRowAsNF_01.xfdl");
