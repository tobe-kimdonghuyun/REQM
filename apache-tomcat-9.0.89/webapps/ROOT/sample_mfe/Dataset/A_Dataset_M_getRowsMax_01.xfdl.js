(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getRowsMax_01_v2");
            this.set_titletext("TA_Dataset_M_getRowsMax_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_getRowsMax_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getRowsMax_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getRowsMax_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getRowsMax_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getRowsMax Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getRowsMax Method Test",
        ...
        tc1.task['getRowsMax'] = function(arrRows, strColExpr, arrArgs) {
        	var result = [];
        	var rtngetRowsMax;

        	if(arrArgs == "생략")
        		rtngetRowsMax = this.dataset.getRowsMax(arrRows, strColExpr);
        	else
        		rtngetRowsMax = this.dataset.getRowsMax(arrRows, strColExpr, arrArgs);

        	result.push(rtngetRowsMax);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getRowsMax(arrRows, strColExpr, arrArgs) 수행",
        	autoTaskFlow : ["getRowsMax"],
        	vcinfo : {
        		...
        		args : [
        				...
        				//filter 후
        				{vc: [[tapi.VBT_NORMAL,[0,1,2,3,4,5,6,7,8]],[tapi.VBT_NORMAL,"int_"],[tapi.VBT_EXCEPTION,"생략"]],ev: [9]},
        			]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "getRowsMax":
        			var rtn = tc1.task['getRowsMax'].call(this, arrRows, strColExpr, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getRowsMax_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getRowsMax_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_M_getRowsMax_01.xfdl");
