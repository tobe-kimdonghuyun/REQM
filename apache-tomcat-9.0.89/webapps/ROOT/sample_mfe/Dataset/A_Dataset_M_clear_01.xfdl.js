(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_clear_01_v2");
            this.set_titletext("TA_Dataset_M_clear_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_clear_48118_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","285","294","155",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_clear","232","200","63","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_datasetClear","106","200","116","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("Dataset clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_reset","11","200","85","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("10");
            obj.set_text("reset");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_clear_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_clear_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_clear_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset clear Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset clear Method Test",
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "canrowposchange 리턴값 별 clear() 수행",
        	autoTaskFlow : ["returnValue", "clear", "eventChk", "reset"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : bCanrowposchange, ev : 리턴값, rowcount, colcount, 이벤트정보, rowposition, reset 후 rowcount, colcount
        				{vc: [[tapi.VBT_NORMAL,true]],  ev: [5,0,0,"onrowsetchanged",24,"","onrowposchanged",-1,0,0]},
        				{vc: [[tapi.VBT_NORMAL,false]],  ev: [5,0,0,"onrowsetchanged",24,"","onrowposchanged",-1,0,0]},
        				{vc: [[tapi.VBT_EXCEPTION,"생략"]],  ev: [5,0,0,"onrowsetchanged",24,"canrowposchange","onrowposchanged",-1,0,0]},
        		]
        	},
        	prepare: function () {
        		var vdAdt = tapi.getVdAdaptor();
        ...
        ***********************************************************************/
        this.TA_Dataset_M_clear_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_clear_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_datasetClear.addEventHandler("onclick",this.btn_datasetClear_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_clear_01.xfdl");
