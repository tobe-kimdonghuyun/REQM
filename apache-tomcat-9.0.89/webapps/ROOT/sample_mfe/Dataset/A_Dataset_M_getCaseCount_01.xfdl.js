(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getCaseCount_01_v2");
            this.set_titletext("TA_Dataset_M_getCaseCount_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getCaseCount_48174_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_getCaseCount1","8","256","296","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("15");
            obj.set_text("getCaseCount(strCmpExpr)");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_getCaseCount2","8","288","296","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("16");
            obj.set_text("getCaseCount(strCmpExpr,nStart)");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_getCaseCount3","8","320","296","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("17");
            obj.set_text("getCaseCount(strCmpExpr,nStart,nEnd) ");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getCaseCount_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getCaseCount_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getCaseCount_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getCaseCount Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getCaseCount Method Test",
        ...
        tc1.task['getCaseCount'] = function(strExpr, nStartIdx, nEndIdx, arrArgs) {
        	var result = [];
        	var rtngetCaseCount;

        	if(nStartIdx == "생략" && nEndIdx == "생략" && arrArgs == "생략")
        		rtngetCaseCount = this.dataset.getCaseCount(strExpr);
        	else if(nEndIdx == "생략" && arrArgs == "생략")
        		rtngetCaseCount = this.dataset.getCaseCount(strExpr, nStartIdx);
        	else if(arrArgs == "생략")
        		rtngetCaseCount = this.dataset.getCaseCount(strExpr, nStartIdx, nEndIdx);
        	else
        		rtngetCaseCount = this.dataset.getCaseCount(strExpr, nStartIdx, nEndIdx, arrArgs);

        	result.push(rtngetCaseCount);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getCaseCount(strExpr, nStartIdx, nEndIdx, arrArgs) 수행",
        	autoTaskFlow : ["getCaseCount"],
        	vcinfo : {
        		...
        		args : [
        				...
        				//filter 후
        				{vc: [[tapi.VBT_NORMAL,"int_ > 1"],[tapi.VBT_MIN,0],[tapi.VBT_MAX,8],[tapi.VBT_EXCEPTION,"생략"]],ev: [3]},
        				//keystring 후
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "getCaseCount":
        			var rtn = tc1.task['getCaseCount'].call(this, strExpr, nStartIdx, nEndIdx, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getCaseCount_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getCaseCount_01_v2_onload,this);
            ...
            this.btn_getCaseCount1.addEventHandler("onclick",this.btn_getCaseCount1_onclick,this);
            this.btn_getCaseCount2.addEventHandler("onclick",this.btn_getCaseCount2_onclick,this);
            this.btn_getCaseCount3.addEventHandler("onclick",this.btn_getCaseCount3_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getCaseCount_01.xfdl");
