(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("btn00","556","225","120","50",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("btn00");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("RP_103733_NKDS_00.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.Button10_onclick = function(obj,e)
        {
        	...
        	this.ds06.setConstColProp("storeId", "EE", null);	// boolean
        	this.ds06.setConstColProp("storeId", "DD", "");	// boolean
            Col0Info.AAA = 1;		// number
            Col0Info.BBB = false;	// boolean
        	Col0Info.CCC = true;	// boolean
        	Col0Info.EEE = null;	// boolean
        	Col0Info.DDD = "";	// boolean
        	this.tracePrint(this.ds06.saveXML());
        	this.tracePrint(this.ds06.saveCSV());
        	this.tracePrint(this.ds06.saveJSON());
        	var jsondata = this.ds06.saveJSON();
        	this.ds06.loadJSON(jsondata);
        	this.tracePrint(this.ds06.saveSSV());
        };

        this.btn00_onclick = function(obj,e)
        {
        	trace(ds01.getConstColIndex("company"));
        	this.ds00.getConstColIndex()
        	};
        ...
        this.loadIncludeScript("RP_103733_NKDS_00.xfdl");
