(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_setColumnNF_01_v2");
            this.set_titletext("TA_Dataset_M_setColumnNF_01_v2");
            ...
            obj._setContents({"ColumnInfo" : {"ConstColumn" : [{"id" : "ConstA","size" : "30","type" : "STRING","value" : "A"},{"id" : "ConstB","size" : "30","type" : "STRING","value" : "B"},{"id" : "ConstC","size" : "30","type" : "STRING","value" : "C"}],"Column" : [{"id" : "Check","size" : "256","type" : "STRING"},{"id" : "colA","size" : "256","type" : "STRING"},{"id" : "colB","size" : "256","type" : "STRING"},{"id" : "colC","size" : "256","type" : "INT"},{"id" : "colD","size" : "256","type" : "STRING"}]},"Rows" : [{"colB" : "유동규","colA" : "1","colC" : "100","colD" : "투우","Check" : "1"},{"colB" : "주인희","colA" : "1","colC" : "200","colD" : "비이","Check" : "0"},{"colB" : "고준영","colA" : "2","colC" : "200","colD" : "소오","Check" : "1"},{"colB" : "이정빈","colA" : "3","colC" : "300","colD" : "프트","Check" : "1"},{"colA" : "4","colB" : "김선주","colC" : "400","colD" : "비이","Check" : "0"}]});
            ...
            obj = new nexacro.Button("btn_setColumnNF1","211","120","93","90",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("12");
            obj.set_text("setColumnNF()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_setColumnNF2","211","216","93","90",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("13");
            obj.set_text("setColumnNF()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_setColumnNF_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_setColumnNF_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_setColumnNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset setColumnNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset setColumnNF Method Test",
        ...
        tc1.task['setColumnNF'] = function(nRow, varCol, varVal) {
        	var result = [];
        	var rtnsetColumnNF = this.dataset.setColumnNF(nRow, varCol, varVal);

        	result.push(rtnsetColumnNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "cancolumnchange 리턴값, setColumnNF(nRow, varCol, varVal) 수행",
        	autoTaskFlow : ["setColumnNF", "eventChk", "getCellText"],
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_NORMAL,0],[tapi.VBT_NORMAL,"colA"],[tapi.VBT_NORMAL,"TEST07"]],   ev: [true,"cancolumnchange","TEST06","TEST07","oncolumnchanged","TEST06","TEST07","TEST07"]},
        				{vc: [[tapi.VBT_NORMAL,0],[tapi.VBT_EXCEPTION,"test"],[tapi.VBT_NORMAL,"TEST08"]],   ev: [false,"","",""]},
        				...
        				//filter 후
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST17"]],   ev: [true,"cancolumnchange","TEST04","TEST17","oncolumnchanged","TEST04","TEST17",3]},
        				//keystring group 후
        				{vc: [[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST18"]],   ev: [true,"cancolumnchange",1,"TEST18","oncolumnchanged",1,"TEST18","TEST18"]},
        			]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "setColumnNF":
        			var rtn = tc1.task['setColumnNF'].call(this, nRow, varCol, varVal);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_setColumnNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_setColumnNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_setColumnNF1.addEventHandler("onclick",this.btn_setColumnNF1_onclick,this);
            this.btn_setColumnNF2.addEventHandler("onclick",this.btn_setColumnNF2_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_setColumnNF_01.xfdl");
