(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getColCount_01_v1");
            this.set_titletext("TA_Dataset_M_getColCount_01_v1");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getColCount_48175_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_filterstr","117","249","90","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("filterstr set");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_getColCount","64","203","238","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_text("getColCount()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getColCount_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getColCount_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getColCount_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getColCount Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getColCount Method Test",
        ...
        tc1.task['getColCount'] = function() {
        	var result = [];

        	var rtngetColCount = this.dataset.getColCount();

        	result.push(rtngetColCount);
        ...
        tc1.task['deleteColumn'] = function() {
        	this.dataset.deleteColumn("colA");
        	this.dataset.deleteColumn("ConstA");
        	this.grid.createFormat();
        }
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "addColumn() 후 getColCount()",
        	autoTaskFlow : ["addColumn", "getColCount"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		case "addColumn":
        			...
        			break;
        		case "getColCount":
        			rtn = tc1.task['getColCount'].call(this);
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "deleteColumn() 후 getColCount()",
        	autoTaskFlow : ["deleteColumn", "getColCount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "deleteColumn":
        			tc1.task['deleteColumn'].call(this);
        			break;
        		case "getColCount":
        			rtn = tc1.task['getColCount'].call(this);
        			tc1.userdata.result.push(rtn);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getColCount_01_v1 = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getColCount_01_v1,this);
            ...
            this.btn_getColCount.addEventHandler("onclick",this.btn_getColCount_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getColCount_01.xfdl");
