(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getRowCount_01_v2");
            this.set_titletext("TA_Dataset_M_getRowCount_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getRowCount_48140_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_getRowCount","64","203","238","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("13");
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getRowCount_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getRowCount_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getRowCount_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getRowCount Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.02.19  김형철   최초 작성
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getRowCount Method Test",
        ...
        tc1.task['getRowCount'] = function() {
        	var result = [];
        	var rtngGetRowCount = this.dataset.getRowCount();

        	result.push(rtngGetRowCount);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getRowCount() 수행",
        	autoTaskFlow : ["getRowCount"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "getRowCount":
        			var rtn = tc1.task['getRowCount'].call(this);
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "deleteRow 후 getRowCount() 수행",
        	autoTaskFlow : ["getRowCount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        ...
        tc1.validator ['tc1_vd3'] = {
        	description: "addRow 후 getRowCount() 수행",
        	autoTaskFlow : ["getRowCount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        ...
        tc1.validator ['tc1_vd4'] = {
        	description: "filterstr 후 getRowCount() 수행",
        	autoTaskFlow : ["getRowCount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getRowCount_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getRowCount_01_v2_onload,this);
            ...
            this.btn_getRowCount.addEventHandler("onclick",this.btn_getRowCount_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getRowCount_01.xfdl");
