(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getCountNF_01_v2");
            this.set_titletext("TA_Dataset_M_getCountNF_01_v2");
            ...
            obj._setContents({"ColumnInfo" : {"ConstColumn" : [{"id" : "ConstA","size" : "30","type" : "STRING","value" : "A"},{"id" : "ConstB","size" : "30","type" : "STRING","value" : "B"},{"id" : "ConstC","size" : "30","type" : "STRING","value" : "C"}],"Column" : [{"id" : "colA","size" : "256","type" : "STRING"},{"id" : "colB","size" : "256","type" : "STRING"},{"id" : "colC","size" : "256","type" : "INT"},{"id" : "colD","size" : "256","type" : "STRING"},{"id" : "123","size" : "256","type" : "STRING"},{"id" : "4a","size" : "256","type" : "STRING"}]},"Rows" : [{"colB" : "유동규","colA" : "1","colC" : "100","colD" : "투우","123" : "1","4a" : "2"},{"colA" : "1","colC" : "200","colD" : "비이","123" : "1","4a" : "2"},{"colB" : "","colA" : "2","colC" : "200","colD" : "소오","123" : "1","4a" : "2"},{"colB" : "이정빈","colA" : "3","colC" : "300","colD" : "프트","123" : "1","4a" : "2"},{"colA" : "4","colB" : "김선주","colC" : "400","colD" : "비이","123" : "1","4a" : "2"}]});
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getCountNF_48161_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_getCountNF01","150","216","154","29",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("getCountNF(strColID)");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_getCountNF02","150","248","154","29",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("12");
            obj.set_text("getCountNF(nColIdx)");
            this.addChild(obj.name, obj);

            obj = new nexacro.Grid("Grid00","6","61","295","118",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("btn_getCountNF00","32","286","132","29",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("18");
            obj.set_text("getCountNF()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getCountNF_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getCountNF_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getCountNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getCountNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getCountNF Method Test",
        ...
        tc1.task['getCountNF'] = function(strColID, nStartIdx , nEndIdx) {
        	var result = [];
        	var rtngetCountNF;

        	if(nStartIdx == "생략" && nEndIdx == "생략")
        		rtngetCountNF = this.dataset.getCountNF(strColID);
        	else if(nEndIdx == "생략")
        		rtngetCountNF = this.dataset.getCountNF(strColID, nStartIdx);
        	else
        		rtngetCountNF = this.dataset.getCountNF(strColID, nStartIdx, nEndIdx);

        	result.push(rtngetCountNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getCountNF(strColID, nStartIdx , nEndIdx) 수행",
        	autoTaskFlow : ["getCountNF"],
        	vcinfo : {
        		...
        		args : [
        				...
        				//filter 후
         				{vc: [[tapi.VBT_NORMAL,"ConstA"],[tapi.VBT_MIN,0],[tapi.VBT_MAX,5]],ev: [5]},
         				//grouping 후
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "getCountNF":
        			var rtn = tc1.task['getCountNF'].call(this, strColID, nStartIdx, nEndIdx);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getCountNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getCountNF_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_getCountNF01.addEventHandler("onclick",this.btn_getCountNF01_onclick,this);
            this.btn_filter.addEventHandler("onclick",this.btn_filter_onclick,this);
            this.btn_getCountNF02.addEventHandler("onclick",this.btn_getCountNF02_onclick,this);
            ...
            this.btn_getCountNF00.addEventHandler("onclick",this.btn_getCountNF00_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getCountNF_01.xfdl");
