(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_setColumn_03.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_setColumn_03.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_setColumn_03.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_HIGHER,4],[tapi.VBT_NORMAL,"TEST11"]],   ev: [true,"cancolumnchange","소오","TEST11","oncolumnchanged","소오","TEST11","TEST11"]},
        				{vc: [[tapi.VBT_NORMAL,2],[tapi.VBT_MAX,4],[tapi.VBT_NORMAL,"TEST12"]],   ev: [true,"cancolumnchange","TEST11","TEST12","oncolumnchanged","TEST11","TEST12","TEST12"]},
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_setColumn_03.xfdl");
