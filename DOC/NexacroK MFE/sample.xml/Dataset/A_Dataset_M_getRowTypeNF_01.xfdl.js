(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getRowTypeNF_01_v2");
            this.set_titletext("TA_Dataset_M_getRowTypeNF_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getRowTypeNF_48137_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_getRowTypeNF","120","310","100","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("17");
            obj.set_text("getRowTypeNF()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getRowTypeNF_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getRowTypeNF_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getRowTypeNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getRowTypeNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getRowTypeNF Method Test",
        ...
        tc1.task['getRowTypeNF'] = function(nRow) {
        	var result = [];

        	var rtngetRowTypeNF = this.dataset.getRowTypeNF(nRow);

        	result.push(rtngetRowTypeNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getRowTypeNF() 수행",
        	autoTaskFlow : ["getRowTypeNF"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        			...
        			{vc: [[tapi.VBT_HIGHER,5]],   ev: [0]},
        			{vc: [[tapi.VBT_MAX,4]],  	  ev: [1]},
        			{vc: [[tapi.VBT_NORMAL,2]],   ev: [1]},
        			//[확인필요] nRow  에 undefined, null 등의 NaN 값을 입력하면 ECMA 의 정수 변환 규칙에 따라 "0" 이 됩니다.
         			{vc: [[tapi.VBT_EXCEPTION,undefined]],  ev: [1]},
         			{vc: [[tapi.VBT_EXCEPTION,null]],   	ev: [1]},
        			//addRow 후
        			{vc: [[tapi.VBT_MAX,5]],   ev: [2]},
        			//수정 후
        			{vc: [[tapi.VBT_MIN,0]],   ev: [4]},
        			//fliter 후
        			{vc: [[tapi.VBT_MIN,0]],   ev: [4]},
        			//keystring group 후
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "getRowTypeNF":
        			var rtn = tc1.task['getRowTypeNF'].call(this, nRow);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getRowTypeNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getRowTypeNF_01_v2_onload,this);
            ...
            this.btn_getRowTypeNF.addEventHandler("onclick",this.btn_getRowTypeNF_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_getRowTypeNF_01.xfdl");
