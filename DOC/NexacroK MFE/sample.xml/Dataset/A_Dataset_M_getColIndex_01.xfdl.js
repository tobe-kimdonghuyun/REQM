(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getColIndex_01_v2");
            this.set_titletext("TA_Dataset_M_getColIndex_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_getColIndex_48172_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getColIndex_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getColIndex_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getColIndex_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getColIndex Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getColIndex Method Test",
        ...
        tc1.task['getColIndex'] = function(strColID) {
        	var result = [];

        	var rtngetColIndex = this.dataset.getColIndex(strColID);

        	result.push(rtngetColIndex);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getColIndex(strColID) 수행",
        	autoTaskFlow : ["addColumn", "getColIndex",],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : strColID, ev : 리턴값
        			    {vc: [[tapi.VBT_EXCEPTION,"test"]],   ev: [-1]},
        				{vc: [[tapi.VBT_NORMAL,"colA"]],      ev: [0]},
        				{vc: [[tapi.VBT_NORMAL,"ConstC"]],      ev: [6]},
        				{vc: [[tapi.VBT_NORMAL,"colC"]],   ev: [2]},
        				//addColumn 후
        				{vc: [[tapi.VBT_NORMAL,"colE"]],   ev: [4]},
        				{vc: [[tapi.VBT_NORMAL,"ConstD"]],   ev: [8]},
        		]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		case "addColumn":
        			...
        			break;
        		case "getColIndex":
        			var rtn = tc1.task['getColIndex'].call(this, strColID);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getColIndex_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getColIndex_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getColIndex_01.xfdl");
