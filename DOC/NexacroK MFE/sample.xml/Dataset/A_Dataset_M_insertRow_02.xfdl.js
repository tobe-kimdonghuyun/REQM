(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_insertRow_01_v2");
            this.set_titletext("TA_Dataset_M_insertRow_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_insertRow_48124_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","10","553","298","136",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_clear","237","513","63","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_insertRow","135","513","92","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("insertRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Grid("Grid00","5","61","295","359",null,null,null,null,null,null,this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"149\"/><Column size=\"130\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"colA\"/><Cell col=\"1\" text=\"colB\"/></Band><Band id=\"body\"><Cell text=\"bind:colA\"/><Cell col=\"1\" text=\"bind:colB\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static00","14","452","82","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("insertRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txt_value","130","449","170","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_value("");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static02","14","484","102","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("10");
            obj.set_text("updatecontrol");
            this.addChild(obj.name, obj);

            obj = new nexacro.Radio("rd_updatecontrol","130","483","169","21",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("Button00","10","515","111","34",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("saveXML");
            this.addChild(obj.name, obj);

            obj = new nexacro.Grid("Grid00_00","325","60","425","360",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_insertRow_02.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_insertRow_02.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_insertRow_02.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset insertRow Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset insertRow Method Test",
        ...
        tc1.task['insertRow'] = function(nRow) {
        	var result = [];

        	var rtnInsertRow = this.dataset.insertRow(parseInt(nRow));
        	var getUpdateControl = this.dataset.updatecontrol;

        	var getRowType = this.dataset.getRowType(nRow);

        	result.push(rtnInsertRow);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "canrowposchanged 리턴값 true, updatecontrol=true, insertRow(nRow) 수행",
        	autoTaskFlow : ["insertRow", "eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : nRow, ev : 리턴값, updatecontrol속성값, RowType, 이벤트정보
        			    //{vc: [[tapi.VBT_LOWER,-1]],   ev: [-1, true, 0, "", "", "", ""]},
        				{vc: [[tapi.VBT_MIN,0]],      ev: [0, true, 2, "onrowsetchanged", 43, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_HIGHER,10]],  ev: [6, true, 0, "onrowsetchanged", 43, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_MAX,7]],      ev: [7, true, 2, "onrowsetchanged", 43, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_NORMAL,5]],   ev: [5, true, 2, "onrowsetchanged", 43, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_UNDEFINED,undefined]],   ev: [0, true, 2, "onrowsetchanged", 43, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_EXCEPTION,null]],   ev: [0, true, 2, "onrowsetchanged", 43, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        		]
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "insertRow":
        			var rtn = tc1.task['insertRow'].call(this, nRow);
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "canrowposchanged 리턴값 false, updatecontrol=false, insertRow(nRow) 수행",
        	autoTaskFlow : ["insertRow", "eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : nRow, ev : 리턴값, updatecontrol속성값, RowType, 이벤트정보
        			    {vc: [[tapi.VBT_LOWER,-1]],   ev: [-1, false, 0, "", "", "", ""]},
        				{vc: [[tapi.VBT_MIN,0]],      ev: [0, false, 1, "onrowsetchanged", 43, "canrowposchange", "", ""]},
        				{vc: [[tapi.VBT_HIGHER,10]],  ev: [10,false,1,"onrowsetchanged",43,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_MAX,7]],      ev: [7,false,1,"onrowsetchanged",43,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_NORMAL,5]],   ev: [5,false,1,"onrowsetchanged",43,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_UNDEFINED,undefined]],   ev: [0,false,1,"onrowsetchanged",43,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_EXCEPTION,null]],   ev: [0,false,1,"onrowsetchanged",43,"canrowposchange","",""]},
        		]
        	},
        	prepare: function () {
        ...
        tc1.validator ['tc1_vd3'] = {
        	description: "insertRow(nRow) 수행, reason 체크",
        	autoTaskFlow : ["insertRow", "eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : nRow, ev : 리턴값, updatecontrol속성값, RowType, 이벤트정보, RowType, 이벤트정보, DSRowPosChangeEventInfo.reason
        				{vc: [[tapi.VBT_MIN,0]],   ev: [0, true, 2, "onrowsetchanged", 43, "canrowposchange", "onrowposchanged", 53, "onvaluechanged"]},
        				{vc: [[tapi.VBT_NORMAL,3]],      ev: [3, true, 2, "onrowsetchanged", 43, "canrowposchange", "onrowposchanged", 51, "onvaluechanged"]}
        ...
        ***********************************************************************/
        this.TA_Dataset_M_insertRow_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_insertRow_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_M_insertRow_02.xfdl");
