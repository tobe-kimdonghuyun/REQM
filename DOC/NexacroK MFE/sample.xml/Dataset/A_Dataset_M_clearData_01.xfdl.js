(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_clearData_01_v2");
            this.set_titletext("TA_Dataset_M_clearData_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_clearDataData_48120_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","283","294","157",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_clearData","232","200","63","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            ...
            obj = new nexacro.Button("btn_clearDataData","114","200","107","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("clearDataData");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_reset","24","200","79","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("10");
            obj.set_text("reset");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_reload","232","240","63","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("11");
            obj.set_text("reload");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_clearData_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_clearData_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_clearData_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset clearData Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.02.22  김형철   최초 작성
        *     2020.05.20  김동열   매뉴얼 충돌나는 스펙정리후 기대값 수정
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset clearData Method Test",
        ...
        tc1.task['changeRowposition'] = function(newpos) {
        	if (newpos != "변경없음")
        	{
        		this.dataset3.set_rowposition(newpos);

        		// rowposition변경하면서 발생한 이벤트는 체크대상에서 제외
        ...
        tc1.task['clearData'] = function() {
        	var result = [];

        	var rtnclearData = this.dataset3.clearData();
        	var getrowCount = this.dataset3.rowcount;
        	var getcolCount = this.dataset3.colcount;

        	result.push(rtnclearData);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "canrowposchange 리턴값 별 clearData() 수행",
        	autoTaskFlow : ["changeRowposition", "clearData", "eventChk", "reset"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc :  변경할rowposition, 		   ev : clearData리턴값, 지운후 rowcount, 지운후colcount, 이벤트정보, rowposition, reset 후 rowcount, colcount
        				{vc: [[tapi.VBT_NORMAL,"변경없음"]],  ev: [5,0,5,"onrowsetchanged",23,"","onrowposchanged",0,-1,0,5]},
        				{vc: [[tapi.VBT_NORMAL,1]],            ev: [5,0,5,"onrowsetchanged",23,"","onrowposchanged",1,-1,0,5]},
        		]
        	},
        	prepare: function () {},
        	run: function () {
        		...
        		var rtn;
        		var rowpos = vdAdt.getValue(0);

        		switch(taskName) {
        		case "changeRowposition":
        			tc1.task['changeRowposition'].call(this, rowpos);
        			break;
        		case "clearData":
        			rtn = tc1.task['clearData'].call(this);
        	...
        	teardown: function () {
        		//초기 상태로 변경
        		this.dataset3.assign(this.dataset4);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_clearData_01_v2_onload = function(obj,e)
        {
           tapi.systemDebugOn();
           tapi.debugOn();
        ...
        ***********************************************************************/
        ...
        this.ds_data3_onrowposchanged = function(obj,e)
        {
        	...
        	tc1.userdata.eventChkList3.push(e.oldrow);
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_clearData_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clearData.addEventHandler("onclick",this.btn_clearData_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_clearDataData.addEventHandler("onclick",this.btn_clearDataData_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_clearData_01.xfdl");
