(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_saveCSV_01_v2");
            this.set_titletext("TA_Dataset_M_saveCSV_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_saveCSV_478828_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_clear","241","256","63","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("5");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Edit("edt_strID","72","152","230","29",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_value("ds_data1");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_addRow","211","225","93","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_text("addRow()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_deleteRow","117","225","90","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("10");
            ...
            obj = new nexacro.Edit("edt_nRow","64","224","47","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("12");
            obj.set_value("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_keystring","13","257","90","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("13");
            obj.set_text("keystring set");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_filterstr","117","257","90","25",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("14");
            ...
            obj = new nexacro.Button("Button00","23","187","136","27",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("saveCVS(strID)");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("Button01","167","187","136","27",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("saveCVS()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_saveCSV_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_saveCSV_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_saveCSV_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset saveCSV Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset saveCSV Method Test",
        ...
        tc1.task['saveCSV'] = function(strID) {
        	trace("strID:"+strID);
        	var result = [];
        	var rtnsaveCSV;

        	if(strID == "생략")
        		rtnsaveCSV = this.dataset.saveCSV();
        	else
        		rtnsaveCSV = this.dataset.saveCSV(strID);

        	//strCSV 리턴값에 숨겨진값이 있어 textarea에 값을 넣어주고 검증
        	this.txt_result.set_value(rtnsaveCSV);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "saveCSV(strID) 수행",
        	autoTaskFlow : ["saveCSV"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : strID, ev : 리턴값
        				{vc: [[tapi.VBT_EXCEPTION,"생략"]], ev: ["Dataset:ds_data1\ncolA:STRING(256),colB:STRING(256),colC:INT(256),colD:STRING(256)\n1,유동규,100,투우\n1,주인희,200,비이\n2,고준영,200,소오\n3,이정빈,300,프트\n4,김선주,400,비이\n\n"]},
        				{vc: [[tapi.VBT_NORMAL,"Dataset02"]], ev: ["Dataset:Dataset02\ncolA:STRING(256),colB:STRING(256),colC:INT(256),colD:STRING(256)\n1,유동규,100,투우\n1,주인희,200,비이\n2,고준영,200,소오\n3,이정빈,300,프트\n4,김선주,400,비이\n\n"]},
        				//filter 후
        				{vc: [[tapi.VBT_EXCEPTION,"생략"]], ev: ["Dataset:ds_data1\ncolA:STRING(256),colB:STRING(256),colC:INT(256),colD:STRING(256)\n1,유동규,100,투우\n1,주인희,200,비이\n2,고준영,200,소오\n3,이정빈,300,프트\n4,김선주,400,비이\n\n"]},
        				//deleteRow, keystring 후
        				{vc: [[tapi.VBT_EXCEPTION,"생략"]], ev: ["Dataset:ds_data1\ncolA:STRING(256),colB:STRING(256),colC:INT(256),colD:STRING(256)\n1,주인희,200,비이\n2,고준영,200,소오\n3,이정빈,300,프트\n4,김선주,400,비이\n\n"]},
        		]
        	},
        	prepare: function () {
        		...
        		if(vdAdt.getIndexVC() == 3)
        		{
        			this.dataset.deleteRow(0);
        			this.dataset.set_keystring("S:-colA");
        		}
        	},
        	run: function () {
        		var vdAdt = tapi.getVdAdaptor();
        		...
        		switch(taskName) {
        		case "saveCSV":
        			var rtn = tc1.task['saveCSV'].call(this, strID);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_saveCSV_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_saveCSV_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_M_saveCSV_01.xfdl");
