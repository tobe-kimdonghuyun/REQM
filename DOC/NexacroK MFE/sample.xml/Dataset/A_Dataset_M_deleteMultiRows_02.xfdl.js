(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Grid("Grid00_00","315","68","295","99",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_deleteMultiRows_02.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_deleteMultiRows_02.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_deleteMultiRows_02.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset deleteMultiRows Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2021.10.21  함경곤   최초 작성
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        ...
        tc1.task['deleteMultiRows'] = function(arrRowlist) {
        	...
        	getRowCount = this.ds_data2.rowcount;
        ...
        tc1.task['getCellText'] = function(arrRowlist){
        	...
        	for(var j=0; j<this.ds_data2.rowcount; j++)
        	{
        		for(var i=0; i<7; i++)
        		{
        			result.push(this.Grid00_00.getCellText(arrRowlist[j], i));
        		}
        	}
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_deleteMultiRows_02.xfdl");
