(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("Button01","88","167","93","37",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("modeless02");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("np_Form_Showmodal_Popup.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        {
        	nexacro.open("modeless02", "Base::np_Form_Showmodal_Popup1.xfdl", this.getOwnerFrame(),{}, "showtitlebar=true", 600, 400);
        };
        ...
        this.loadIncludeScript("np_Form_Showmodal_Popup.xfdl");
