(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("btnCancel","30",null,"165","60",null,"40",null,null,null,null,this);
            obj.set_cssclass("btn_WF_Revised");
            obj.set_taborder("0");
            obj.set_text("취소");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btnOk","205",null,"165","60",null,"40",null,null,null,null,this);
        ...
        // User Script
        this.registerScript("cmmConfirm.xfdl", function(nexacro, system, trace, environment, application) {
        /**
        *  Mobile 프로젝트
