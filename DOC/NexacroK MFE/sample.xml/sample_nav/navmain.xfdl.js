(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_navurl("sample_nav::navform1.xfdl?user1=\"navform1\"&user2=\"222\"#btn00");
            obj.set_taborder("0");
            obj.set_text("btn00");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn01_01","940","344","117","35",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("addNavTabpage");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn01_00_00","940","384","117","35",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("insertTabpage");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn01_00_00_00","939","424","117","35",null,null,null,null,null,null,this);
            obj.set_navtarget("targetTab");
            obj.set_navtargetproperties("{\"text\":\"usertabpage1\"}");
            obj.set_navurl("sample_nav::navform3.xfdl");
            obj.set_taborder("12");
            obj.set_text("navtarget");
            this.addChild(obj.name, obj);

            obj = new nexacro.Tab("tab00_00","550","536","314","200",null,null,null,null,null,null,this);
            obj.set_navid("targetTab1");
            obj.set_navtype("always_new");
            obj.set_showextrabutton("true");
            obj.set_tabindex("0");
            obj.set_taborder("13");
            this.addChild(obj.name, obj);

            obj = new nexacro.Tabpage("Tabpage1",this.tab00_00);
            obj.set_initvalueid("iv_Tabpage");
            obj.set_text("Tabpage1");
            this.tab00_00.addChild(obj.name, obj);

            obj = new nexacro.Tabpage("Tabpage2",this.tab00_00);
            obj.set_text("Tabpage2");
            obj.set_url("sample_nav::navform1.xfdl");
            this.tab00_00.addChild(obj.name, obj);

            obj = new nexacro.Button("btn01_00_00_00_00","943","543","117","35",null,null,null,null,null,null,this);
            obj.set_navtarget("targetTab1");
            obj.set_navtargetproperties("{\"text\":\"usertabpage1\"}");
            obj.set_navurl("sample_nav::navform3.xfdl");
            obj.set_taborder("14");
            obj.set_text("navtarget");
            ...
            obj = new nexacro.Layout("default","",0,0,this.tab00_00.Tabpage1.form,function(p){});
            this.tab00_00.Tabpage1.form.addLayout(obj.name, obj);

            //-- Default Layout : this.tab00_00.Tabpage2
            obj = new nexacro.Layout("default","",0,0,this.tab00_00.Tabpage2.form,function(p){});
        ...
        // User Script
        this.registerScript("navmain.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.btn01_00_00_00_00_onclick = function(obj,e)
        {

        };

        this.tab00_00_onextrabuttonclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn01_01.addEventHandler("onclick",this.btn01_onclick,this);
            this.btn01_00_00.addEventHandler("onclick",this.btn02_onclick,this);
            this.tab00_00.addEventHandler("onextrabuttonclick",this.tab00_00_onextrabuttonclick,this);
            this.btn01_00_00_00_00.addEventHandler("onclick",this.btn01_00_00_00_00_onclick,this);
        };

        this.loadIncludeScript("navmain.xfdl");
