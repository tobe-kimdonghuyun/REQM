(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_updateColID_01_v2");
            this.set_titletext("TA_Dataset_M_updateColID_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_updateColID_48098_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_updateColID1","196","168","108","56",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("15");
            obj.set_text("updateColID()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_updateColID2","196","240","108","56",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("16");
            obj.set_text("updateColID()");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_getCollID","116","307","100","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("19");
            obj.set_text("getCollID()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_updateColID_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_updateColID_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_updateColID_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset updateColID Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset updateColID Method Test",
        ...
        tc1.task['updateColID'] = function(varCol, strNewColID) {
        	var result = [];
        	var rtnupdateColID = this.dataset.updateColID(varCol, strNewColID);

        	result.push(rtnupdateColID);
        ...
        tc1.task['getColID'] = function(nColIdx) {
        	var result = [];

        	if(nColIdx == "colC") nColIdx = 2;
        	if(nColIdx == "test") nColIdx = -1;

        	var getColID = this.dataset.getColID(nColIdx);

        	result.push(getColID);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "updateColID(varCol, strNewColID) 수행",
        	autoTaskFlow : ["updateColID", "eventChk", "getColID"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : varCol, strNewColID, ev : 리턴값, 이벤트정보, getColID
        				...
        				{vc: [[tapi.VBT_HIGHER,7],[tapi.VBT_NORMAL,"NewColumn02"]],   ev: [-1,"",""]},
        				{vc: [[tapi.VBT_MAX,6],[tapi.VBT_NORMAL,"NewColumn03"]],   ev: [6,"onrowsetchanged",34,"NewColumn03"]},
        			    {vc: [[tapi.VBT_NORMAL,3],[tapi.VBT_NORMAL,"NewColumn04"]],   ev: [3,"onrowsetchanged",34,"NewColumn04"]},
        				{vc: [[tapi.VBT_NORMAL,"colC"],[tapi.VBT_NORMAL,"NewColumn05"]],   ev: [2,"onrowsetchanged",34,"NewColumn05"]},
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "updateColID":
        			var rtn = tc1.task['updateColID'].call(this, varCol, strNewColID);
        		...
        		case "eventChk":
        			...
        			break;
        		case "getColID":
        			var rtn = tc1.task['getColID'].call(this, varCol);
        			tc1.userdata.result.push(rtn);
        			break;
        		}
        ...
        ***********************************************************************/
        this.TA_Dataset_M_updateColID_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_updateColID_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_updateColID1.addEventHandler("onclick",this.btn_updateColID1_onclick,this);
            this.btn_updateColID2.addEventHandler("onclick",this.btn_updateColID2_onclick,this);
            this.btn_getCollID.addEventHandler("onclick",this.btn_getCollID_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_updateColID_01.xfdl");
