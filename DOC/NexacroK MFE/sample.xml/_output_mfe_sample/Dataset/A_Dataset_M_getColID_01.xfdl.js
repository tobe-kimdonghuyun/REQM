(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getColID_01_v2");
            this.set_titletext("TA_Dataset_M_getColID_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getColID_48172_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","291","298","151",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_value("//");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Grid("Grid00","5","61","295","155",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Static("Static00","10","227","58","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_text("nColIdx");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_nColIdx","101","224","83","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_value("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_getColID","196","224","108","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_text("getColID()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getColID_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getColID_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getColID_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getColID Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2019.02.27  김형철   최초 작성
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getColID Method Test",
        ...
        tc1.task['getColID'] = function(nColIdx) {
        	...
        	var rtngetColID = this.dataset.getColID(nColIdx);

        	result.push(rtngetColID);

        	return result;
        };

        tc1.task['addColumn'] = function() {
        	this.dataset.addColumn("colE", "string");
        	this.dataset.addConstColumn("ConstD", "1234");
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getColID(nColIdx) 수행",
        	autoTaskFlow : ["addColumn", "getColID",],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : nRow, ev : 리턴값
        			    {vc: [[tapi.VBT_LOWER,-1]],   ev: [""]},
        				{vc: [[tapi.VBT_MIN,0]],      ev: ["colA"]},
        				{vc: [[tapi.VBT_HIGHER,7]],   ev: [""]},
        				{vc: [[tapi.VBT_MAX,6]],      ev: ["ConstC"]},
        				{vc: [[tapi.VBT_NORMAL,3]],   ev: ["colD"]},
        				{vc: [[tapi.VBT_EXCEPTION,undefined]],   ev: ["colA"]},
        				{vc: [[tapi.VBT_EXCEPTION,null]],   ev: ["colA"]},
        				//addColumn 후
        				{vc: [[tapi.VBT_NORMAL,4]],   ev: ["colE"]},
        				{vc: [[tapi.VBT_NORMAL,8]],   ev: ["ConstD"]},
        		]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		case "addColumn":
        			if(vdAdt.getIndexVC() == 7)
        				tc1.task['addColumn'].call(this);
        			break;
        		case "getColID":
        			var rtn = tc1.task['getColID'].call(this, nRow);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getColID_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getColID_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_getColID.addEventHandler("onclick",this.btn_getColID_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getColID_01.xfdl");
