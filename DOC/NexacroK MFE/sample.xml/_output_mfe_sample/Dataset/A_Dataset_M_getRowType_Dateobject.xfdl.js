(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getRowType_01_v2");
            this.set_titletext("TA_Dataset_M_getRowType_01_v2");
            ...
            obj._setContents({"ColumnInfo" : {"ConstColumn" : [{"id" : "ConstA","size" : "30","type" : "STRING","value" : "A"},{"id" : "ConstB","size" : "30","type" : "STRING","value" : "B"},{"id" : "ConstC","size" : "30","type" : "STRING","value" : "C"}],"Column" : [{"id" : "colA","size" : "256","type" : "STRING"},{"id" : "colB","size" : "256","type" : "STRING"},{"id" : "colC","size" : "256","type" : "INT"},{"id" : "colD","size" : "256","type" : "STRING"},{"id" : "colE","size" : "256","type" : "DATE"}]},"Rows" : [{"colB" : "유동규","colA" : "1","colC" : "100","colD" : "투우","colE" : "20200324"},{"colB" : "주인희","colA" : "1","colC" : "200","colD" : "비이","colE" : "20200325"},{"colB" : "고준영","colA" : "2","colC" : "200","colD" : "소오","colE" : "20200326"},{"colB" : "이정빈","colA" : "3","colC" : "300","colD" : "프트","colE" : "20200327"},{"colA" : "4","colB" : "김선주","colC" : "400","colD" : "비이","colE" : "20200328"}]});
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_getRowType_48137_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_setRowType1","211","144","93","56",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("13");
            obj.set_text("setRowType()");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_setRowType2","211","208","93","56",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("14");
            obj.set_text("setRowType()");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getRowType_Dateobject.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getRowType_Dateobject.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getRowType_Dateobject.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getRowType Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        *     2020.03.24  홍현표   최초 작성
              : RP:88851 rowtype 오류 수정으로 인해 test case 추가함
        ***********************************************************************
        */
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getRowType Method Test",
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getRowType() 수행",
        	autoTaskFlow : ["getRowType"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        			args : [

        			{vc: [[tapi.VBT_NORMAL,0]],   ev: [4]},
        			{vc: [[tapi.VBT_NORMAL,0]],   ev: [1]},
        			{vc: [[tapi.VBT_NORMAL,0]],   ev: [4]},
        			{vc: [[tapi.VBT_NORMAL,0]],   ev: [1]},
        			{vc: [[tapi.VBT_NORMAL,0]],   ev: [4]},
        			{vc: [[tapi.VBT_NORMAL,0]],   ev: [1]},
        	...
        	prepare: function () {
        		...
        		switch(vdAdt.getIndexVC())
        		{
        			...
        			// string 데이터 변경 후 값 원복 rowtype 4->1로 변경확인
        			case 0:
        				this.dataset.setColumn(0, 1, "1유동규");
        			break;
        			case 1:
        				this.dataset.setColumn(0, 1, "유동규");
        			break;
        			// int 데이터 변경 후 값 원복 rowtype 4->1로 변경확인
        			case 2:
        				this.dataset.setColumn(0, 2, "110");
        			break;
        			case 3:
        				this.dataset.setColumn(0, 2, "100");
        			break;
        			// date 데이터 변경 후 값 원복 rowtype 4->1로 변경확인 (이전버전에서는 fail 확인)
        			case 4:
        				this.dataset.setColumn(0, 4, "20200326");
        			break;
        			case 5:
        				this.dataset.setColumn(0, 4, "20200324");
        			break;
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getRowType_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getRowType_01_v2_onload,this);
            ...
            this.btn_setRowType2.addEventHandler("onclick",this.btn_setRowType2_onclick,this);
        ...
        this.loadIncludeScript("A_Dataset_M_getRowType_Dateobject.xfdl");
