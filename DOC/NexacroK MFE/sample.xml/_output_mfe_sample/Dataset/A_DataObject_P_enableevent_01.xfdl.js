(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_DataObject_P_enableevent_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_DataObject_P_enableevent_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_DataObject_P_enableevent_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset enableevnet Property
        * 작성일    : 2021.08.17
        * 작성자    : 함경곤
        ...
        ***********************************************************************/
        ...
        tc1.task['setColumn'] = function(nRow, varCol, varVal,benableevent) {
        	var result = [];
        	this.DataObject00.set_enableevent(benableevent);
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0],[tapi.VBT_NORMAL,1],[tapi.VBT_NORMAL,"TEST01"],[tapi.VBT_NORMAL,undefined]],   ev: [true,,1]},
        				{vc: [[tapi.VBT_MIN,1],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,"TEST02"],[tapi.VBT_NORMAL,false]],   ev: [true,,"주인희"]},
        				{vc: [[tapi.VBT_MIN,3],[tapi.VBT_NORMAL,2],[tapi.VBT_NORMAL,"TEST03"],[tapi.VBT_NORMAL,true]],   ev: [true,"ondatachanged",2,"DataObject00","onvaluechanged","$.dataset[*],DataObject00",3,"colB","ds_data1","TEST03","TEST03"]},
        	...
        	run: function () {
        		...
        		var benable = vdAdt.getValue(3);

        		switch(taskName) {
        		case "setColumn":
        			var rtn = tc1.task['setColumn'].call(this, nRow, varCol, varVal,benable);
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_DataObject_P_enableevent_01.xfdl");
