(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_filterRow_01_v2");
            this.set_titletext("TA_Dataset_M_filterRow_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_filterRow_48152_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","287","298","145",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_clear","233","240","63","35",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btn_filterRow","131","240","92","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("filterRow");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("Static00","10","203","70","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("filterRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txt_filterRow","83","203","118","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_value("2");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_filterRow_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_filterRow_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_filterRow_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset filterRow Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset filterRow Method Test",
        ...
        tc1.task['filterRow'] = function(nRow) {
        	var result = [];

        	this.dataset.filterRow(parseInt(nRow));
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "canrowposchanged 리턴값 true, updatecontrol=true, filterRow(nRow) 수행",
        	autoTaskFlow : ["filterRow", "eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        				//vc : nRow, ev : 리턴값, rowposition, 이벤트정보
        			    {vc: [[tapi.VBT_LOWER,-1]],   ev: [5,""]},
        				{vc: [[tapi.VBT_MIN,0]],      ev: [4, "onrowsetchanged", 31]},
        				{vc: [[tapi.VBT_HIGHER,10]],  ev: [4, ""]},
        				{vc: [[tapi.VBT_MAX,3]],      ev: [3, "onrowsetchanged", 31]},
        				{vc: [[tapi.VBT_NORMAL,1]],   ev: [2, "onrowsetchanged", 31]},
        				{vc: [[tapi.VBT_EXCEPTION,undefined]],   ev: [1, "onrowsetchanged", 31]},
        				{vc: [[tapi.VBT_EXCEPTION,null]],   ev: [0, "onrowsetchanged", 31]}
        		]
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "filterRow":
        			var rtn = tc1.task['filterRow'].call(this, nRow);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_filterRow_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_filterRow_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_clear.addEventHandler("onclick",this.btn_clear_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
            this.btn_filterRow.addEventHandler("onclick",this.btn_filterRow_onclick,this);
            this.ds_data1.addEventHandler("onrowsetchanged",this.ds_data1_onrowsetchanged,this);
        };

        this.loadIncludeScript("A_Dataset_M_filterRow_01.xfdl");
