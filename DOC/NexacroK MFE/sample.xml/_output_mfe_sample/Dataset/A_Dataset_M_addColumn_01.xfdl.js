(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_addColumn_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_addColumn_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_addColumn_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        ...
        tc1.task['addColumn'] = function(strColID, strColType, nColSize) {
        	...
        	if(nColSize == "생략")
        	{
        		rtnAddColumn = this.dataset.addColumn(strColID, strColType);
        	}
        	//선택적 파라미터 미생략 시
        	else
        	{
        		rtnAddColumn = this.dataset.addColumn(strColID, strColType, nColSize);
        	}
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "addColumn(strColID, strColType, nColSize) 수행",
        	autoTaskFlow : ["addColumn", "eventChk"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        			case "addColumn":
        				rtn = tc1.task['addColumn'].call(this, strColID, strColType, nColSize);
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_addColumn_01.xfdl");
