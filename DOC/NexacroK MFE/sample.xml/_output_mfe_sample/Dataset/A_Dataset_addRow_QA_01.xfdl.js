(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.addIncludeScript("A_Dataset_addRow_QA_01.xfdl","lib::libCommon.xjs");
        this.registerScript("A_Dataset_addRow_QA_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : addRow : addColumn 테스트 시스템 고도화 팀원 교육용 샘플
        * 작성일    : 2018.08.22
        * 작성자    : 윤재식
        * 수정이력  :
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc  = {
            // tc 설명
        	description: "Dataset_Method_addRow Test",
            metadata : {
        			 objectId : "nexacro.Dataset",        // 객체 식별자 : typedef의 object id(개별)
        			 featureType: tapi.FT_METHOD,     		// object metainfo의 속성 종류
        			 elementName : "addRow",        // 요소 이름 : [ object metainfo의 속성 이름 | undefined ]
        			 keyword : ["Dataset", "addRow", "onrowposchanged"]
            },
        	//  테스트케이스 시작 전 해야할 일
        	initialize: function(){
        	},
        ...
        ***********************************************************************/
        tc.validator ['tc_vc2'] = {
        	...
        	run: function () {
        		this.ds00.addRow();
        		rtn = this.eventChkList[0];
        		return rtn;
        	},

        	// 기대값 검사
        	check: function  (resultValue) {
        		return nexacro.test.checkEqual(this, resultValue, "onrowposchanged");
        	},
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_addRow_QA_01.xfdl");
