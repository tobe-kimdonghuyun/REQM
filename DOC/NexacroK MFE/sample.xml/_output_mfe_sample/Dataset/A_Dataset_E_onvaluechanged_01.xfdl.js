(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_E_onvaluechanged_01_v2");
            this.set_titletext("TA_Dataset_E_onvaluechanged_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_E_onvaluechanged_48071_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","276","298","156",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"colA\"/><Cell col=\"1\" text=\"colB\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" editdisplay=\"display\" edittype=\"text\" text=\"bind:colA\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"text\" text=\"bind:colB\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("Static00","20","192","54","14",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("nRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static02","20","215","54","14",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("nColIdx");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static05","20","238","46","14",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("varVal");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_varVal1","83","235","110","19",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_value("TEST00");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_nColIdx","83","212","110","19",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_value("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("edt_nRow1","83","189","110","19",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_value("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_setColumn1","201","189","98","65",null,null,null,null,null,null,this);
            obj.set_taborder("15");
        ...
        // User Script
        this.addIncludeScript("A_Dataset_E_onvaluechanged_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_E_onvaluechanged_01.xfdl","libevent::event.util.xjs");
        this.addIncludeScript("A_Dataset_E_onvaluechanged_01.xfdl","libevent::event.wrapper.xjs");
        this.registerScript("A_Dataset_E_onvaluechanged_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset onvaluechanged Event Test",
        ...
        tc1.task['setColumn'] = function(nRow, varCol, varVal) {
        	this.dataset.setColumn(nRow, varCol, varVal);
        }
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	check: function (resultValue) {
        		var expectedValue = ["","","","ds_data3",-1,-1,"","onvaluechanged","[object Dataset]","[object Dataset]",undefined,undefined,0];
        ...
        tc1.validator ['tc1_vd2'] = {
        	...
        	autoTaskFlow : ["setColumn", "eventChk"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "setColumn":
        			tc1.task['setColumn'].call(this, 0, 0, "TEST00");
        			break;
        		case "eventChk":
        			rtn = tc1.task['eventChk'].call(this);
        			tc1.userdata.result.push(rtn);
        	...
        	check: function (resultValue) {
        		// ev : 이벤트 정보
        		var expectedValue = ["","","","ds_data3",0,-1,"colA","onvaluechanged","[object Dataset]","[object Dataset]","TEST00",1,0];
        		var chk = tc1.checker['equal'].call(this, resultValue, expectedValue);
        		return chk;
        	},
        	teardown: function () {
        ...
        tc1.validator ['tc1_vd3'] = {
        	...
        	check: function (resultValue) {
        		// ev : 이벤트 정보
        		var expectedValue = ["onrowsetchanged","canrowposchange","onrowposchanged","ds_data3",-1,-1,"","onvaluechanged","[object Dataset]","[object Dataset]",undefined,undefined,0];
        		var chk = tc1.checker['equal'].call(this, resultValue, expectedValue);
        		return chk;
        	},
        	teardown: function () {
        ...
        tc1.validator ['tc1_vd4'] = {
        	...
        	check: function (resultValue) {
        		// ev : 이벤트 정보
        		var expectedValue = ["onrowsetchanged","canrowposchange","onrowposchanged","ds_data3",-1,-1,"","onvaluechanged","[object Dataset]","[object Dataset]",undefined,undefined,4];
        		var chk = tc1.checker['equal'].call(this, resultValue, expectedValue);
        		return chk;
        	},
        	teardown: function () {
        ...
        ***********************************************************************/
        this.TA_Dataset_E_onvaluechanged_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        this.ds_data3_onvaluechanged = function(obj,e)
        {
        	...
        	tc1.userdata.eventChkList4.push(e.col);
        	tc1.userdata.eventChkList4.push(e.colidx);
        	tc1.userdata.eventChkList4.push(e.columnid);
        	tc1.userdata.eventChkList4.push(e.eventid);
        	tc1.userdata.eventChkList4.push(e.fromobject);
        	tc1.userdata.eventChkList4.push(e.fromreferenceobject);
        	tc1.userdata.eventChkList4.push(e.newvalue);
        	tc1.userdata.eventChkList4.push(e.oldvalue);
        	tc1.userdata.eventChkList4.push(e.row);
        };
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_E_onvaluechanged_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_E_onvaluechanged_01.xfdl");
