(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_P_constcount_01_v2");
            this.set_titletext("TA_Dataset_P_constcount_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_P_constcount_48048_01]");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.TextArea("txt_result","6","384","298","59",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_clear","241","271","63","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("4");
            obj.set_text("clear");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("Static00","24","237","79","27",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            obj.set_text("constcount");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txt_value","113","230","191","40",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("7");
            obj.set_value("10");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_set","35","271","92","29",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("set");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_get","139","271","92","29",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_text("get");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Static("Static02","18","304","58","21",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("ColID");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txtColID","85","301","219","26",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_value("ConstD");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static03","18","336","58","21",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("ColVal");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txtColVal","85","333","219","26",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_value("테스트1234");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_addConstColumn","174","360","130","21",null,null,null,null,null,null,this);
            obj.set_taborder("15");
        ...
        // User Script
        this.addIncludeScript("A_Dataset_P_constcount_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_P_constcount_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_P_constcount_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        ...
        tc1.task['addColumn'] = function(strColID, strColType, nColSize) {
        	this.dataset.addColumn(strColID, strColType, nColSize);
        	this.grid.createFormat();
        }

        tc1.task['addConstColumn'] = function(strColID, varVal) {
        	this.dataset.addConstColumn(strColID, varVal);
        	this.grid.createFormat();
        }

        tc1.task['deleteColumn'] = function(colVal) {
        	this.dataset.deleteColumn(colVal);
        	this.grid.createFormat();
        }

        tc1.task['constcount'] = function() {
        	var result = [];
        	var rtnconstcount = this.dataset.constcount;

        	result.push(rtnconstcount);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "Column 추가 후 constcount",
        	autoTaskFlow : ["addColumn", "constcount"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "addColumn":
        			tc1.task['addColumn'].call(this, "colE", "string", 255);
        			break;
        		case "constcount":
        			rtn = tc1.task['constcount'].call(this);
        ...
        tc1.validator ['tc1_vd2'] = {
        	description: "ConstColumn 추가 후 constcount",
        	autoTaskFlow : ["addConstColumn", "constcount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_NONE,
        	},
        	prepare: function () {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "addConstColumn":
        			tc1.task['addConstColumn'].call(this, "ConstD", "D");
        			break;
        		case "constcount":
        			rtn = tc1.task['constcount'].call(this);
        			tc1.userdata.result.push(rtn);
        ...
        tc1.validator ['tc1_vd3'] = {
        	description: "deleteColumn 후 constcount",
        	autoTaskFlow : ["deleteColumn", "constcount"],
        	vcinfo : {
        		argType : tapi.VCT_ARG_LIST,
        		args : [
        			//vc : colVal, ev : constcount
        			{vc: [[tapi.VBT_NORMAL,0]],  	ev: [4]},
        			{vc: [[tapi.VBT_NORMAL,"ConstA"]],  ev: [3]},
        		]
        	},
        	prepare: function () {
        	},
        	run: function () {
        		var vdAdt = tapi.getVdAdaptor();
        		var taskName = vdAdt.getTaskFlowName();
        		var colVal = vdAdt.getValue(0);
        		var rtn;

        		switch(taskName) {
        		case "deleteColumn":
        			tc1.task['deleteColumn'].call(this, colVal);
        			break;
        		case "constcount":
        			rtn = tc1.task['constcount'].call(this);
        			tc1.userdata.result.push(rtn);
        ...
        ***********************************************************************/
        this.TA_Dataset_P_constcount_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_P_constcount_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_P_constcount_01.xfdl");
