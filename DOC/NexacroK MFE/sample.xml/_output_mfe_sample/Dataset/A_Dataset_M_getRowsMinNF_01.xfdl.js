(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getRowsMinNF_01_v2");
            this.set_titletext("TA_Dataset_M_getRowsMinNF_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_getRowsMinNF_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getRowsMinNF_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getRowsMinNF_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getRowsMinNF_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getRowsMinNF Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getRowsMinNF Method Test",
        ...
        tc1.task['getRowsMinNF'] = function(arrRows, strColExpr, arrArgs) {
        	var result = [];
        	var rtngetRowsMinNF;

        	if(arrArgs == "생략")
        		rtngetRowsMinNF = this.dataset.getRowsMinNF(arrRows, strColExpr);
        	else
        		rtngetRowsMinNF = this.dataset.getRowsMinNF(arrRows, strColExpr, arrArgs);

        	result.push(rtngetRowsMinNF);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getRowsMinNF(arrRows, strColExpr, arrArgs) 수행",
        	autoTaskFlow : ["getRowsMinNF"],
        	vcinfo : {
        	...
        	run: function () {
        		...
        		switch(taskName) {
        		case "getRowsMinNF":
        			var rtn = tc1.task['getRowsMinNF'].call(this, arrRows, strColExpr, arrArgs);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getRowsMinNF_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getRowsMinNF_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_M_getRowsMinNF_01.xfdl");
