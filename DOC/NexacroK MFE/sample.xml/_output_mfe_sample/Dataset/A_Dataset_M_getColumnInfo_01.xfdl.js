(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_getColumnInfo_01_v2");
            this.set_titletext("TA_Dataset_M_getColumnInfo_01_v2");
            ...
            obj.set_taborder("0");
            obj.set_text("[Dataset_M_getColumnInfo_48172_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_getColumnInfo_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_getColumnInfo_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_getColumnInfo_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset getColumnInfo Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset getColumnInfo Method Test",
        ...
        tc1.task['getColumnInfo'] = function(varCol) {
        	var result = [];

        	var objColInfo = this.dataset.getColumnInfo(varCol);

        	if(objColInfo)
        		result.push(objColInfo.name);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "getColumnInfo(varCol) 수행",
        	autoTaskFlow : ["addColumn", "getColumnInfo",],
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_HIGHER,4]],   ev: [""]},
        				{vc: [[tapi.VBT_MAX,3]],   ev: ["colD"]},
        				{vc: [[tapi.VBT_NORMAL,1]],   ev: ["colB"]},
        			    {vc: [[tapi.VBT_EXCEPTION,"test"]],   ev: [""]},
        				{vc: [[tapi.VBT_NORMAL,"colA"]],      ev: ["colA"]},
        				{vc: [[tapi.VBT_NORMAL,"colC"]],   ev: ["colC"]},
        				//addColumn 후
        				{vc: [[tapi.VBT_NORMAL,"colE"]],   ev: ["colE"]},
        		]
        	},
        	prepare: function () {
        		tc1.userdata.result = [];
        	...
        	run: function () {
        		...
        		case "addColumn":
        			...
        			break;
        		case "getColumnInfo":
        			var rtn = tc1.task['getColumnInfo'].call(this, varCol);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_getColumnInfo_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_getColumnInfo_01_v2_onload,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
            this.btn_Combo_menu.addEventHandler("onclick",this.btn_button_menu_onclick,this);
            this.btn_main.addEventHandler("onclick",this.btn_main_onclick,this);
        };

        this.loadIncludeScript("A_Dataset_M_getColumnInfo_01.xfdl");
