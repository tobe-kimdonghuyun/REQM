(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_E_onload_01_v2");
            this.set_titletext("TA_Dataset_E_onload_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_E_onload_48078_01]");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"ConstA\"/><Cell col=\"1\" text=\"ConstB\"/><Cell col=\"2\" text=\"ConstC\"/><Cell col=\"3\" text=\"colA\"/><Cell col=\"4\" text=\"colB\"/></Band><Band id=\"body\"><Cell text=\"bind:ConstA\"/><Cell col=\"1\" text=\"bind:ConstB\"/><Cell col=\"2\" text=\"bind:ConstC\"/><Cell col=\"3\" text=\"bind:colA\"/><Cell col=\"4\" text=\"bind:colB\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new nexacro.TextArea("txt_result","6","224","298","196",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_value("//");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_E_onload_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_E_onload_01.xfdl","libevent::event.util.xjs");
        this.addIncludeScript("A_Dataset_E_onload_01.xfdl","libevent::event.wrapper.xjs");
        this.registerScript("A_Dataset_E_onload_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset onload Event Test",
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	check: function (resultValue) {
        		// ev : 이벤트 정보
        		var expectedValue = [-1,"ds_data3",0,"SUCCESS","onload","[object Dataset]","[object Dataset]",3]
        ...
        ***********************************************************************/
        ...
        {
        	tc1.userdata.eventChkList1.push(this.ds_data3.rowposition);
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_E_onload_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_E_onload_01.xfdl");
