(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        {
            this.set_name("TA_Dataset_M_loadSSV_01_v2");
            this.set_titletext("TA_Dataset_M_loadSSV_01_v2");
            ...
            obj.set_taborder("1");
            obj.set_text("[Dataset_M_loadSSV_78827_01]");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_loadSSV_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_loadSSV_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_loadSSV_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        * 설명      : Dataset loadSSV Method
        ***********************************************************************
        *     수정일     작성자   내용
        ***********************************************************************
        ...
        ***********************************************************************/
        var tc1  = {
        	description: "Dataset loadSSV Method Test",
        ...
        tc1.task['loadSSV'] = function(varSsvData, bClear) {
        	var result = [];
        	var rtnloadSSV;
        	var getrowPosition;

        	if(bClear == "생략")
        		rtnloadSSV = this.dataset3.loadSSV(varSsvData);
        	else
        		rtnloadSSV = this.dataset3.loadSSV(varSsvData, bClear);
        ...
        tc1.validator ['tc1_vd1'] = {
        	description: "loadSSV(varSsvData, bClear) 수행",
        	autoTaskFlow : ["loadSSV", "getCellText", "eventChk"],
        	vcinfo : {
        	...
        	prepare: function () {
        		...
        		if(vdAdt.getIndexVC() == 0)
        			tc1.userdata.strSSV = this.dataset1.saveSSV();
        	...
        	run: function () {
        		...
        		var varSsvData = tc1.userdata.strSSV;
        		var bClear = vdAdt.getValue(0);

        		switch(taskName) {
        		case "loadSSV":
        			var rtn = tc1.task['loadSSV'].call(this, varSsvData, bClear);
        ...
        ***********************************************************************/
        this.TA_Dataset_M_loadSSV_01_v2_onload = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        {
            this.addEventHandler("onload",this.TA_Dataset_M_loadSSV_01_v2_onload,this);
        ...
        this.loadIncludeScript("A_Dataset_M_loadSSV_01.xfdl");
