(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.TextArea("txt_result","6","296","298","136",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("3");
            obj.set_text("//");
            obj.set_value("//");
            ...
            obj = new nexacro.Button("btn_insertRow","131","256","92","37",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("6");
            ...
            obj = new nexacro.Static("Static00","10","195","82","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("8");
            obj.set_text("insertRow");
            this.addChild(obj.name, obj);

            obj = new nexacro.Edit("txt_value","126","192","170","26",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("9");
            obj.set_value("");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static02","10","227","102","21",null,null,null,null,null,null,this);
            obj.getSetter("position").set("absolute");
            obj.set_taborder("10");
            obj.set_text("updatecontrol");
            this.addChild(obj.name, obj);

            obj = new nexacro.Radio("rd_updatecontrol","126","226","169","21",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("Button00","6","258","111","34",null,null,null,null,null,null,this);
            obj.set_taborder("14");
        ...
        // User Script
        this.addIncludeScript("A_Dataset_M_insertRow_01.xfdl","lib::libCommon.xjs");
        this.addIncludeScript("A_Dataset_M_insertRow_01.xfdl","libevent::event.util.xjs");
        this.registerScript("A_Dataset_M_insertRow_01.xfdl", function(nexacro, system, trace, environment, application) {
        /***********************************************************************
        ...
        tc1.validator ['tc1_vd1'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0]],      ev: [0, true, 2, "onrowsetchanged", 12, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_HIGHER,10]],  ev: [6, true, 0, "onrowsetchanged", 12, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_MAX,7]],      ev: [7, true, 2, "onrowsetchanged", 12, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_NORMAL,5]],   ev: [5, true, 2, "onrowsetchanged", 12, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_UNDEFINED,undefined]],   ev: [0, true, 2, "onrowsetchanged", 12, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        				{vc: [[tapi.VBT_EXCEPTION,null]],   ev: [0, true, 2, "onrowsetchanged", 12, "canrowposchange", "onrowposchanged", "onvaluechanged"]},
        		]
        	},
        	prepare: function () {
        ...
        tc1.validator ['tc1_vd2'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0]],      ev: [0, false, 1, "onrowsetchanged", 12, "canrowposchange", "", ""]},
        				{vc: [[tapi.VBT_HIGHER,10]],  ev: [10,false,1,"onrowsetchanged",12,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_MAX,7]],      ev: [7,false,1,"onrowsetchanged",12,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_NORMAL,5]],   ev: [5,false,1,"onrowsetchanged",12,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_UNDEFINED,undefined]],   ev: [0,false,1,"onrowsetchanged",12,"canrowposchange","",""]},
        				{vc: [[tapi.VBT_EXCEPTION,null]],   ev: [0,false,1,"onrowsetchanged",12,"canrowposchange","",""]},
        		]
        	},
        	prepare: function () {
        ...
        tc1.validator ['tc1_vd3'] = {
        	...
        	vcinfo : {
        		...
        		args : [
        				...
        				{vc: [[tapi.VBT_MIN,0]],   ev: [0, true, 2, "onrowsetchanged", 12, "canrowposchange", "onrowposchanged", 53, "onvaluechanged"]},
        				{vc: [[tapi.VBT_NORMAL,3]],      ev: [3, true, 2, "onrowsetchanged", 12, "canrowposchange", "onrowposchanged", 51, "onvaluechanged"]}
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("A_Dataset_M_insertRow_01.xfdl");
