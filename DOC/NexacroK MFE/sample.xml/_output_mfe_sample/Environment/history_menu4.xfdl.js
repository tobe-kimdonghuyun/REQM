(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.registerScript("history_menu4.xfdl", function(nexacro, system, trace, environment, application) {

        this.history_onload = function(obj,e)
        {
        trace("histroy_onload : menu4");
        ...
        this.loadIncludeScript("history_menu4.xfdl");
