(function()
{
    return function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Div("divTop","0","0",null,"55","0",null,null,null,null,null,this);
            obj.set_cssclass("div_TF_Bg");
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("Static02","0",null,null,"1","0","0",null,null,null,null,this.divTop.form);
            obj.set_cssclass("sta_TF_Line");
            obj.set_taborder("3");
            this.divTop.addChild(obj.name, obj);

            obj = new nexacro.Static("sta00","65","0",null,"55","65",null,null,null,null,null,this.divTop.form);
            obj.set_cssclass("sta_TF_Title");
            obj.set_taborder("0");
            obj.set_text("타이틀영역");
            this.divTop.addChild(obj.name, obj);

            obj = new nexacro.Static("sta01","65","0",null,"55","65",null,null,null,null,null,this.divTop.form);
            ...
            obj = new nexacro.Button("btnMenu",null,"0","55","55","20",null,null,null,null,null,this.divTop.form);
            obj.set_cssclass("btn_TF_Menu");
            obj.set_taborder("2");
            obj.set_text("");
            this.divTop.addChild(obj.name, obj);

            obj = new nexacro.Button("btnBack","20","0","55","55",null,null,null,null,null,null,this.divTop.form);
            obj.set_cssclass("btn_TF_Pre");
            obj.set_taborder("1");
            obj.set_text("");
            this.divTop.addChild(obj.name, obj);

            obj = new nexacro.Div("divCenter","0","55",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_url("frame::frmWork.xfdl");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new nexacro.Div("divMain","0","0",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);

            obj = new nexacro.Div("divMenu","980","0",null,null,"-980","0",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_url("frame::frmMenu.xfdl");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new nexacro.Div("divLogin","490","0",null,null,"-490","0",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("");
            ...
            obj = new nexacro.Layout("default","",0,0,this.divTop.form,function(p){});
            this.divTop.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divCenter
            obj = new nexacro.Layout("default","",0,0,this.divCenter.form,function(p){});
            this.divCenter.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divMain
            obj = new nexacro.Layout("default","",0,0,this.divMain.form,function(p){});
            ...
            obj = new nexacro.Layout("default","",0,0,this.divLogin.form,function(p){});
        ...
        // User Script
        this.registerScript("frmBase.xfdl", function(nexacro, system, trace, environment, application) {
        /**
        *  Mobile 프로젝트
