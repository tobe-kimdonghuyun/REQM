 ...
 * @return {string}
 */
pForm.gfn_cryptoEncode = function(targetStr) {
	GibberishAES.size(128);	
    return GibberishAES.aesEncrypt(targetStr, nxApp.gv_keyvalue);
}
 ...
 * @return {string}
 */
pForm.gfn_cryptoDecode = function(targetStr) {
	GibberishAES.size(128);	
	return GibberishAES.aesDecrypt(targetStr, nxApp.gv_keyvalue);
}
