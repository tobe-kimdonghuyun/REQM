...
if (!nexacro.CalendarWeekSingle)
{
  ...
  /* accessibility */
  _pCalendarWeekSingle.accessibilityrole = "button";
  ...
  _pCalendarWeekSingle.on_create_contents = function()
  {
    ...
    var strFormat = '<Formats>'
                  ...
                  + '  </Rows>'
                  + '  <Band id="head">'
                  + '    <Cell color="#115fac" text="주" textAlign="center" expandchar="week"/>'
                  + '    <Cell col="1" color="#333333" text="월" textAlign="center" expandchar="mon"/>'
                  + '    <Cell col="2" color="#333333" text="화" textAlign="center" expandchar="tue"/>'
                  + '    <Cell col="3" color="#333333" text="수" textAlign="center" expandchar="wed"/>'
                  + '    <Cell col="4" color="#333333" text="목" textAlign="center" expandchar="thu"/>'
                  + '    <Cell col="5" color="#333333" text="금" textAlign="center" expandchar="fri"/>'
                  + '    <Cell col="6" color="#d40009" text="토" textAlign="center" expandchar="sat"/>'
				  + '    <Cell col="7" color="#d40009" text="일" textAlign="center" expandchar="sun"/>'
                  + '  </Band>'
                  + '  <Band id="body">'
      ...
      for (j = 1; j < 8; j++)
      {
        ...
        else
        {
          if (i == 0)
          {
            ...
            {
              if (j == 7) //일요일
                this.form.calendardataset.setColumn(i+1, "css" + (j), "CalendarWeekSunColor");
              else if (j == 6) //토요일
