...
/* 1. 추후 BasicObjs.js로 이동
   2. framework/BasicObjs/nexacro.Point 삭제
 */
/*
...
if (!nexacro.Point)
{
    ...
    {
        nexacro.Point.call(this, x, y);
    };

    var _pGraphicsPoint = nexacro._createPrototype(nexacro.Point, nexacro.Point);
    nexacro.Point.prototype = _pGraphicsPoint;

    nexacro.Point.min = function (pt0, pt1)
    {
        if (pt0 instanceof nexacro.Point)
        {
            return new nexacro.Point(Math.min(arguments[0] | 0, arguments[1] | 0), Math.min(arguments[2] | 0, arguments[3] | 0));
        }
        else
        {
            return new nexacro.Point(Math.min(pt1.x, pt2.x), Math.min(pt1.y, pt2.y));
        }
    };
    ...
    nexacro.Point.max = function (pt0, pt1)
    {
        if (pt0 instanceof nexacro.Point)
        {
            return new nexacro.Point(Math.max(arguments[0] | 0, arguments[2] | 0), Math.max(arguments[1] | 0, arguments[3] | 0));
        }
        else
        {
            return new nexacro.Point(Math.max(pt1.x, pt2.x), Math.max(pt1.y, pt2.y));
        }
    };

    _pGraphicsPoint.getAngle = function ()
    {
        return this._getAngleInRadians.apply(this, arguments) * 180 / Math.PI;
    };

    _pGraphicsPoint._getAngleInRadians = function ()
    {
    ...
    _pGraphicsPoint.getLength = function ()
    {   
        return Math.sqrt(this.x * this.x + this.y * this.y);
    };

   
    _pGraphicsPoint.rotate = function (angle, center)
    {
        if (angle === 0)
        {
            return this.clone();
    ...
    _pGraphicsPoint.dot = function (pt)
    {
        if (pt instanceof nexacro.Point)
        {
        ...
        {
            return this.x * (arguments[0] | 0) + this.y * (arguments[1] | 0);
        }
        
    };

    _pGraphicsPoint.cross = function (pt)
    {
        if (pt instanceof nexacro.Point)
        {
        ...
        {
            return this.x * (arguments[1] | 0) - this.y * (arguments[0] | 0);
        }
		
    };

    _pGraphicsPoint.project = function (pt)
    {
        if (!(pt instanceof nexacro.Point))
        {
            pt = new nexacro.Point(arguments[0], arguments[1]);
    ...
    _pGraphicsPoint.add = function (pt)
    {
        if (pt instanceof nexacro.Point)
        {
    ...
    _pGraphicsPoint.subtract = function (pt)
    {
        if (pt instanceof nexacro.Point)
        {
            return new nexacro.Point(this.x - pt.x, this.y - pt.y);
    ...
    _pGraphicsPoint.multiply = function (pt)
    {
        if (pt instanceof nexacro.Point)
        {
            return new nexacro.Point(this.x * pt.x, this.y * pt.y);
    ...
    _pGraphicsPoint.divide = function (pt)
    {
        if (pt instanceof nexacro.Point)
        {
            return new nexacro.Point(this.x / pt.x, this.y / pt.y);
    ...
    _pGraphicsPoint.modulo = function (pt)
    {
        if (pt instanceof nexacro.Point)
        {
            return new nexacro.Point(this.x % pt.x, this.y % pt.y);
    ...
    _pGraphicsPoint.negate = function ()
    {
        return new nexacro.Point(-this.x, -this.y);
    };

    _pGraphicsPoint.clone = function ()
    {
        return new nexacro.Point(this.x, this.y);
    };

    delete _pGraphicsPoint;    
}
*/
...
if (!nexacro._GraphicsLib)
{
    ...
    nexacro._GraphicsLib.isObject = function (value)
    {
        ...
        // nexacro Component
        if (nexacro._GraphicsLib.isXComponent(value)) return false;
    ...
    else
    {
        ...
        nexacro._GraphicsLib._getLines = function (nexacroFont, txt, wordwrap, maxWidth)
        {
            var canvas = nexacro._GraphicsLib._getDefaultCanvas(),
...
if (!nexacro._GraphicsMathUtil)
{
    ...
    nexacro._GraphicsMathUtil._abscissas = [
    ...
    nexacro._GraphicsMathUtil._weights = [
		[1],
...
if (!nexacro._GraphicsMatrix)
{
    ...
    {
        var f0 = [nexacro._GraphicsClassUtils.fmtNumber(this._scaleX), nexacro._GraphicsClassUtils.fmtNumber(this._shearX),
                    nexacro._GraphicsClassUtils.fmtNumber(this._translateX)];
        var f1 = [nexacro._GraphicsClassUtils.fmtNumber(this._shearY), nexacro._GraphicsClassUtils.fmtNumber(this._scaleY),
                    nexacro._GraphicsClassUtils.fmtNumber(this._translateY)];
...
if (!nexacro._GraphicsRectsManager)
{
    ...
    _pGraphicsRectsManager.remove = function (rect)
    {
        var l = 0,
			...
			size = rects.length,
			r = size - 1,
			arrayCopy = nexacro._GraphicsLibArray.arrayCopy,
			idx = 0;
...
if (!nexacro._GraphicsObject)
{
    ...
    _pGraphicsObject._render = function (ctx)
    {
        ...
        if (m && style)
        {
            ...
            this._painted = 1;
            ctx.save();
            if (isScalingStroke) m.applyToContext(ctx);
        ...
        _pGraphicsObject._applystyles = function (ctx, style)
        {
            ...
            if (ctx)
            {
                ...
                if (strokeColor)
                {
					...
					{
						if ('setLineDash' in handle)
						{
							handle.setLineDash(dashArray);
							handle.lineDashOffset = dashOffset;
						}
						else if ('mozDash' in handle)
						{
							handle.mozDash = dashArray;
							handle.mozDashOffset = dashOffset;
						}
					}
					*/
                }
...
if (!nexacro.GraphicsEllipse)
{
    ...
    _pGraphicsEllipse._drawShape = function (ctx, strokeMatrix)
    {
        ...
        else
        {
            ...
            var mx = w / 2,
				my = h / 2,
				kappa = nexacro._GraphicsMathUtil._KAPPA,
				cx = mx * kappa,
				cy = my * kappa;
            if (strokeMatrix)
            {
...
if (!nexacro.GraphicsPath)
{
    ...
    _pGraphicsPath.getPathData = function ()
    {
        ...
        var mpt = segs[0].point,
			fmtNumber = nexacro._GraphicsClassUtils.fmtNumber;
            ...
            switch (lower)
            {
                ...
                case 'a':
                    ...
                    for (var j = 0; j < length; j += 7)
                    {
                        ...
                        new nexacro._GraphicsSize(+coords[0], +coords[1]),
    ...
    _pGraphicsPath._getRect = function (bStrokeWidth, iscurrent)
    {
        ...
        if (bStrokeWidth)
        {
            if (this._strokejoin == "miter" || this._strokejoin == "round")
    ...
    _pGraphicsPath._calcCurve = function (v0, v1, v2, v3, xyCoord, padding, min, max, roots)
    {
        var a = 3 * (v1 - v2) - v0 + v3,
			b = 2 * (v0 + v2) - 4 * v1,
			c = v1 - v0,
			count = nexacro._GraphicsMathUtil.solveQuadratic(a, b, c, roots),
			tMin = this._curveMin,
			tMax = this._curveMax,
			u, t;
...
if (!nexacro.GraphicsControl)
{
    ...
    //===============================================================
    // nexacro.GraphicsControl : Create & Destroy & Update
    //===============================================================	
    ...
    //===============================================================
    // nexacro.GraphicsControl : Properties
    //===============================================================

    //===============================================================
    // nexacro.GraphicsControl : Methods
    //===============================================================
    ...
    //===============================================================
    // nexacro.GraphicsControl : Event Handlers
    //===============================================================	

    //===============================================================
    // nexacro.GraphicsControl : Logical part
    //===============================================================
    // 검토 후 노출
    ...
    //===============================================================
    // nexacro.GraphicsControl : Util Function
    //===============================================================
