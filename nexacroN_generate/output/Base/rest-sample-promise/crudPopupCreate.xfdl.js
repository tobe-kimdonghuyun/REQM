(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"id\" type=\"string\" size=\"256\"/><Column id=\"employee_name\" type=\"string\" size=\"256\"/><Column id=\"employee_salary\" type=\"string\" size=\"256\"/><Column id=\"employee_age\" type=\"string\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
        ...
        * FORM EVENT 영역(onload)
        /***********************************************************************************************/
        this.RestAPI_boiler_popup_onload = function(obj,e)
        {
        ...
        */
        this.btn_create_onclick = async function(obj,e)
        {
        	// 데이터 생성 통신
        	// 프로미스 RestAPI 통신
        	try {
        		let {strSvcId, nErrorCode, objResolveData, elapsedTime} = await this.gfn_dsFetch(this.SVC_SAVE);
        		this.close(true);
        	} catch (err) {
        		console.error(err);
        	}
