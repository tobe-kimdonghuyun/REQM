(function()
{
	return function(nexacro, system, trace)
	{
		...
		const ButtonMinWidth = "ButtonMinWidth";
			...
			"Button" : 
			{
				"self" : 
				{
					...
					"enabled" : 
					{
						...
						get width() { return getCSSPredefineValue(ButtonWidth)},
						"letterSpacing" : CSSValueObject("1px"),
						get minWidth() { return getCSSPredefineValue(ButtonMinWidth)},
						get height() { return getCSSPredefineValue(ButtonHeight)}
					},
					"selected" : 
					{
					}
				...
				},
				{
					"userFit" : 
					{
						"self" : 
						{
							"mouseover" : 
							{
								"border" : BorderObject("20px solid purple"),
								"width" : "200px",
								"height" : "150px"
							},
							"focused" : 
							...
							"enabled" : 
							{
								"border" : BorderObject("20px solid lightblue"),
