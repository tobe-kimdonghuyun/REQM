(function()
{
    return function(nexacro, system, trace)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("Button00","98","73","unset","unset",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Panel("Panel00","345.00","49","unset","unset",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Panel("Panel01","645.00","49","unset","unset",null,null,null,null,null,null,this);
            obj.set_background("lightgray");
            obj.set_border("3px solid yellow");
            ...
            obj = new nexacro.Button("Button04","507","414","unset","47",null,null,null,null,null,null,this);
            obj.set_cssclass("userA");
            obj.set_flexshrink("0");
            obj.set_taborder("5");
            ...
            obj = new nexacro.Button("Button041","507","414","unset","47",null,null,null,null,null,null,this);
            obj.set_cssclass("userA");
            obj.set_flexshrink("0");
            obj.set_taborder("5");
            obj.set_text("패널 버튼 1 (XCSS)");
            ...
            obj = new nexacro.Combo("Combo00_00","354","396","unset","unset",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Combo00");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Combo("Combo00_02","354","560","unset","unset",null,null,"100","400",null,null,this);
            obj.set_taborder("9");
            obj.set_text("Combo00");
            this.addChild(obj.name, obj);

            obj = new nexacro.PopupDiv("PopupDiv00","790","273","unset","unset",null,null,null,null,null,null,this);
            obj.set_background("purple");
            obj.set_text("PopupDiv00");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("Button001","9","12","unset","unset",null,null,null,null,null,null,this.PopupDiv00.form);
            obj.set_taborder("0");
            ...
            obj = new nexacro.Button("Button06","553","126","unset","unset",null,null,null,null,null,null,this);
            ...
            obj = new nexacro.Button("Button061","553","126","unset","unset",null,null,null,null,null,null,this);
            obj.set_cssclass("userFit");
            obj.set_flexshrink("0");
            obj.set_taborder("16");
            obj.set_text("패널 버튼 (Fit)");
            ...
            obj = new nexacro.Button("Button002","35","56","unset","unset",null,null,null,"200",null,null,this.Div01.form.Div00.form);
            ...
            obj = new nexacro.Button("Button001","160","23","unset","unset",null,null,null,null,null,null,this.Div01.form.Div00.form);
            obj.set_cssclass("userB");
            obj.set_flexgrow("1");
            obj.set_taborder("1");
            obj.set_text("Button001");
            ...
            obj = new nexacro.Button("Button003","23","21","unset","50",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("1");
        ...
        {
        	this.PopupDiv00.trackPopup(300, 300);
        };
        ...
        this.Button031_onclick = function(obj,e)
        {
        	obj.height = 1300;
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.Button031.addEventHandler("onclick",this.Button031_onclick,this);
