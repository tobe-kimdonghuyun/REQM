import {nexacro ,trace, system} from "./nexacrolib/framework/Framework.mjs"
nexacro.__importpath = import.meta.url;
...
if (nexacro.Environment)
{
    ...
    {
        this.set_csscollisionpreventkey("D1wiK");
        this.set_datatyperule("2.0");
        this.getSetter("onrootcssclassselected").set("Environment_onrootcssclassselected");
        this.set_themeid("theme::blue");
        this.set_themekey("Samsung");
    };
    ...
    // User Script
    env.registerScript("environment.xml", function(nexacro, system, trace) {

    this.Environment_onrootcssclassselected = function(obj,e)
    {
    	alert(e.condition);
    };
