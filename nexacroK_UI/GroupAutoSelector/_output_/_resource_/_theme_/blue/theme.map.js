(function()
{
	return function(nexacro, system, trace)
	{
		...
		{
			"root" : {
				"PrimaryFont":"15px Malgun Gothic",
				"PrimaryTextAlign":"left",
				"PrimaryColor":"black",
				"SecondaryColor":"white",
				"ButtonWordWrap":"none",
				get ButtonTextAlign() { return nexacro._getCSSPredefineValue("PrimaryTextAlign"); },
				"ButtonEdge":"URL('./images/btn_WF_Calendar.png') 5px 5px",
				"ButtonOverEdge":"URL('./images/btn_WF_Calendar.png') 10px 10px"
			},
			"Small" : {
				"PrimaryFont":"9px Malgun Gothic"
			},
			"Medium" : {
				"PrimaryFont":"12px Malgun Gothic"
			},
			"Dark" : {
				"PrimaryColor":"white",
				...
				"ButtonWordWrap":"char",
				"ButtonEdge":"URL('./images/btn_WF_Calendar.png') 8px 8px"
			}
		}
		);
		...
		const PrimaryTextAlign = "PrimaryTextAlign";
		const PrimaryColor = "PrimaryColor";
		const SecondaryColor = "SecondaryColor";
		const ButtonWordWrap = "ButtonWordWrap";
		const ButtonTextAlign = "ButtonTextAlign";
		const ButtonEdge = "ButtonEdge";
		const ButtonOverEdge = "ButtonOverEdge";
		...
		nexacro._setCSSMaps(
		{
			...
			"Button" : 
			{
				"self" : 
				{
					"mouseover" : 
					{
						...
						get edge() { return EdgeImageObject(getCSSPredefineValue(ButtonOverEdge,"edge")) }
					},
					"focused" : 
					{
						"border" : BorderObject("1px solid #a0a0a0"),
					...
					"enabled" : 
					{
						get edge() { return EdgeImageObject(getCSSPredefineValue(ButtonEdge,"edge")) },
						get wordWrap() { return getCSSPredefineValue(ButtonWordWrap,"wordwrap")}
					},
					"selected" : 
					{
					}
			...
			"Form" : 
			{
				"self" : 
				{
					...
					{
						"border" : BorderObject("0px none"),
						get color() { return ColorObject(getCSSPredefineValue(PrimaryColor)) },
						get font() { return FontObject(getCSSPredefineValue(PrimaryFont)) }
					}
				}
			},
			"MaskEditControl" : 
		...
		nexacro._setCSSPredefineGroupAutoSelectInfo (
		{
			...
			"Medium":{
				"viewport-minwidth":"481px",
				"viewport-maxwidth":"640px"
			},
			"Dark":{
